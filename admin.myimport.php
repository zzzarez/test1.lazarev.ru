...
for ($i=1;$i<count($data);$i++)
	...
	if (!$data_array[1] && $data_array[2])//запись категории 3 уровня
        ...
        //запись товаров
	//echo "<br>!".$data_array[0].$data_array[1].$data_array[2];
	...
	if (!$data_array[0] && !$data_array[1] && !$data_array[2])
        ...
        $data_array[8]=edit_import($data_array[8]);//описание
		//echo "<br>da=".$data_array[4].$data_array[3];
...
//echo "<br>"."SELECT * FROM #__vm_product WHERE product_sku ='".$data_array[4]."' LIMIT 1";
...
//!!!
		 ...
		 //$prod_thumb_img = $category_path0.$category_path1."oborudovanie/torgovoe/resized/".$data_array[4].".jpg";
		 //$prod_full_img = $category_path0.$category_path1."oborudovanie/torgovoe/".$data_array[4].".jpg";

		 $prod_thumb_img ="shcool_mebel/preshcool_mebel/resized/".$data_array[4].".jpg";
		 $prod_full_img = "shcool_mebel/preshcool_mebel/".$data_array[4].".jpg";
         //запись товаров                                                                                                                                                                                                                                                                            //!!!["product_id"]
	         echo "path=".$category_path0.$category_path1;
		 $database->setQuery("INSERT INTO #__vm_product ( vendor_id , product_parent_id , product_sku , product_s_desc , product_publish , product_special , product_discount_id , product_name , product_desc , child_options, quantity_options,product_order_levels,product_full_image,product_thumb_image) values ( '1', '".$product_parent_id."', '".$data_array[4]."', '".$data_array[6]."', 'Y', 'N', '0', '".$data_array[5]."', '".$data_array[7]."','Y,Y,N,N,N,Y,,,', 'check,0,0,1', '0,0','".$prod_full_img."','".$prod_thumb_img."')");
		 $database->query();
                 // $category_path="";
