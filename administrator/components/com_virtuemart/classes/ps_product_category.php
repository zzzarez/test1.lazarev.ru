	...
	function get_category_tree( $category_id=0,
		...
		for($n = 0 ; $n < $nrows ; $n++) {
			...
			if( $allowed ) {
				...
				$html .= '
          <a title="'.$catname.'" style="display:block;font-size:80px;'.$style.'" class="'. $css_class .'" href="'. $sess->url(URL."index.php?page=shop.browse&amp;category_id=".$category_tmp[$row_list[$n]]["category_child_id"]) .'" '.$append.'>'
