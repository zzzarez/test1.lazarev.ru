	...
	***************************************************************************/
	...
	function add( &$d ) {
		...
		if( !empty($my->id) || !empty($auth['user_id']) ) {
            ...
            //fix!!!
            $msg =  '<span id="congrt_activation" align="center">Поздравляем!  Ваша учетная запись создана!</span><br><br><span id="text_activation"><br /><br />Прежде чем начать совершать покупки в нашем магазине, Вам необходимо активировать свою учетную запись.<br /><br />Ссылка для активации Вашей учетной записи была отправлена в письме на Ваш E-mail, указанный при регистрации. Пожалуйста, пройдите по данной ссылке, и процедура регистрации будет полностью завершена. </span>';
			$vmLogger->info( $msg );
		}
