...
define( 'SECUREURL', 'http://shop.lazarev.ru/' );
...
define('VM_GENERALLY_PREVENT_HTTPS', '');
...
define('VM_PROXY_USER', 'zarez@yandex.ru');
define('VM_PROXY_PASS', 'SdaKlj123');
...
define('DOWNLOAD_MAX', '10');
define('DOWNLOAD_EXPIRE', '8640000');
define('ENABLE_DOWNLOAD_STATUS', 'C');
define('DISABLE_DOWNLOAD_STATUS', 'X');
define('DOWNLOADROOT', '/opt/video/video_downloads/');
...
define('NO_IMAGE', 'add-to-cart.png');
define('DEBUG', '');
define('SHOWVERSION', '');
define('TAX_VIRTUAL', '');
define('TAX_MODE', '1');
...
define('VM_LOGFILE_NAME', 'virtue_log');
...
$VM_BROWSE_ORDERBY_FIELDS = array( 'product_name','product_price','product_sku' );
