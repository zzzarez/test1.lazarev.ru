...
class TopCategoriesStatistic extends TopListStatistic
{	
	/**
	...
	{			
		...
		$this->color_schema = "topCategories";
		
		$this->data =& $this->model->getTopCategoriesData();
	}
}