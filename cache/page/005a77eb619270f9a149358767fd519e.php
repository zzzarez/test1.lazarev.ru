...
<thead>
	...
	<input type="hidden" name="c1306027b3b5c70b6ba1838b4ff69045" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="sheptunova@rambler.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="c1306027b3b5c70b6ba1838b4ff69045" value="1" />
            </form>
    </div>
