...
<thead>
	...
	<input type="hidden" name="66baa029d765aec676347f2a3df858ba" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523898465152a" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="66baa029d765aec676347f2a3df858ba" value="1" />
            </form>
    </div>
