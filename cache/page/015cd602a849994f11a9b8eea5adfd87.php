...
<thead>
	...
	<input type="hidden" name="c49b9a697e7858426ad3240cc64736df" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3234&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2010020607zaporozhe_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="c49b9a697e7858426ad3240cc64736df" value="1" />
            </form>
    </div>
