...
<thead>
	...
	<input type="hidden" name="31945d665339585dda8ff96a16fdd57e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=36d213b4ad87a0edf30753982959c542">
...
<!--        </div>-->
        ...
        <input type="hidden" name="31945d665339585dda8ff96a16fdd57e" value="1" />
            </form>
    </div>
