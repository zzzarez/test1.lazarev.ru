...
<thead>
	...
	<input type="hidden" name="6414d32166d8fa252679c4c236e1ea21" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=65b5eebd7492b5b668112208248df4e2">
...
<!--        </div>-->
        ...
        <input type="hidden" name="6414d32166d8fa252679c4c236e1ea21" value="1" />
            </form>
    </div>
