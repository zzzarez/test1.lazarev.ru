...
<thead>
	...
	<input type="hidden" name="25d744f34ed54cd7fba5bda7772f594c" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="pavel1977-77@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="25d744f34ed54cd7fba5bda7772f594c" value="1" />
            </form>
    </div>
