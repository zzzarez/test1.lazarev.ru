...
<thead>
	...
	<input type="hidden" name="de80c8282c21b3447c203e68826ec302" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=bd97ba814a1af33b80458f47be11157a">
...
<!--        </div>-->
        ...
        <input type="hidden" name="de80c8282c21b3447c203e68826ec302" value="1" />
            </form>
    </div>
