...
<thead>
	...
	<input type="hidden" name="f00a289bfe7a2c3a6607b0850dccb028" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=b767197bf2f43691c083d8cb5efd6be4">
...
<!--        </div>-->
        ...
        <input type="hidden" name="f00a289bfe7a2c3a6607b0850dccb028" value="1" />
            </form>
    </div>
