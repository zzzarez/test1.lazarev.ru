...
<thead>
	...
	<input type="hidden" name="59e3a228dfa2ec1cb761c4ac79fc18ee" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3085&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2001022801novosibirsk_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="59e3a228dfa2ec1cb761c4ac79fc18ee" value="1" />
            </form>
    </div>
