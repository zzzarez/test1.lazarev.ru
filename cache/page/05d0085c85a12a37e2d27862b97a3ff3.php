...
<thead>
	...
	<input type="hidden" name="5587ea7b7cc9f9d8494fffc48c37b065" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="osipovich.l@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="5587ea7b7cc9f9d8494fffc48c37b065" value="1" />
            </form>
    </div>
