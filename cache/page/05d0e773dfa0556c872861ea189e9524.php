...
<thead>
	...
	<input type="hidden" name="cc69c067f8ccc019bd001111c1a35ea6" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3360&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="20031021otveti" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="cc69c067f8ccc019bd001111c1a35ea6" value="1" />
            </form>
    </div>
