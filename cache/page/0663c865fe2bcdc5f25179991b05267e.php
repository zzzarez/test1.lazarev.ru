...
<thead>
	...
	<input type="hidden" name="fb86dfef8fc9a6a36a4313359578a583" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523ba9c4c297f" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="fb86dfef8fc9a6a36a4313359578a583" value="1" />
            </form>
    </div>
