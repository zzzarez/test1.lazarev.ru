...
<thead>
	...
	<input type="hidden" name="a767b55de2074c9c1f3f4fa732cd850a" value="1" /></form>
</div>
    </div>
</div>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
	...
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3744&amp;category_id=8&amp;option=com_virtuemart&amp;Itemid=1"><strong>Семинар 22 и 23 июня 2013г Санкт-Петербург</strong></a><br />    </td>
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3744" method="post" name="delete" style="display: inline;">
...
<!--        </div>-->
        ...
        <input type="hidden" name="a767b55de2074c9c1f3f4fa732cd850a" value="1" />
            </form>
    </div>
<div class="vmCartModule radgrad"><div class='cart_hdr_img'><a style='font-size:14px;color:white;' href='/index.php?page=shop.cart&option=com_virtuemart&Itemid=1'>Корзина</a></div>  <script type="text/javascript">
	    ...
	    sm.disabled = true;
            ...
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=8&amp;product_id=3744&amp;option=com_virtuemart&amp;Itemid=1">Семинар 22 и 23 июня 2013г Санкт-Петербург</a>
            </div>
