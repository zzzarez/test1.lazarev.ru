...
<thead>
	...
	<input type="hidden" name="87a17c5bba9c4841f07457e000ce56a4" value="1" /></form>
</div>
    </div>
</div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="87a17c5bba9c4841f07457e000ce56a4" value="1" />
            </form>
    </div>
<div class="vmCartModule radgrad"><div class='cart_hdr_img'><a style='font-size:14px;color:white;' href='/index.php?page=shop.cart&option=com_virtuemart&Itemid=1'>Корзина</a></div>  <script type="text/javascript">
	    ...
	    sm.disabled = true;
            ...
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=1&amp;product_id=3704&amp;option=com_virtuemart&amp;Itemid=1">Выздоровление души</a>
            </div>
