...
<thead>
	...
	<input type="hidden" name="76e03fbc51620416ce966ea07103665d" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="ghbdtn77@inbox.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="76e03fbc51620416ce966ea07103665d" value="1" />
            </form>
    </div>
