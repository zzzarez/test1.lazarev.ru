...
<thead>
	...
	<input type="hidden" name="063f2a3e52b8ee3d54f7642eca3557eb" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=bf5a417d78efc1f18f29dd61c5c45bf7">
...
<!--        </div>-->
        ...
        <input type="hidden" name="063f2a3e52b8ee3d54f7642eca3557eb" value="1" />
            </form>
    </div>
