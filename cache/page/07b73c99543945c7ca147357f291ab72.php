...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?option=com_content&amp;view=article&amp;id=10&amp;Itemid=41" class="pathway">Помощь</a> <img src="/images/M_images/arrow.png" alt=""  /> Корзина</span>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
	...
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3584&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=41"><strong>Диагностика кармы (вторая серия). Опыт выживания. Часть 1.</strong></a><br />    </td>
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart&Itemid=41" method="post" name="delete" style="display: inline;">
...
<!--  </tr>-->
  ...
  <tr class="sectiontableentry1" style="border-bottom:0px ;border-top: 2px solid rgb(213, 210, 210);">
    ...
    <td  align="right" ><strong>70 р. </strong></td>
      <td></td>
...
<!--  </tr>-->
    ...
    <a href="http://shop.lazarev.ru/index.php?page=checkout.index&amp;ssl_redirect=1&amp;option=com_virtuemart&amp;Itemid=41" title="Оформить заказ" class="checkout_link" onclick="try{ if( !parent.GB ) return GB_showCenter('Оформить заказ', 'http://shop.lazarev.ru/index2.php?page=checkout.index&amp;ssl_redirect=1&amp;option=com_virtuemart&amp;Itemid=41', 500, 600);} catch(e) { }">Оформить заказ</a>	</div>
