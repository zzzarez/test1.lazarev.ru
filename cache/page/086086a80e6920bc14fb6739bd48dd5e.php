...
<thead>
	...
	<input type="hidden" name="4ad0e1ba62a0d7cacbe323764c23958f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3756&amp;category_id=8&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2013090708moskva_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="4ad0e1ba62a0d7cacbe323764c23958f" value="1" />
            </form>
    </div>
