...
<thead>
	...
	<input type="hidden" name="b7b03997bcacac1cb9cb33c0908a5e4f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=9f3e3034b24791f6dee58dab446a8a01">
...
<!--        </div>-->
        ...
        <input type="hidden" name="b7b03997bcacac1cb9cb33c0908a5e4f" value="1" />
            </form>
    </div>
