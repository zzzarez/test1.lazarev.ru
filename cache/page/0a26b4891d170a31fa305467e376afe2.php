...
<thead>
	...
	<input type="hidden" name="cfc4fdc8162fb13834a0242331c6b819" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=da7031c2dd330681ee6a61a0cce0b366">
...
<!--        </div>-->
        ...
        <input type="hidden" name="cfc4fdc8162fb13834a0242331c6b819" value="1" />
            </form>
    </div>
