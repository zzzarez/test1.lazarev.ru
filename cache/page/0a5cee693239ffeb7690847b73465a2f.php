...
<thead>
	...
	<input type="hidden" name="d7a7c5a65c0162fc00d030d27a93e8d8" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3040&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="19940811saratov_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="d7a7c5a65c0162fc00d030d27a93e8d8" value="1" />
            </form>
    </div>
