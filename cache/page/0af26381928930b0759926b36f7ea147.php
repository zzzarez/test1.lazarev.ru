...
<thead>
	...
	<input type="hidden" name="c7565f6f40c4b0700c750fa46ea4f7d9" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3433&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2007092627moskva" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="c7565f6f40c4b0700c750fa46ea4f7d9" value="1" />
            </form>
    </div>
