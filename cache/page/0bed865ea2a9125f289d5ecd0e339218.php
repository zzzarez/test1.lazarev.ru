...
<thead>
	...
	<input type="hidden" name="e8131588bcd7af44fc16543470a54be1" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3225&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2009091213moskva_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="e8131588bcd7af44fc16543470a54be1" value="1" />
            </form>
    </div>
