...
<thead>
	...
	<input type="hidden" name="cee94dd127900896422106b4cffad11c" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523baacef0b2e" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="cee94dd127900896422106b4cffad11c" value="1" />
            </form>
    </div>
