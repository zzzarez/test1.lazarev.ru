...
<thead>
	...
	<input type="hidden" name="372de5f47d870f379106e2d8e6a0aba4" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?page=shop.browse&amp;category_id=8&amp;option=com_virtuemart&amp;Itemid=1" class="pathway">Аудио</a> <img src="/images/M_images/arrow.png" alt=""  /> Москва. 4 и 5 декабря 2010 г (2 дня)</span>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3254&amp;category_id=8&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5232e6046b7b4" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="372de5f47d870f379106e2d8e6a0aba4" value="1" />
            </form>
    </div>
