...
<thead>
	...
	<input type="hidden" name="1c8e8f6577b3ce5d8df48d6f8d450e2c" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="nikolarama@yandex.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="1c8e8f6577b3ce5d8df48d6f8d450e2c" value="1" />
            </form>
    </div>
