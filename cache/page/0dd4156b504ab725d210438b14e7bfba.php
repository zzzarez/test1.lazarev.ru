...
<thead>
	...
	<input type="hidden" name="507ea2c0f1a8a4c360b0490939d22d4a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=e56431e5e12acb09c6289f7f6a8aba84">
...
<!--        </div>-->
        ...
        <input type="hidden" name="507ea2c0f1a8a4c360b0490939d22d4a" value="1" />
            </form>
    </div>
