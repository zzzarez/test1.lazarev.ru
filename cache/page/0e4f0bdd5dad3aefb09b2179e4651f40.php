...
<thead>
	...
	<input type="hidden" name="f831c1590b33de375c7138b64ed9f659" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523389c27ed25" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="f831c1590b33de375c7138b64ed9f659" value="1" />
            </form>
    </div>
