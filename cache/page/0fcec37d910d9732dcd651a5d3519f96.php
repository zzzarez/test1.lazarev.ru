...
<thead>
	...
	<input type="hidden" name="4c763938cabfc0788840ffca8b7f321f" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="veravik@list.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="4c763938cabfc0788840ffca8b7f321f" value="1" />
            </form>
    </div>
