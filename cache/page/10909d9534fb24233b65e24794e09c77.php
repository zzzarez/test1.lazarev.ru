...
<thead>
	...
	<input type="hidden" name="37b0e11768bef1542b81afbae275fe91" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=1d241e66e66481a5414fbc6d40108d71">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"Диагностика кармы. Книга первая. Система полевой саморегуляции."
    </a>
    <br>
        Имя файла: dk1.fb2        <br>
...
<!--        </div>-->
        ...
        <input type="hidden" name="37b0e11768bef1542b81afbae275fe91" value="1" />
            </form>
    </div>
