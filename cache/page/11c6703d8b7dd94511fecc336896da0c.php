...
<thead>
	...
	<input type="hidden" name="0484f00a89a8e374b08b32aab23be714" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=5cc94f459d7a414d115454e5eaaa7484">
...
<!--        </div>-->
        ...
        <input type="hidden" name="0484f00a89a8e374b08b32aab23be714" value="1" />
            </form>
    </div>
