...
<thead>
	...
	<input type="hidden" name="317e9034394a55907e74925f46eb8fe6" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=cfa95feec3b0166bbf9803231eedee80">
...
<!--        </div>-->
        ...
        <input type="hidden" name="317e9034394a55907e74925f46eb8fe6" value="1" />
            </form>
    </div>
