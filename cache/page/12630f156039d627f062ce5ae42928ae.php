...
<thead>
	...
	<input type="hidden" name="befc9d97237a3bcbae2ce08dc3e23bae" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=dc6c2069fcdb7d3f5098ec6a809bc424">
...
<!--        </div>-->
        ...
        <input type="hidden" name="befc9d97237a3bcbae2ce08dc3e23bae" value="1" />
            </form>
    </div>
