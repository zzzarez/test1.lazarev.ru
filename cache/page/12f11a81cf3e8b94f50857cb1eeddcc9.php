...
<thead>
	...
	<input type="hidden" name="02c1f0a071be117cd06d5aae42a3b2f9" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3399&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2006031112germaniya" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="02c1f0a071be117cd06d5aae42a3b2f9" value="1" />
            </form>
    </div>
