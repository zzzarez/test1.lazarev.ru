...
<thead>
	...
	<input type="hidden" name="0ed2d35bd63d803218cd383e9fda986c" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=c64738e707756ec310619635143facd4">
...
<!--        </div>-->
        ...
        <input type="hidden" name="0ed2d35bd63d803218cd383e9fda986c" value="1" />
            </form>
    </div>
