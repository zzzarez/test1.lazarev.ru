...
<thead>
	...
	<input type="hidden" name="ea06b5c3cb40df0fa29e0987550b7cc9" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=9f3f0376162cea834f0f0d7f74873bcd">
...
<!--        </div>-->
        ...
        <input type="hidden" name="ea06b5c3cb40df0fa29e0987550b7cc9" value="1" />
            </form>
    </div>
