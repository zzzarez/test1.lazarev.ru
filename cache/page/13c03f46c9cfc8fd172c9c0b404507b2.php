...
<thead>
	...
	<input type="hidden" name="7a9e56d9dc5327833294ffded022e5d5" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=c82193b5b1cecd1ba0584a83911ca791">
...
<!--        </div>-->
        ...
        <input type="hidden" name="7a9e56d9dc5327833294ffded022e5d5" value="1" />
            </form>
    </div>
