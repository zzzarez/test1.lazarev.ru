...
<thead>
	...
	<input type="hidden" name="d3b60fed95551fb482ba9e0d7b47d6be" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=64efbdecbbc91250e3f245425fbaf757">
...
<!--        </div>-->
        ...
        <input type="hidden" name="d3b60fed95551fb482ba9e0d7b47d6be" value="1" />
            </form>
    </div>
