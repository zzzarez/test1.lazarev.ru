...
<thead>
	...
	<input type="hidden" name="335f4f793a278255d8dee5e215ff9b9b" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=91d7b8ad4d8237496151d2ab00835c12">
...
<!--        </div>-->
        ...
        <input type="hidden" name="335f4f793a278255d8dee5e215ff9b9b" value="1" />
            </form>
    </div>
