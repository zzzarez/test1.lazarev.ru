...
<thead>
	...
	<input type="hidden" name="1224381b8b35dd2169a1c6e6eddaa1bd" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3512&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2011040203piter" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="1224381b8b35dd2169a1c6e6eddaa1bd" value="1" />
            </form>
    </div>
