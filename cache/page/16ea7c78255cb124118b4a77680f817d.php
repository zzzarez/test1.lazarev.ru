...
<thead>
	...
	<input type="hidden" name="4a6b1fdbdf2f09d5e4da839076dde8b9" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=0aa6ddd29cf0ea56871c71241ec347b1">
...
<!--        </div>-->
        ...
        <input type="hidden" name="4a6b1fdbdf2f09d5e4da839076dde8b9" value="1" />
            </form>
    </div>
