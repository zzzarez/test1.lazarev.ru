...
<thead>
	...
	<input type="hidden" name="648e65bf8ef24a307afa947a49ff49ac" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=1b633c516635f34501f72b84b6d379aa">
...
<!--        </div>-->
        ...
        <input type="hidden" name="648e65bf8ef24a307afa947a49ff49ac" value="1" />
            </form>
    </div>
