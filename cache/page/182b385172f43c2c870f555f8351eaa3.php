...
<thead>
	...
	<input type="hidden" name="ab7c940d71ec6e3d3db08da694b5e9c5" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=95ca4673c69684fef1b49fdb8bdd52c4">
...
<!--        </div>-->
        ...
        <input type="hidden" name="ab7c940d71ec6e3d3db08da694b5e9c5" value="1" />
            </form>
    </div>
