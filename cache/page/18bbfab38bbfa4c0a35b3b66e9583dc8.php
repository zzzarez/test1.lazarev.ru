...
<thead>
	...
	<input type="hidden" name="eb0f018457602344c48d8c19b4a3b965" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://shoplazarev.com/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?option=com_content&amp;view=section&amp;layout=blog&amp;id=6&amp;Itemid=44" class="pathway">Новинки</a> <img src="/images/M_images/arrow.png" alt=""  /> Регистрация</span>
...
<script language="javascript" type="text/javascript">
    ...
    function getUsername(){
        ...
        if( form.username.value.length < 3 ) {
            ...
            $('username_ticker').innerHTML	= "<img src=\"http://shoplazarev.com/images/wait.gif\">&nbsp;Checking";
    ...
    function getEmail(){
        ...
        if( !(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,4})+$/.test(form.email.value))) {
           ...
           // $('email_ticker').setHTML("<img src=\"http://shoplazarev.com/images/wait.gif\">&nbsp;Checking");
			...
			return isvalid;
	            ...
	            //]]>
	    </script><form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.registration&Itemid=44" method="post" name="adminForm">
...
<div align="center"><input type="hidden" name="remember" value="yes" />
	...
	<input type="hidden" name="eb0f018457602344c48d8c19b4a3b965" value="1" />
