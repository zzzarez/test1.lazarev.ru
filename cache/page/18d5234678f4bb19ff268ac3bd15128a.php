...
<thead>
	...
	<input type="hidden" name="b6baf4cb2e7a434c1fa0abdaea775423" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=a26fd3b99b016ef101692ca5f937eddc">
...
<!--        </div>-->
        ...
        <input type="hidden" name="b6baf4cb2e7a434c1fa0abdaea775423" value="1" />
            </form>
    </div>
