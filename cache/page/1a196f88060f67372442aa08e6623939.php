...
<thead>
	...
	<input type="hidden" name="f3c0152ac59426a14d23095e754fb62e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=0cc3fbdcee5387279239eb1d2b95fb50">
...
<!--        </div>-->
        ...
        <input type="hidden" name="f3c0152ac59426a14d23095e754fb62e" value="1" />
            </form>
    </div>
