...
<thead>
	...
	<input type="hidden" name="f332b5ffa4b5f433c3fb1cc124d28c99" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3326&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="1999100910piter" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="f332b5ffa4b5f433c3fb1cc124d28c99" value="1" />
            </form>
    </div>
