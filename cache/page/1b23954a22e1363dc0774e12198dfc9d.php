...
<thead>
	...
	<input type="hidden" name="71b3bcf9f1a275558b781ec16216a7a0" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3295&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="1995052728ekaterinburg" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="71b3bcf9f1a275558b781ec16216a7a0" value="1" />
            </form>
    </div>
