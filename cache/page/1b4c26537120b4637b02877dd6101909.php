...
<thead>
	...
	<input type="hidden" name="45523b3d26edcc9d8e7fdbea88b6baef" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://www.shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?page=shop.browse&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1" class="pathway">Видео</a> <img src="/images/M_images/arrow.png" alt=""  /> Самара. 6 февраля 2009 г.</span>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3462&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5238e02a2b0b8" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="45523b3d26edcc9d8e7fdbea88b6baef" value="1" />
            </form>
    </div>
