...
<thead>
	...
	<input type="hidden" name="9e5c9b1dfdb769318bfd8c718696354f" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52389717362b5" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="9e5c9b1dfdb769318bfd8c718696354f" value="1" />
            </form>
    </div>
