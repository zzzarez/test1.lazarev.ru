...
<thead>
	...
	<input type="hidden" name="9bdb902f270d17f61f7e70495125fd40" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=b67fd2074cc4f741c2c801019f6cde36">
...
<!--        </div>-->
        ...
        <input type="hidden" name="9bdb902f270d17f61f7e70495125fd40" value="1" />
            </form>
    </div>
