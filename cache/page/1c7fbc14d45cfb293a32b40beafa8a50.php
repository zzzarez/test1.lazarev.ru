...
<thead>
	...
	<input type="hidden" name="a4aeacc648325283610257c28ba24f2d" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3754&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=37">Вернуться к товару</a>
	<br /><br />
...
<!--        </div>-->
        ...
        <input type="hidden" name="a4aeacc648325283610257c28ba24f2d" value="1" />
            </form>
    </div>
