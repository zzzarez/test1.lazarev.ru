...
<thead>
	...
	<input type="hidden" name="1edd28eada32bb24d4f00f9b435d3c61" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_RUS_DVD_DK_front.jpg" height="292" width="200" alt="Алматы. 30 мая 2000 г. (весна)" border="0" />    </div>
    <div class="fly_name">
        <b align="left">Алматы. 30 мая 2000 г. (весна)</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3328&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52367733ec650" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Алматы. 30 мая 2000 г. (весна)","140");var sm=document.getElementById("sbm_btn3328");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3328" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3328" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3328" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="1edd28eada32bb24d4f00f9b435d3c61" value="1" />
            </form>
    </div>
