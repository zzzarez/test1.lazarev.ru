...
<thead>
	...
	<input type="hidden" name="0201537fc848c0532459323245feb17b" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="andrej-valov@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="0201537fc848c0532459323245feb17b" value="1" />
            </form>
    </div>
