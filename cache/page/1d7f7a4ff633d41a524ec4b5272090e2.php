...
<thead>
	...
	<input type="hidden" name="f2033a23bdb66d7dbe3d3213328b22bc" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523baadbf15c1" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="f2033a23bdb66d7dbe3d3213328b22bc" value="1" />
            </form>
    </div>
