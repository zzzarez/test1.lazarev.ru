...
<thead>
	...
	<input type="hidden" name="b97e63d8c13b4be00b4650600175df62" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=272232e6d2b3fa82176be410d2bf254a">
...
<!--        </div>-->
        ...
        <input type="hidden" name="b97e63d8c13b4be00b4650600175df62" value="1" />
            </form>
    </div>
