...
<thead>
	...
	<input type="hidden" name="1e34ed0a2c67699d81ea3600ec7f810a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3528&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="20120213otveti" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="1e34ed0a2c67699d81ea3600ec7f810a" value="1" />
            </form>
    </div>
