...
<thead>
	...
	<input type="hidden" name="14146d5485e2b9aca4bf969acd6d36fa" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_RUS_DVD_DK_front.jpg" height="292" width="200" alt="Израиль. 25 марта 2001 г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Израиль. 25 марта 2001 г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3337&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5234e8512b2e1" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Израиль. 25 марта 2001 г.","140");var sm=document.getElementById("sbm_btn3337");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3337" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3337" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3337" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="14146d5485e2b9aca4bf969acd6d36fa" value="1" />
            </form>
    </div>
