...
<thead>
	...
	<input type="hidden" name="a2ea2a7376c45d75cbf6e35ee696e5da" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=9dc33d1e221afec70dafb0c1a62106ee">
...
<!--        </div>-->
        ...
        <input type="hidden" name="a2ea2a7376c45d75cbf6e35ee696e5da" value="1" />
            </form>
    </div>
