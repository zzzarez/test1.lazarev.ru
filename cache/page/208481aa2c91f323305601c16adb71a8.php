...
<thead>
	...
	<input type="hidden" name="493b48fb0fc1055debc3ae39bcf03098" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=1854241222ebc200fbee3163fa7fc4ab">
...
<!--        </div>-->
        ...
        <input type="hidden" name="493b48fb0fc1055debc3ae39bcf03098" value="1" />
            </form>
    </div>
