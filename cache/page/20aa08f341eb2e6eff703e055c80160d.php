...
<thead>
	...
	<input type="hidden" name="8ce6df6aabbb948eeec61f7f711ca001" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=b078bfed7135c452bdaad3aebe9a115c">
...
<!--        </div>-->
        ...
        <input type="hidden" name="8ce6df6aabbb948eeec61f7f711ca001" value="1" />
            </form>
    </div>
