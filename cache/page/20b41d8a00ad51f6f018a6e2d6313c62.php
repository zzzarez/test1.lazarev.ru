...
<thead>
	...
	<input type="hidden" name="dcafefae43451bfd8ea86ca8f7d4b19d" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=b47507cb18d88d2f8c1ad4dbf1490a04">
...
<!--        </div>-->
        ...
        <input type="hidden" name="dcafefae43451bfd8ea86ca8f7d4b19d" value="1" />
            </form>
    </div>
