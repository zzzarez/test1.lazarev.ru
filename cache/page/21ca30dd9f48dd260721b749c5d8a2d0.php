...
<thead>
	...
	<input type="hidden" name="2526cbbd0eed6b80a6fce033dbff9eb1" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523acfa18d898" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="2526cbbd0eed6b80a6fce033dbff9eb1" value="1" />
            </form>
    </div>
