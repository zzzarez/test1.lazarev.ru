...
<thead>
	...
	<input type="hidden" name="38534824441b7b8bbcf26b5de72ba4c0" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?page=shop.browse&amp;category_id=8&amp;option=com_virtuemart&amp;Itemid=1" class="pathway">Аудио</a> <img src="/images/M_images/arrow.png" alt=""  /> С-Петербург. 2 и 3 апреля 2002 г. (2 дня)</span>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3092&amp;category_id=8&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5235eae6baacb" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="38534824441b7b8bbcf26b5de72ba4c0" value="1" />
            </form>
    </div>
