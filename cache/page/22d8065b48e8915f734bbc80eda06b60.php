...
<thead>
	...
	<input type="hidden" name="b68796ae9cb349f0bfbf65d215dcc8e6" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3371&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="20040512kiev" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="b68796ae9cb349f0bfbf65d215dcc8e6" value="1" />
            </form>
    </div>
