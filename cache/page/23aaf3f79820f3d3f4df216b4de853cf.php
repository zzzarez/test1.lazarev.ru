...
<thead>
	...
	<input type="hidden" name="cdb107400a24f80c38c74b1116a49cd5" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=18431fe77da2e930250d21d24abf10db">
...
<!--        </div>-->
        ...
        <input type="hidden" name="cdb107400a24f80c38c74b1116a49cd5" value="1" />
            </form>
    </div>
