...
<thead>
	...
	<input type="hidden" name="ac52b9abd67280721682c0320237dca5" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523ba9ee8d286" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="ac52b9abd67280721682c0320237dca5" value="1" />
            </form>
    </div>
