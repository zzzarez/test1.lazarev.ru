...
<thead>
	...
	<input type="hidden" name="8bce3ec87163ef7cfaabed64615d2ec7" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=8256252456a580fb94c25da7a96daffb">
...
<!--        </div>-->
        ...
        <input type="hidden" name="8bce3ec87163ef7cfaabed64615d2ec7" value="1" />
            </form>
    </div>
