...
<thead>
	...
	<input type="hidden" name="354fe319fe256666e9f48cd362ac1aec" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="ankakononova@yandex.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="354fe319fe256666e9f48cd362ac1aec" value="1" />
            </form>
    </div>
