...
<thead>
	...
	<input type="hidden" name="2bd6f76c0d15172a53a259a1768c4ece" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=aab6e724edc5d0655165cd9c7d281cc7">
...
<!--        </div>-->
        ...
        <input type="hidden" name="2bd6f76c0d15172a53a259a1768c4ece" value="1" />
            </form>
    </div>
