...
<thead>
	...
	<input type="hidden" name="1702da15be1421aa88cf4350eb58e7ef" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=176642bcc166bf4235e584bb71a23987">
...
<!--        </div>-->
        ...
        <input type="hidden" name="1702da15be1421aa88cf4350eb58e7ef" value="1" />
            </form>
    </div>
