...
<thead>
	...
	<input type="hidden" name="2ebad9a07038f8d9e7a46eb604a0dbb4" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523b7576b2f0d" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="2ebad9a07038f8d9e7a46eb604a0dbb4" value="1" />
            </form>
    </div>
