...
<thead>
	...
	<input type="hidden" name="189e7a95dfd5ea9b664bdd5fc10d2a96" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5232c382d9d00" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="189e7a95dfd5ea9b664bdd5fc10d2a96" value="1" />
            </form>
    </div>
