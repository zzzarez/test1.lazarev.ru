...
<thead>
	...
	<input type="hidden" name="dafa6dc672969f6404dceaf2d05ab2aa" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=e06146d60edcd84f0a2e9147dbc28d7f">
...
<!--        </div>-->
        ...
        <input type="hidden" name="dafa6dc672969f6404dceaf2d05ab2aa" value="1" />
            </form>
    </div>
