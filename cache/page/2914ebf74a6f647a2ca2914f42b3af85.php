...
<thead>
	...
	<input type="hidden" name="513b0ec6936d9b6acd8a7a6aa966362e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=7b1de02bebe08c0aca95d6069573f697">
...
<!--        </div>-->
        ...
        <input type="hidden" name="513b0ec6936d9b6acd8a7a6aa966362e" value="1" />
            </form>
    </div>
