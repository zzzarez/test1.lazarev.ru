...
<thead>
	...
	<input type="hidden" name="ad607b9387156b29e0b8d7137977411f" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52338114a9128" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="ad607b9387156b29e0b8d7137977411f" value="1" />
            </form>
    </div>
