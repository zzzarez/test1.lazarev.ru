...
<thead>
	...
	<input type="hidden" name="32c0584521e3db5a914c7d2c806c937a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3643&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="55519940711bumerang_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="32c0584521e3db5a914c7d2c806c937a" value="1" />
            </form>
    </div>
