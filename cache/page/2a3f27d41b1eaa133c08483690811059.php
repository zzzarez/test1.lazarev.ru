...
<thead>
	...
	<input type="hidden" name="660a12a8123da5af9f2ec01b7afcbe60" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=b136c1cb90a9b17154336e0aedd3a916">
...
<!--        </div>-->
        ...
        <input type="hidden" name="660a12a8123da5af9f2ec01b7afcbe60" value="1" />
            </form>
    </div>
