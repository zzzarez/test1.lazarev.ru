...
<thead>
	...
	<input type="hidden" name="28337ce3af9acba02960b804a48fddc0" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=44302c02f50cd8d3c3078ebc1d6fbfad">
...
<!--        </div>-->
        ...
        <input type="hidden" name="28337ce3af9acba02960b804a48fddc0" value="1" />
            </form>
    </div>
