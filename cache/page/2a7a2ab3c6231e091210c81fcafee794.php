...
<thead>
	...
	<input type="hidden" name="b18783878ccd8cd64f3777668e4c8d65" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3077&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="1999101314moskva_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="b18783878ccd8cd64f3777668e4c8d65" value="1" />
            </form>
    </div>
