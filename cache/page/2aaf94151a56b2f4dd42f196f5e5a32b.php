...
<thead>
	...
	<input type="hidden" name="c2330b9e707ac468553a68ccf3c9bea3" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=aa296b2618f616df5b35c39d0ac3f068">
...
<!--        </div>-->
        ...
        <input type="hidden" name="c2330b9e707ac468553a68ccf3c9bea3" value="1" />
            </form>
    </div>
