...
<thead>
	...
	<input type="hidden" name="65106cbd75a21985b1668ee51becf75c" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=185a75f3fc6b55aece83d64e471bd653">
...
<!--        </div>-->
        ...
        <input type="hidden" name="65106cbd75a21985b1668ee51becf75c" value="1" />
            </form>
    </div>
