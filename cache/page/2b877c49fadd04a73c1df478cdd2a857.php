...
<thead>
	...
	<input type="hidden" name="fb5cc9383c6a698f3ec58f04a42ee268" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5238a2266ed2e" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="fb5cc9383c6a698f3ec58f04a42ee268" value="1" />
            </form>
    </div>
