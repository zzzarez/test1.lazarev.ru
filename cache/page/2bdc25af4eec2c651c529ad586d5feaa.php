...
<thead>
	...
	<input type="hidden" name="1202552b3ceee90d10fa88bbefce29a2" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=a21029aa7364396bbc04dbeb42d781ca">
...
<!--        </div>-->
        ...
        <input type="hidden" name="1202552b3ceee90d10fa88bbefce29a2" value="1" />
            </form>
    </div>
