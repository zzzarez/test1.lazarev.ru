...
<thead>
	...
	<input type="hidden" name="2c7c709f64ac120e9a5e83dc0e94b498" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=0846356eff7b7eb080c83aa044b4459e">
...
<!--        </div>-->
        ...
        <input type="hidden" name="2c7c709f64ac120e9a5e83dc0e94b498" value="1" />
            </form>
    </div>
