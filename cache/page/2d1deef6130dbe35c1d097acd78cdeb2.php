...
<thead>
	...
	<input type="hidden" name="593e0fe4ce2d950ee0cf80aff2df35aa" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=a61410971b9f1f27a402d0e104cd5c4b">
...
<!--        </div>-->
        ...
        <input type="hidden" name="593e0fe4ce2d950ee0cf80aff2df35aa" value="1" />
            </form>
    </div>
