...
<thead>
	...
	<input type="hidden" name="f430fa249c93211356dcf704de7d1ef1" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=665451d63374a5804749cd21e8beee79">
...
<!--        </div>-->
        ...
        <input type="hidden" name="f430fa249c93211356dcf704de7d1ef1" value="1" />
            </form>
    </div>
