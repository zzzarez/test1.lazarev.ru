...
<thead>
	...
	<input type="hidden" name="82f36f6b1132ca403a7204455af5c158" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3434&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2007101314germaniya" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="82f36f6b1132ca403a7204455af5c158" value="1" />
            </form>
    </div>
