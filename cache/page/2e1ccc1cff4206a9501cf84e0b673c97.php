...
<thead>
	...
	<input type="hidden" name="fa3d466e973b565f11d571167172b5a6" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=edc003063b1a5d78da6856714fb5fe98">
...
<!--        </div>-->
        ...
        <input type="hidden" name="fa3d466e973b565f11d571167172b5a6" value="1" />
            </form>
    </div>
