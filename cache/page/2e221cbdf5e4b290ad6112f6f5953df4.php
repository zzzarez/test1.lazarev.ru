...
<thead>
	...
	<input type="hidden" name="9ddbf710c98a9f887b2f9aac69cf7d8f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=5064e6cfe2e57e1d8d4513dea7a51c18">
...
<!--        </div>-->
        ...
        <input type="hidden" name="9ddbf710c98a9f887b2f9aac69cf7d8f" value="1" />
            </form>
    </div>
