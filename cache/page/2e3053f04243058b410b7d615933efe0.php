...
<thead>
	...
	<input type="hidden" name="308463773b922fdef72e08a13d1110de" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="nat.0504@yandex.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="308463773b922fdef72e08a13d1110de" value="1" />
            </form>
    </div>
