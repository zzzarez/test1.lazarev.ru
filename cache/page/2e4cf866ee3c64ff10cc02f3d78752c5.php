...
<thead>
	...
	<input type="hidden" name="13d9b5a2ee15e20d9eadda91fe27d5c1" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=c205b58b141dc34623d3382d7ac894d7">
...
<!--        </div>-->
        ...
        <input type="hidden" name="13d9b5a2ee15e20d9eadda91fe27d5c1" value="1" />
            </form>
    </div>
