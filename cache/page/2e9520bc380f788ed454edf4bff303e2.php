...
<thead>
	...
	<input type="hidden" name="c234211c16f5bba77ab4e6013f170b18" value="1" /></form>
</div>
    </div>
</div>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
      ...
      <td ><img class='cart_prod_img' src='/components/com_virtuemart/shop_image/product/rus_cb_01_pcvb.jpg'></td>
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3577&amp;category_id=0&amp;option=com_virtuemart&amp;Itemid=1"><strong>Человек будущего. Первый шаг в будущее.</strong></a><br />    </td>
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3577" method="post" name="delete" style="display: inline;">
...
<!--        </div>-->
        ...
        <input type="hidden" name="c234211c16f5bba77ab4e6013f170b18" value="1" />
            </form>
    </div>
