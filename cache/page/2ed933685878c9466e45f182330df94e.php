...
<thead>
	...
	<input type="hidden" name="c7ff0bc1204524e1e2084050f2bbce3f" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523b5080512df" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="c7ff0bc1204524e1e2084050f2bbce3f" value="1" />
            </form>
    </div>
