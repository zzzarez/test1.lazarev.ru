...
<thead>
	...
	<input type="hidden" name="be8b77fee0d74bb3de0248711725fff4" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="post_vafelka@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="be8b77fee0d74bb3de0248711725fff4" value="1" />
            </form>
    </div>
