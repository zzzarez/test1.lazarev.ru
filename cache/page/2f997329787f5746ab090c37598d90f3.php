...
<thead>
	...
	<input type="hidden" name="f4c2fdf1d9cd3d7ffab53bdd371c3942" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3331&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=39">Вернуться к товару</a>
	<br /><br />
...
<!--        </div>-->
        ...
        <input type="hidden" name="f4c2fdf1d9cd3d7ffab53bdd371c3942" value="1" />
            </form>
    </div>
