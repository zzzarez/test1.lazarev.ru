...
<thead>
	...
	<input type="hidden" name="c5edcb4ab25b7b0db1b36b4db8864384" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3043&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="19941216surgut_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="c5edcb4ab25b7b0db1b36b4db8864384" value="1" />
            </form>
    </div>
