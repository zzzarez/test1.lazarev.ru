...
<thead>
	...
	<input type="hidden" name="2d51074eb822767164e8843585839b75" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=252ec837b9425c7b020a1fc2e45785e4">
...
<!--        </div>-->
        ...
        <input type="hidden" name="2d51074eb822767164e8843585839b75" value="1" />
            </form>
    </div>
