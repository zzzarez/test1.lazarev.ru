...
<thead>
	...
	<input type="hidden" name="b57315bf3b6e2c04d25c5a80c91fcbde" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3494&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2010061213germany" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="b57315bf3b6e2c04d25c5a80c91fcbde" value="1" />
            </form>
    </div>
