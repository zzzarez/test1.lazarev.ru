...
<thead>
	...
	<input type="hidden" name="d6b51eef7db517a910f07decfae483c4" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=bc73d8007ea83faee5c3ec016f6613fc">
...
<!--        </div>-->
        ...
        <input type="hidden" name="d6b51eef7db517a910f07decfae483c4" value="1" />
            </form>
    </div>
