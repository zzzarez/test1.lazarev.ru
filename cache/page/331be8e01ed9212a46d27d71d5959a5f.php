...
<thead>
	...
	<input type="hidden" name="98eee11931166c6f8ce4b4c81bce2dbe" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5233cba27aa85" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="98eee11931166c6f8ce4b4c81bce2dbe" value="1" />
            </form>
    </div>
