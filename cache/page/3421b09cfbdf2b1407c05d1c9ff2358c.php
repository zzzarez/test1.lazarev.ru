...
<thead>
	...
	<input type="hidden" name="7ebe4f4c4be97041a525047f17047a9f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3531&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2012030910moskva" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="7ebe4f4c4be97041a525047f17047a9f" value="1" />
            </form>
    </div>
