...
<thead>
	...
	<input type="hidden" name="2008a5e4be9508c0784c1393738633cc" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_audio.jpg" height="192" width="200" alt="Ответы на вопросы 21 января 2013 г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Ответы на вопросы 21 января 2013 г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3707&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5233eed67f6d4" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Ответы на вопросы 21 января 2013 г.","100");var sm=document.getElementById("sbm_btn3707");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3707" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3707" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3707" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<p><img src="images/stories/IMG_2823.JPG" width="340" height="255" alt="IMG 2823" /></p></div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="2008a5e4be9508c0784c1393738633cc" value="1" />
            </form>
    </div>
