...
<thead>
	...
	<input type="hidden" name="1e4fdeee3c89ad1e7b652037a5bc900f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=676e5e9e98591c0de586bf93900fb70c">
...
<!--        </div>-->
        ...
        <input type="hidden" name="1e4fdeee3c89ad1e7b652037a5bc900f" value="1" />
            </form>
    </div>
