...
<thead>
	...
	<input type="hidden" name="343b004110fb89d8928e522734ae6780" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="legon84@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="343b004110fb89d8928e522734ae6780" value="1" />
            </form>
    </div>
