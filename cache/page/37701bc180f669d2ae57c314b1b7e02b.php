...
<thead>
	...
	<input type="hidden" name="2b21937f727804dd2181ef58e7840bf8" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_RUS_DVD_DK2_front.jpg" height="292" width="200" alt="Ответы на вопросы    21 января 2013г" border="0" />    </div>
    <div class="fly_name">
        <b align="left">Ответы на вопросы    21 января 2013г</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3708&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523a7e504638e" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Ответы на вопросы    21 января 2013г","140");var sm=document.getElementById("sbm_btn3708");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3708" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3708" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3708" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<div class="fly_desc_wrp">
    <p><b>Ответы на вопросы 21 января 2013 г.</b></p>
<p>С.Н.Лазарев отвечает на вопросы читателей, присланные ему для онлайн-семинара и на сайт lazarev.org, а также на записки с прошедших семинаров.</p>
<p><img src="images/stories/IMG_2823.JPG" width="180" height="135" alt="IMG 2823" /></p></div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="2b21937f727804dd2181ef58e7840bf8" value="1" />
            </form>
    </div>
