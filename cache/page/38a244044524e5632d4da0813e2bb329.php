...
<thead>
	...
	<input type="hidden" name="d9732f7d6ffd34ece6dee5e5feac8406" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=336088866204f7f03c87940a9b81630c">
...
<!--        </div>-->
        ...
        <input type="hidden" name="d9732f7d6ffd34ece6dee5e5feac8406" value="1" />
            </form>
    </div>
