...
<thead>
	...
	<input type="hidden" name="9000843690c6d91757bffec312d5af4e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=19e5d9d9103b2100b6030e657fea3adc">
...
<!--        </div>-->
        ...
        <input type="hidden" name="9000843690c6d91757bffec312d5af4e" value="1" />
            </form>
    </div>
