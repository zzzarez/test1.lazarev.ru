...
<thead>
	...
	<input type="hidden" name="b4b16a282c7168cfbdcd110252e42157" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=f609786c33023b3d8047b9d01987ecca">
...
<!--        </div>-->
        ...
        <input type="hidden" name="b4b16a282c7168cfbdcd110252e42157" value="1" />
            </form>
    </div>
