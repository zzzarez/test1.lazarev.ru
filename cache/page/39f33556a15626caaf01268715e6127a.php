...
<thead>
	...
	<input type="hidden" name="fe42f5e7e7e628e22f7e97fb56229a7a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=4ef9d9aba5797a2a2eda8b79748f2f11">
...
<!--        </div>-->
        ...
        <input type="hidden" name="fe42f5e7e7e628e22f7e97fb56229a7a" value="1" />
            </form>
    </div>
