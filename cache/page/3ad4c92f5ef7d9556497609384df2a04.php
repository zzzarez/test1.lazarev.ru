...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_audio.jpg" height="192" width="200" alt="Саратов. 10 декабря 1997 г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Саратов. 10 декабря 1997 г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3066&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523817567ffd6" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Саратов. 10 декабря 1997 г.","100");var sm=document.getElementById("sbm_btn3066");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3066" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3066" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3066" class="addtocart_button" value="Купить" title="Купить" />
            </div>
