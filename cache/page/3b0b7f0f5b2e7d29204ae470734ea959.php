...
<thead>
	...
	<input type="hidden" name="c4b827f1908e2cf9796329d7080ab99f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=0daaf48a88a0b311fa71eeaf6e9762ac">
...
<!--        </div>-->
        ...
        <input type="hidden" name="c4b827f1908e2cf9796329d7080ab99f" value="1" />
            </form>
    </div>
