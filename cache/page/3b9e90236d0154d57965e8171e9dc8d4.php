...
<thead>
	...
	<input type="hidden" name="659609025b7bc2190d3db586da30a6f0" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_RUS_DVD_DK_front.jpg" height="292" width="200" alt="Владивосток. 14 сентября 2005 г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Владивосток. 14 сентября 2005 г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3389&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52389722495d6" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Владивосток. 14 сентября 2005 г.","140");var sm=document.getElementById("sbm_btn3389");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3389" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3389" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3389" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="659609025b7bc2190d3db586da30a6f0" value="1" />
            </form>
    </div>
