	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		<tr>
			<td colspan="2" height="40">
				<p>Для завершения процедуры сброса пароля, пожалуйста, введите новый пароль.</p>
			</td>
		</tr>
		<tr>
			<td height="40">
				<label for="password1" class="hasTip" title="Пароль::Пожалуйста, введите новый пароль для вашей учетной записи.">Пароль:</label>
			</td>
			<td>
		...
		<tr>
			<td height="40">
				<label for="password2" class="hasTip" title="Подтвердите пароль::Пожалуйста, введите пароль ещё раз.">Подтверждение:</label>
			</td>
			<td>
