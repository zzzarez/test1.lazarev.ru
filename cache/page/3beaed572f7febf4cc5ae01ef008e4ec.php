...
<thead>
	...
	<input type="hidden" name="64af947bba76c60b4cd6b3f5c5152d42" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=d1bf3843fd1d744014cfdf67b239fa43">
...
<!--        </div>-->
        ...
        <input type="hidden" name="64af947bba76c60b4cd6b3f5c5152d42" value="1" />
            </form>
    </div>
