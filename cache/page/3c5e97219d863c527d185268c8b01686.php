...
<thead>
	...
	<input type="hidden" name="6643cfc7bfc33dba48d83f9e38f3ef89" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=89c912203c5069b6a0f894c2b7c667f9">
...
<!--        </div>-->
        ...
        <input type="hidden" name="6643cfc7bfc33dba48d83f9e38f3ef89" value="1" />
            </form>
    </div>
