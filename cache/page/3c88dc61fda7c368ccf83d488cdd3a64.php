...
<thead>
	...
	<input type="hidden" name="0350804f9f4440334a544d8227d66f4d" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=8871caafcdcf50020d8f975e3c7f6038">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"Диагностика кармы (вторая серия). Опыт выживания. Часть 6."
    </a>
    <br>
        Имя файла: dkII6.pdf        <br>
...
<!--        </div>-->
        ...
        <input type="hidden" name="0350804f9f4440334a544d8227d66f4d" value="1" />
            </form>
    </div>
