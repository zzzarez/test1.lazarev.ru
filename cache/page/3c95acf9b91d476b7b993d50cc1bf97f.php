...
<thead>
	...
	<input type="hidden" name="365b5d8840b5c714c8940dddf5bbc20a" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523b85e9329b1" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="365b5d8840b5c714c8940dddf5bbc20a" value="1" />
            </form>
    </div>
