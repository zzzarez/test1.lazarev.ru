...
<thead>
	...
	<input type="hidden" name="9abe790d8daca0f9d9bf9b8db7480ea3" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=0c41f23268323b56ce7b0ecb702aa26b">
...
<!--        </div>-->
        ...
        <input type="hidden" name="9abe790d8daca0f9d9bf9b8db7480ea3" value="1" />
            </form>
    </div>
