...
<thead>
	...
	<input type="hidden" name="2bec5b94d556c4d8cd92995532028cdb" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523a69102fcc9" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="2bec5b94d556c4d8cd92995532028cdb" value="1" />
            </form>
    </div>
