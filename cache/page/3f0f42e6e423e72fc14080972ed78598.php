...
<thead>
	...
	<input type="hidden" name="d159e906591e9f67920c6d62cf0bfb06" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3067&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="19971212volgograd_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="d159e906591e9f67920c6d62cf0bfb06" value="1" />
            </form>
    </div>
