...
<thead>
	...
	<input type="hidden" name="d07021a3c34d957eb5b7fd030079a18b" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=f62dcc790ab694966b92d38c2eb25a48">
...
<!--        </div>-->
        ...
        <input type="hidden" name="d07021a3c34d957eb5b7fd030079a18b" value="1" />
            </form>
    </div>
