...
<thead>
	...
	<input type="hidden" name="61483b9461f0f91a880536f4bf5d6e01" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=a8bbe820c91730c7ea7f8609824dd3fa">
...
<!--        </div>-->
        ...
        <input type="hidden" name="61483b9461f0f91a880536f4bf5d6e01" value="1" />
            </form>
    </div>
