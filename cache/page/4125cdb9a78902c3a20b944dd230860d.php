...
<thead>
	...
	<input type="hidden" name="e183c730c169cb5414671625c731ac11" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5238990b999f5" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="e183c730c169cb5414671625c731ac11" value="1" />
            </form>
    </div>
