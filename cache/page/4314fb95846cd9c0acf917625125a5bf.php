...
<thead>
	...
	<input type="hidden" name="a7a88a72f972853540c3c32a2b2b362e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=293c7bcf98ff91d92b1165ff9086b47e">
...
<!--        </div>-->
        ...
        <input type="hidden" name="a7a88a72f972853540c3c32a2b2b362e" value="1" />
            </form>
    </div>
