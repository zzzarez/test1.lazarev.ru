...
<thead>
	...
	<input type="hidden" name="661a4fd736c960594354f7aad96299d9" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=ae24d99ecb6c37d0cdd059abd67082f0">
...
<!--        </div>-->
        ...
        <input type="hidden" name="661a4fd736c960594354f7aad96299d9" value="1" />
            </form>
    </div>
