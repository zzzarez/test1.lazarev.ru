...
<thead>
	...
	<input type="hidden" name="bcd612e1b5bc692845b50edc355fb9cd" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=eb5c44e4f693406861cf882ece05cfce">
...
<!--        </div>-->
        ...
        <input type="hidden" name="bcd612e1b5bc692845b50edc355fb9cd" value="1" />
            </form>
    </div>
