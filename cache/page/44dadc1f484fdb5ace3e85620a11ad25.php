...
<thead>
	...
	<input type="hidden" name="b3115fa38befc465140e707e59f02904" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3662&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52356443e4511" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Запорожье. 7 июня 2003 г.","100");var sm=document.getElementById("sbm_btn3662");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3662" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3662" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3662" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="b3115fa38befc465140e707e59f02904" value="1" />
            </form>
    </div>
