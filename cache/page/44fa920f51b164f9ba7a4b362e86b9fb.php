...
<thead>
	...
	<input type="hidden" name="bd4c1cf3b12a06f642978eaaaf46b19c" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=89fb0e741d4dae3740b9cc3a1c3a3209">
...
<!--        </div>-->
        ...
        <input type="hidden" name="bd4c1cf3b12a06f642978eaaaf46b19c" value="1" />
            </form>
    </div>
