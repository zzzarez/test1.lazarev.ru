...
<thead>
	...
	<input type="hidden" name="fdd9d938fa2362ff788257f6328fa829" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5235f10fe0664" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="fdd9d938fa2362ff788257f6328fa829" value="1" />
            </form>
    </div>
