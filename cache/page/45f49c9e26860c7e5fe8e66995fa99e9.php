...
<thead>
	...
	<input type="hidden" name="62751927f0e1650c3c87c36564ec580f" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523baa0a2ee0a" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="62751927f0e1650c3c87c36564ec580f" value="1" />
            </form>
    </div>
