...
<thead>
	...
	<input type="hidden" name="839f0123c9bba6402ba26b9190cc0b3a" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523897cdbacc3" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="839f0123c9bba6402ba26b9190cc0b3a" value="1" />
            </form>
    </div>
