...
<thead>
	...
	<input type="hidden" name="2d3203aeb881d5d9128377647fda8aae" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=d440b5909551125657ffb82bf8bfb8df">
...
<!--        </div>-->
        ...
        <input type="hidden" name="2d3203aeb881d5d9128377647fda8aae" value="1" />
            </form>
    </div>
