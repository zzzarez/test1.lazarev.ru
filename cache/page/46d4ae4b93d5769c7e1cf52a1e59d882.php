...
<thead>
	...
	<input type="hidden" name="b08e8680d0c6f1e59220a3c4d79a5b6a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3314&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="19970917piter" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="b08e8680d0c6f1e59220a3c4d79a5b6a" value="1" />
            </form>
    </div>
