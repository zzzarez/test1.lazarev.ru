...
<thead>
	...
	<input type="hidden" name="800e28647556f917032998a253da26bc" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52327832b3c6b" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="800e28647556f917032998a253da26bc" value="1" />
            </form>
    </div>
