...
<thead>
	...
	<input type="hidden" name="34add86a82ea2fdf10d23b65f415016d" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=50f7b000ed830fad1b3a84dcb1f9f372">
...
<!--        </div>-->
        ...
        <input type="hidden" name="34add86a82ea2fdf10d23b65f415016d" value="1" />
            </form>
    </div>
