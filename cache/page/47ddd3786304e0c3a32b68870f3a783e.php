...
<thead>
	...
	<input type="hidden" name="318da75cdf3e77c682394bb0da8c6ef0" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=2423bcb1efdd72f1d077622170618c62">
...
<!--        </div>-->
        ...
        <input type="hidden" name="318da75cdf3e77c682394bb0da8c6ef0" value="1" />
            </form>
    </div>
