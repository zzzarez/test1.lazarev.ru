...
<thead>
	...
	<input type="hidden" name="d79ef381e19be1c15598faea3da9b7de" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=379e7b0cbdfe76ea11596bc501dfc0b1">
...
<!--        </div>-->
        ...
        <input type="hidden" name="d79ef381e19be1c15598faea3da9b7de" value="1" />
            </form>
    </div>
