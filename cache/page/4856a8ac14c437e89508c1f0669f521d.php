...
<thead>
	...
	<input type="hidden" name="75e0aab627b630d6da15c34acebe19ae" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3401&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2006041516piter" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="75e0aab627b630d6da15c34acebe19ae" value="1" />
            </form>
    </div>
