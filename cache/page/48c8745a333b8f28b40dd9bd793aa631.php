...
<thead>
	...
	<input type="hidden" name="e78c0023995997ebeb844fe330722623" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="otryfonov@gmail.com" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="e78c0023995997ebeb844fe330722623" value="1" />
            </form>
    </div>
