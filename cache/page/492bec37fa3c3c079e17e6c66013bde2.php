...
<thead>
	...
	<input type="hidden" name="9a2a546988979279365a97bd1a6a7911" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523896a6cb34d" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="9a2a546988979279365a97bd1a6a7911" value="1" />
            </form>
    </div>
