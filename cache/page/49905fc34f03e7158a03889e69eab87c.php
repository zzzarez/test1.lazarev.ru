...
<thead>
	...
	<input type="hidden" name="12d1b2404fca46e24850aaea98dadc7e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=99a7a3694cc6ee57f77ba3ac62a2d9bd">
...
<!--        </div>-->
        ...
        <input type="hidden" name="12d1b2404fca46e24850aaea98dadc7e" value="1" />
            </form>
    </div>
