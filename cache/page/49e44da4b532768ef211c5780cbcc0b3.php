...
<thead>
	...
	<input type="hidden" name="c265ec4e2c6c61ceb71dedc2b8e23b2b" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523baa3398c0f" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="c265ec4e2c6c61ceb71dedc2b8e23b2b" value="1" />
            </form>
    </div>
