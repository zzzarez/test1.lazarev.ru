...
<thead>
	...
	<input type="hidden" name="4e5fdb15674fd8e015c939f78eaa011e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3099&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2003031819piter_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="4e5fdb15674fd8e015c939f78eaa011e" value="1" />
            </form>
    </div>
