...
<thead>
	...
	<input type="hidden" name="4c8380e84f0fb71f1ded7739856b849a" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> Помогают ли вам разделы &quot;Помощь&quot; и &quot;Варианты оплаты&quot; при оформлении и покупке заказа?</span>
...
<div class="contentpane">
	<label for="id">
		Выберите голосование		<select name="id" id="id" class="inputbox" size="1" style="width:200px" onchange="if (this.options[selectedIndex].value != '') {document.location.href=this.options[selectedIndex].value}"><option value="" >Выберите голосование из списка</option><option value="/index.php?option=com_poll&amp;id=15:2012-05-31-15-02-28" >Какой раздел нужно доработать?</option><option value="/index.php?option=com_poll&amp;id=16:--------apple-app-store" >Будет ли Вам интересно покупать электронные книги в Apple App Store?</option><option value="/index.php?option=com_poll&amp;id=17:--------blu-ray-" >Будут ли вам интересны видео лекции в формате Blu-Ray? </option><option value="/index.php?option=com_poll&amp;id=18:2013-02-13-15-55-44" >Будут ли Вам интересны аудио книги?</option><option value="/index.php?option=com_poll&amp;id=19:-qq-q-q-"  selected="selected">Помогают ли вам разделы "Помощь" и "Варианты оплаты" при оформлении и покупке заказа?</option></select>	</label>
</div>
<div class="contentpane">
<br />
<table class="pollstableborder" cellspacing="0" cellpadding="0" border="0">
<thead>
	<tr>
		<th colspan="3" class="sectiontableheader">
			...
			Помогают ли вам разделы &quot;Помощь&quot; и &quot;Варианты оплаты&quot; при оформлении и покупке заказа?		</th>
	</tr>
</thead>
<tbody>
	...
	<tr class="sectiontableentry0">
		...
		<td width="300" >
			<div class="polls_color_1" style="height:4px;width:66.2%"></div>
		</td>
	</tr>
	<tr class="sectiontableentry1">
		<td width="100%" colspan="3">
			Следует доработать раздел &quot;Варианты оплаты&quot;		</td>
	</tr>
	<tr class="sectiontableentry1">
		<td align="right" width="25">
			<strong>251</strong>&nbsp;
		...
		<td width="300" >
			<div class="polls_color_2" style="height:4px;width:24.6%"></div>
		</td>
	</tr>
	<tr class="sectiontableentry0">
		<td width="100%" colspan="3">
			Нет, ничего не помогает		</td>
	</tr>
	<tr class="sectiontableentry0">
		<td align="right" width="25">
			<strong>63</strong>&nbsp;
		...
		<td width="300" >
			<div class="polls_color_3" style="height:4px;width:6.2%"></div>
		</td>
	</tr>
	<tr class="sectiontableentry1">
		<td width="100%" colspan="3">
			Следует доработать раздел &quot;Помощь&quot;		</td>
	</tr>
	<tr class="sectiontableentry1">
		<td align="right" width="25">
			<strong>30</strong>&nbsp;
		...
		<td width="300" >
			<div class="polls_color_4" style="height:4px;width:2.9%"></div>
		</td>
	</tr>
</tbody>
</table>
...
<!--        </div>-->
        ...
        <input type="hidden" name="4c8380e84f0fb71f1ded7739856b849a" value="1" />
            </form>
    </div>
