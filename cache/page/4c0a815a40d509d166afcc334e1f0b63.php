...
<thead>
	...
	<input type="hidden" name="f194dcb2cccb47efce5649846db2c2e2" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523a13970927d" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="f194dcb2cccb47efce5649846db2c2e2" value="1" />
            </form>
    </div>
