...
<thead>
	...
	<input type="hidden" name="0004eb0677fc6c3b25effdf7b79fd26d" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3095&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2002071112belgorod_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="0004eb0677fc6c3b25effdf7b79fd26d" value="1" />
            </form>
    </div>
