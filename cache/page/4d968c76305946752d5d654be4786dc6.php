...
<thead>
	...
	<input type="hidden" name="dfa5682168a43ee956fe8d248cbaf9af" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="handemah@list.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="dfa5682168a43ee956fe8d248cbaf9af" value="1" />
            </form>
    </div>
