...
<thead>
	...
	<input type="hidden" name="736e5a7d355e238dc5c40310db20e65c" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3653&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5235f4d2f417f" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "С.-Петербург. 21 и 22 ноября 1998 г. (2 дня)","200");var sm=document.getElementById("sbm_btn3653");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3653" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3653" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3653" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="736e5a7d355e238dc5c40310db20e65c" value="1" />
            </form>
    </div>
