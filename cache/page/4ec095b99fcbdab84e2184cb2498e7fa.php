...
<thead>
	...
	<input type="hidden" name="62badb444a1831064f1679f6d24505b0" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=a1b416a1911cd0905885ee4acfbbd179">
...
<!--        </div>-->
        ...
        <input type="hidden" name="62badb444a1831064f1679f6d24505b0" value="1" />
            </form>
    </div>
