...
<thead>
	...
	<input type="hidden" name="bcd7e9729d1250e37e4e24a669d4dc03" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=9004ab0c6a49a6b6b916ee6adc20b43c">
...
<!--        </div>-->
        ...
        <input type="hidden" name="bcd7e9729d1250e37e4e24a669d4dc03" value="1" />
            </form>
    </div>
