...
<thead>
	...
	<input type="hidden" name="034f4654c60812b3573fa99790a0c29b" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3658&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5238d898d69ea" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "С-Петербург. 10 и 11 ноября 2000 г. (2 дня)","200");var sm=document.getElementById("sbm_btn3658");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3658" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3658" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3658" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="034f4654c60812b3573fa99790a0c29b" value="1" />
            </form>
    </div>
