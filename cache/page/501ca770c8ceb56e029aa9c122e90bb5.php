...
<thead>
	...
	<input type="hidden" name="e816cd91737999576fdaee74c4396014" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3192&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2008021516moskva_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="e816cd91737999576fdaee74c4396014" value="1" />
            </form>
    </div>
