...
<thead>
	...
	<input type="hidden" name="3facbadec9486efbdae0e6fecd6ed8b7" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523baa280e276" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="3facbadec9486efbdae0e6fecd6ed8b7" value="1" />
            </form>
    </div>
