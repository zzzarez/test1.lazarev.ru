...
<thead>
	...
	<input type="hidden" name="0e2cd760cbdad6fe2ce5b5fbb2f4b75a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=e55bcfd707128f5a02d47bf8720b6e20">
...
<!--        </div>-->
        ...
        <input type="hidden" name="0e2cd760cbdad6fe2ce5b5fbb2f4b75a" value="1" />
            </form>
    </div>
