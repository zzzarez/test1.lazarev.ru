...
<thead>
	...
	<input type="hidden" name="b73746583962c65407457dbe98bfde64" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523abf004d1bb" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="b73746583962c65407457dbe98bfde64" value="1" />
            </form>
    </div>
