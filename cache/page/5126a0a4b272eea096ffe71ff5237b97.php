...
<thead>
	...
	<input type="hidden" name="9ffe229cc7ce9cf2052c2cb0dee7b856" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523b573ae2b5c" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="9ffe229cc7ce9cf2052c2cb0dee7b856" value="1" />
            </form>
    </div>
