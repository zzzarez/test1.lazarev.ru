...
<thead>
	...
	<input type="hidden" name="0d1ed9432e8df5355e568df5d57c0e42" value="1" /></form>
</div>
    </div>
</div>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3723" method="post" name="delete" style="display: inline;">
  ...
  <tr valign="top" class="sectiontableentry1">
      ...
      <td ><img class='cart_prod_img' src='/components/com_virtuemart/shop_image/product/RUS_DVD_DK2_front.jpg'></td>
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3723&amp;category_id=0&amp;option=com_virtuemart&amp;Itemid=1"><strong>Семинар 23 и 24 марта 2013г Германия</strong></a><br />    </td>
      <td style="vertical-align: middle;width: 70px;" align='center'>
          <b style='font-size:11px;'>электронная версия<br>(avi)</b>      </td>
...
<!--  </tr>-->
  ...
  <tr class="sectiontableentry1" style="border-bottom:0px ;border-top: 2px solid rgb(213, 210, 210);">
    ...
    <td  align="right" ><strong>840 р. </strong></td>
      <td></td>
...
<!--        </div>-->
        ...
        <input type="hidden" name="0d1ed9432e8df5355e568df5d57c0e42" value="1" />
            </form>
    </div>
...
<div style="float: left;font-size: 11px;padding: 10px;font-weight: bold;color: red;" >
    ...
    <input type="hidden" id="totalprice_hlp" value="840"/>
...
всего: <font style='font-size:14px;margin-left:7px;line-height:0px;'>840 р. </font></div>
