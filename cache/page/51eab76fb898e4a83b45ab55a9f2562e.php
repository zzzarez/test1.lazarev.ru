...
<thead>
	...
	<input type="hidden" name="e178db720b708aa9bec182d8afa7703d" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="migerova85@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="e178db720b708aa9bec182d8afa7703d" value="1" />
            </form>
    </div>
