...
<thead>
	...
	<input type="hidden" name="ba4457de6e8e4fa66734b216bd9ca89b" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=742ecea3b0accf1a79327cb04afba629">
...
<!--        </div>-->
        ...
        <input type="hidden" name="ba4457de6e8e4fa66734b216bd9ca89b" value="1" />
            </form>
    </div>
