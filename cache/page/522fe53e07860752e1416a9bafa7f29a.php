...
<thead>
	...
	<input type="hidden" name="8ae7cdedae6726cf3cc0d888a023bba0" value="1" /></form>
</div>
    </div>
</div>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
	...
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3756&amp;category_id=0&amp;option=com_virtuemart&amp;Itemid=1"><strong>Москва. 7 и 8 сентября 2013г.</strong></a><br />    </td>
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3754" method="post" name="delete" style="display: inline;">
...
<!--  </tr>-->
  ...
  <tr class="sectiontableentry1" style="border-bottom:0px ;border-top: 2px solid rgb(213, 210, 210);">
    ...
    <td  align="right" ><strong>760 р. </strong></td>
      <td></td>
...
<!--        </div>-->
        ...
        <input type="hidden" name="8ae7cdedae6726cf3cc0d888a023bba0" value="1" />
            </form>
    </div>
...
<div style="float: left;font-size: 11px;padding: 10px;font-weight: bold;color: red;" >
    ...
    <input type="hidden" id="totalprice_hlp" value="760"/>
...
всего: <font style='font-size:14px;margin-left:7px;line-height:0px;'>760 р. </font></div>
