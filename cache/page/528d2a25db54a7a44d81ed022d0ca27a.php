...
<thead>
	...
	<input type="hidden" name="8266eeba8de8b9a8ffde5a3f4be47d5b" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=b895929f246791ce479e8df9da987b95">
...
<!--        </div>-->
        ...
        <input type="hidden" name="8266eeba8de8b9a8ffde5a3f4be47d5b" value="1" />
            </form>
    </div>
