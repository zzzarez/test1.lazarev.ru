...
<thead>
	...
	<input type="hidden" name="bba95de0b85f08c1ff791de37d8cd260" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52389799c9544" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="bba95de0b85f08c1ff791de37d8cd260" value="1" />
            </form>
    </div>
