...
<thead>
	...
	<input type="hidden" name="36b605f2f5c0014a498269a6e98a7bd5" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://www.shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?page=shop.browse&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1" class="pathway">Видео</a> <img src="/images/M_images/arrow.png" alt=""  /> 4 лекции перед приемом. 1999 г.</span>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3655&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523394575e934" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "4 лекции перед приемом. 1999 г.","100");var sm=document.getElementById("sbm_btn3655");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3655" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3655" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3655" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="36b605f2f5c0014a498269a6e98a7bd5" value="1" />
            </form>
    </div>
