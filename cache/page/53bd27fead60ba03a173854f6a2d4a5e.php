...
<thead>
	...
	<input type="hidden" name="79bd6b5d3fe73edceab24a3d0fd2891b" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=5549f8bcaa9a9e714a69770b8aa41004">
...
<!--        </div>-->
        ...
        <input type="hidden" name="79bd6b5d3fe73edceab24a3d0fd2891b" value="1" />
            </form>
    </div>
