...
<thead>
	...
	<input type="hidden" name="b3b31ab46b8b8e7681a480740efb62e1" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=7f636772a8d9f48e8ad0b24a3f79c6cb">
...
<!--        </div>-->
        ...
        <input type="hidden" name="b3b31ab46b8b8e7681a480740efb62e1" value="1" />
            </form>
    </div>
