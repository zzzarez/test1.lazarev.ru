...
<thead>
	...
	<input type="hidden" name="218cc7c2fc89e8bbd3db05a582c111fe" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5238efc1dcc7c" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="218cc7c2fc89e8bbd3db05a582c111fe" value="1" />
            </form>
    </div>
