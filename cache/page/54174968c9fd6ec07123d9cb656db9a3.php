...
<thead>
	...
	<input type="hidden" name="bfbef2a353dde81ec2850892c2202edd" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3654&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523b53b42803b" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Москва. 7 и 8 декабря 1998 г. (2 дня)","200");var sm=document.getElementById("sbm_btn3654");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3654" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3654" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3654" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="bfbef2a353dde81ec2850892c2202edd" value="1" />
            </form>
    </div>
