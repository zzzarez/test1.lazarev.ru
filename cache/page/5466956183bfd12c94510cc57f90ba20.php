...
<thead>
	...
	<input type="hidden" name="5256468020cd4ce83ee32b2bebea6624" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="korchagin@phys.vsu.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="5256468020cd4ce83ee32b2bebea6624" value="1" />
            </form>
    </div>
