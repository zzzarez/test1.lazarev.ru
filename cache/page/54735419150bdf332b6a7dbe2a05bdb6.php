...
<thead>
	...
	<input type="hidden" name="14e72e02be730b4153be2b399738a958" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3537&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2012022122varshava" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="14e72e02be730b4153be2b399738a958" value="1" />
            </form>
    </div>
