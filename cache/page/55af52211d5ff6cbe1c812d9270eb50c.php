...
<thead>
	...
	<input type="hidden" name="682bdf8b2de1456d1c0014289a654a10" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=55948452934b7e47dd5b40e7e3695905">
...
<!--        </div>-->
        ...
        <input type="hidden" name="682bdf8b2de1456d1c0014289a654a10" value="1" />
            </form>
    </div>
