...
<thead>
	...
	<input type="hidden" name="8c8a480253aefd9f184bd757952b1739" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://www.shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?page=shop.browse&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1" class="pathway">Видео</a> <img src="/images/M_images/arrow.png" alt=""  /> Ритмы Освобождения Сознания. Часть 4.</span>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_ritm4.png" height="192" width="200" alt="Ритмы Освобождения Сознания. Часть 4." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Ритмы Освобождения Сознания. Часть 4.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3598&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523a6b4b9f2b5" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Ритмы Освобождения Сознания. Часть 4.","100");var sm=document.getElementById("sbm_btn3598");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3598" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3598" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3598" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="8c8a480253aefd9f184bd757952b1739" value="1" />
            </form>
    </div>
