...
<thead>
	...
	<input type="hidden" name="a4fdbb1c135e5afb9941e4541b2bdf24" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3150&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=41">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2006041516piter_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="a4fdbb1c135e5afb9941e4541b2bdf24" value="1" />
            </form>
    </div>
