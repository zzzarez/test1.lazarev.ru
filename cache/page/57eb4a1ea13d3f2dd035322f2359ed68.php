...
<thead>
	...
	<input type="hidden" name="f8e0c05aba353ba4bd183ebe3d8e4bff" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=32fac918c0272d5b55f984e238d944fb">
...
<!--        </div>-->
        ...
        <input type="hidden" name="f8e0c05aba353ba4bd183ebe3d8e4bff" value="1" />
            </form>
    </div>
