...
<thead>
	...
	<input type="hidden" name="303b3e2b893e10bedc5ec00aece063bf" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=0b183c5045af797e20a2c42aa5e18ce6">
...
<!--        </div>-->
        ...
        <input type="hidden" name="303b3e2b893e10bedc5ec00aece063bf" value="1" />
            </form>
    </div>
