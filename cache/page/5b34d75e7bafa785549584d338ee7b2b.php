...
<thead>
	...
	<input type="hidden" name="7a66037db9c085eae1a00491a13219fa" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=df5739a7f004c9bb7d97471280e9468a">
...
<!--        </div>-->
        ...
        <input type="hidden" name="7a66037db9c085eae1a00491a13219fa" value="1" />
            </form>
    </div>
