...
<thead>
	...
	<input type="hidden" name="cde355a5ef076444ef6b942da4466a3e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=a1db36339b36523e2117a07f1ab8afde">
...
<!--        </div>-->
        ...
        <input type="hidden" name="cde355a5ef076444ef6b942da4466a3e" value="1" />
            </form>
    </div>
