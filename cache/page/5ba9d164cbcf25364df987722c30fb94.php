...
<thead>
	...
	<input type="hidden" name="5d003cec45307766f5550a4caa62556f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=befe7de27f1e37c453ca2aaa45fe2915">
...
<!--        </div>-->
        ...
        <input type="hidden" name="5d003cec45307766f5550a4caa62556f" value="1" />
            </form>
    </div>
