...
<thead>
	...
	<input type="hidden" name="03efaeccfc4e4c8d155339994cd21132" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=0a7253c0ae4c3d32182cd4abf0aaba78">
...
<!--        </div>-->
        ...
        <input type="hidden" name="03efaeccfc4e4c8d155339994cd21132" value="1" />
            </form>
    </div>
