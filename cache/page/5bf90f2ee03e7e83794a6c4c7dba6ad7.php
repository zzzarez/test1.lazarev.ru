...
<thead>
	...
	<input type="hidden" name="ce023f22d04de2acb4feb1ed5956d2af" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_audio.jpg" height="192" width="200" alt="Екатеринбург. 2 декабря 2004 г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Екатеринбург. 2 декабря 2004 г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3125&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5234c2f6ce8f4" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Екатеринбург. 2 декабря 2004 г.","100");var sm=document.getElementById("sbm_btn3125");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3125" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3125" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3125" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<div class="fly_desc_wrp">
    Екатеринбург. 2 декабря 2004 г.</div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="ce023f22d04de2acb4feb1ed5956d2af" value="1" />
            </form>
    </div>
