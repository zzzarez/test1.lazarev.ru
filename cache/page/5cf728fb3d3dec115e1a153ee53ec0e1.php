...
<thead>
	...
	<input type="hidden" name="fee935fe717b8fb8dc1573c4eb7a379f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=4cf23b180a4097fc0380dd0943ef8277">
...
<!--        </div>-->
        ...
        <input type="hidden" name="fee935fe717b8fb8dc1573c4eb7a379f" value="1" />
            </form>
    </div>
