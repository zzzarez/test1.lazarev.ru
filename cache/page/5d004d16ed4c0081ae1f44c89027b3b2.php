...
<thead>
	...
	<input type="hidden" name="9f91ca527fbe5fb477688f46f27625d1" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=75446ab5b3211cf013fe680858f62fa0">
...
<!--        </div>-->
        ...
        <input type="hidden" name="9f91ca527fbe5fb477688f46f27625d1" value="1" />
            </form>
    </div>
