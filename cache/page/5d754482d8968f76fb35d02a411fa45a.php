...
<thead>
	...
	<input type="hidden" name="0cd8708dfa2f6850363345a40c0fb5de" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5238ccc1e1746" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="0cd8708dfa2f6850363345a40c0fb5de" value="1" />
            </form>
    </div>
