...
<thead>
	...
	<input type="hidden" name="d8fdfd4b357dff6b2bec2e001931a962" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3674&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="7772007062324volgograd_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="d8fdfd4b357dff6b2bec2e001931a962" value="1" />
            </form>
    </div>
