...
<thead>
	...
	<input type="hidden" name="688fd520dae9fb9bfd7dc4dd737d3e93" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523baa249edff" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="688fd520dae9fb9bfd7dc4dd737d3e93" value="1" />
            </form>
    </div>
