...
<thead>
	...
	<input type="hidden" name="43a1f7964ddb706e68724cd43734793a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=e7abf7e73fca139b87c5d3b23bdd4950">
...
<!--        </div>-->
        ...
        <input type="hidden" name="43a1f7964ddb706e68724cd43734793a" value="1" />
            </form>
    </div>
