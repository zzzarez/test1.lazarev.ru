...
<thead>
	...
	<input type="hidden" name="503fe462b8e84a0ff32f03a7a7d51a8a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3073&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="1998120708moskva_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="503fe462b8e84a0ff32f03a7a7d51a8a" value="1" />
            </form>
    </div>
