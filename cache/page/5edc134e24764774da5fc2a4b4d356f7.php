...
<thead>
	...
	<input type="hidden" name="f4064429448d45743dd683a6bace5d4e" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523889de842c0" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="f4064429448d45743dd683a6bace5d4e" value="1" />
            </form>
    </div>
