...
<thead>
	...
	<input type="hidden" name="28d1ce141d2b530f666aa37b952571f7" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="sta-rta@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="28d1ce141d2b530f666aa37b952571f7" value="1" />
            </form>
    </div>
