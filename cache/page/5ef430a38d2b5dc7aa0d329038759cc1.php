...
<thead>
	...
	<input type="hidden" name="2b6023df8caeb06fc60ae979ad71e15c" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="lora0724@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="2b6023df8caeb06fc60ae979ad71e15c" value="1" />
            </form>
    </div>
