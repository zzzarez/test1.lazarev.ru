...
<thead>
	...
	<input type="hidden" name="9fcafd0f5a3adebf1a1ac440d0cb7d2e" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523a8ab27fcee" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="9fcafd0f5a3adebf1a1ac440d0cb7d2e" value="1" />
            </form>
    </div>
