...
<thead>
	...
	<input type="hidden" name="83e905bee0b14ebc869f0742153c5415" value="1" /></form>
</div>
    </div>
</div>
...
<h2 align="center">
    <b>
        8 сентября (второй день)<br> </b>

</h2>

 <b>Семинар Лазарева С.Н.<br>
     г. Москва, 8 сентября  2013 года (второй день)<br>      11.00 – 15.00 по московскому времени<br>
 </b><br>
<br><br>
...
<!--    <img src="/images/zag.jpg" alt="">-->
                <br><br><br><br>
                <iframe name="prolivestream" src="http://facecast.net/player/?stream=live91&stream_lines=720&def_q=4&autoPlay=false&title=pro-stream.ru&poster=https://dl.dropboxusercontent.com/s/8dugixs8e7gm8hu/plyaerbackground.jpg&width=549&height=309" scrolling="no" frameborder="no" height="339" width="550"></iframe>

<!--                <iframe src="http://broadcast.comdi.com/broadcast/player/stream/?eventKey=ammh7moyyy9kc9dlexuf" width="565" height="350" frameborder="0" scrolling="no"></iframe>-->
                <!--                <iframe src="http://broadcast.comdi.com/broadcast/player/stream/?eventKey=f4xvdhmcgoshg4urlmp1" width="565" height="350" frameborder="0" scrolling="no"></iframe>-->
...
<!--        </div>-->
        ...
        <input type="hidden" name="83e905bee0b14ebc869f0742153c5415" value="1" />
            </form>
    </div>
