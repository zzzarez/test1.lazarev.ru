...
<thead>
	...
	<input type="hidden" name="6948690983eb44acad07514dadd08ce8" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3601&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523737749baca" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="6948690983eb44acad07514dadd08ce8" value="1" />
            </form>
    </div>
