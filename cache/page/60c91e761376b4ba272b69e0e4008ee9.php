...
<thead>
	...
	<input type="hidden" name="613c6c3642b7974bb31e6ffeb70f18c4" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3634&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="7772006030405odessa" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="613c6c3642b7974bb31e6ffeb70f18c4" value="1" />
            </form>
    </div>
