...
<thead>
	...
	<input type="hidden" name="d22aa858314c4b99fea099895db02d5c" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=cf1268b95a09bb4777c1284e078a6fa3">
...
<!--        </div>-->
        ...
        <input type="hidden" name="d22aa858314c4b99fea099895db02d5c" value="1" />
            </form>
    </div>
