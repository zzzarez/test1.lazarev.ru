...
<thead>
	...
	<input type="hidden" name="079e02f0a80dfd52cb1a209c90a41c4b" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3753&amp;category_id=8&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2013081718praga_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="079e02f0a80dfd52cb1a209c90a41c4b" value="1" />
            </form>
    </div>
