...
<thead>
	...
	<input type="hidden" name="3ccfbc66f9068198659589fea1369ff7" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=027d6e49f51e657a3c47439e4709b851">
...
<!--        </div>-->
        ...
        <input type="hidden" name="3ccfbc66f9068198659589fea1369ff7" value="1" />
            </form>
    </div>
