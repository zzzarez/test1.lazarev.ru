...
<thead>
	...
	<input type="hidden" name="af3a807f1d817c7ab2eb476a36a70a6f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=5c879c311af7a53a4cef32dbc4161bbe">
...
<!--        </div>-->
        ...
        <input type="hidden" name="af3a807f1d817c7ab2eb476a36a70a6f" value="1" />
            </form>
    </div>
