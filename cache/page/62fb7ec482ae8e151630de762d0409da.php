...
<thead>
	...
	<input type="hidden" name="60f273cad2ca951147c343d60b3bffc5" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="aleksander.dmitrow@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="60f273cad2ca951147c343d60b3bffc5" value="1" />
            </form>
    </div>
