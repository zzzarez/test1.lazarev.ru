...
<thead>
	...
	<input type="hidden" name="7f4cadee1f1dd5a28a169bc709deaea6" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523588b8796d2" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="7f4cadee1f1dd5a28a169bc709deaea6" value="1" />
            </form>
    </div>
