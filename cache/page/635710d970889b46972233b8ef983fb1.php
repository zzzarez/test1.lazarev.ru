...
<thead>
	...
	<input type="hidden" name="9a581089aae58c0e391b0204691f3e2a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=e49ba1942b526afbf7b5fc47d3ef1302">
...
<!--        </div>-->
        ...
        <input type="hidden" name="9a581089aae58c0e391b0204691f3e2a" value="1" />
            </form>
    </div>
