...
<thead>
	...
	<input type="hidden" name="da65ae84f58a91b3041770bddab1e6ac" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=c80c2fe12bf45c18da45fe65d3a80c66">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"С-Петербург. 7 сентября 1995 г."
    </a>
    <br>
        Имя файла: 19950907piter.mp3        <br>
...
<!--        </div>-->
        ...
        <input type="hidden" name="da65ae84f58a91b3041770bddab1e6ac" value="1" />
            </form>
    </div>
