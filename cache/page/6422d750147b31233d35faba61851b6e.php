...
<thead>
	...
	<input type="hidden" name="ef7f2494aa8f3d33d1227f7bf5c11bdb" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3677&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523ae76e63543" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Германия. Семинар 19 и 20 января 2008 г. (2 дня)","200");var sm=document.getElementById("sbm_btn3677");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3677" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3677" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3677" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="ef7f2494aa8f3d33d1227f7bf5c11bdb" value="1" />
            </form>
    </div>
