...
<thead>
	...
	<input type="hidden" name="1c4aa06657a43f48fedc43c9d3886b3d" value="1" /></form>
</div>
    </div>
</div>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
	...
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3578&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1"><strong>Человек будущего. Воспитание родителей. Часть 1.</strong></a><br />    </td>
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3578" method="post" name="delete" style="display: inline;">
...
<!--        </div>-->
        ...
        <input type="hidden" name="1c4aa06657a43f48fedc43c9d3886b3d" value="1" />
            </form>
    </div>
<div class="vmCartModule radgrad"><div class='cart_hdr_img'><a style='font-size:14px;color:white;' href='/index.php?page=shop.cart&option=com_virtuemart&Itemid=1'>Корзина</a></div>  <script type="text/javascript">
	    ...
	    sm.disabled = true;
            ...
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=1&amp;product_id=3578&amp;option=com_virtuemart&amp;Itemid=1">Человек будущего. Воспитание родителей. Часть 1.</a>
            </div>
