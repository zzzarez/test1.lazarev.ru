...
<thead>
	...
	<input type="hidden" name="fd8fa3cbeccc8c9066235657a73a5f8c" value="1" /></form>
</div>
    </div>
</div>
...
<!--    <a style="font-size:14px;"title="Регистрация" href="/index.php?option=com_virtuemart&page=shop.registration&Itemid=1"> | Регистрация </a>-->
	...
	<input type="hidden" name="return" value="L2luZGV4LnBocD9wYWdlPWFjY291bnQub3JkZXJfZGV0YWlscyZvcmRlcl9pZD04MTc5NSZvcHRpb249Y29tX3ZpcnR1ZW1hcnQmSXRlbWlkPTE=" />
	<input type="hidden" name="fd8fa3cbeccc8c9066235657a73a5f8c" value="1" />
</form>
</div>
