...
<thead>
	...
	<input type="hidden" name="277c314e892a2b37097a3be47d5f9e35" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3061&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=41">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="1997052326moskva_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="277c314e892a2b37097a3be47d5f9e35" value="1" />
            </form>
    </div>
