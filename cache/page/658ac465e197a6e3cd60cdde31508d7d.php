...
<thead>
	...
	<input type="hidden" name="5c5b2e273be17fa4cae590f0343df576" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523899901310f" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="5c5b2e273be17fa4cae590f0343df576" value="1" />
            </form>
    </div>
