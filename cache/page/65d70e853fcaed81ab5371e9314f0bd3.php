...
<thead>
	...
	<input type="hidden" name="9a88deffad9d0b36546bf3e1fbbcd81a" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://mx.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?page=shop.browse&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1" class="pathway">Видео</a> <img src="/images/M_images/arrow.png" alt=""  /> Алматы. Семинар 30 апреля и 1 мая 2011 г.(2 дня)</span>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523ada64cf62f" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="9a88deffad9d0b36546bf3e1fbbcd81a" value="1" />
            </form>
    </div>
