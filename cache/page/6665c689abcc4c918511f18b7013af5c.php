...
<thead>
	...
	<input type="hidden" name="93ede9bcffdfeedcc725d63e02c3edc8" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523ba9e10138f" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="93ede9bcffdfeedcc725d63e02c3edc8" value="1" />
            </form>
    </div>
