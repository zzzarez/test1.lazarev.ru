...
<thead>
	...
	<input type="hidden" name="da96efc00019056626cdb098e30fa55d" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div ><div class="shop_error">Извините, но запрашиваемый файл не найден на сервере. Возможная причина: Неправильный путь<br />
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=17e5e617d56223519a60729e1eab6c30">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"Билет на онлайн - трансляцию 13 апреля (первый день семинара)"
    </a>
    <br>
        Имя файла: aga_view1.htm        <br>
        Оставшееся количество скачиваний: 5        <br> <br><br><br>
    <script>
...
<!--        </div>-->
        ...
        <input type="hidden" name="da96efc00019056626cdb098e30fa55d" value="1" />
            </form>
    </div>
