...
<thead>
	...
	<input type="hidden" name="bb09e306e7e4187bf249e88dc8619af0" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="mihail.zemlyankin@yandex.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="bb09e306e7e4187bf249e88dc8619af0" value="1" />
            </form>
    </div>
