...
<thead>
	...
	<input type="hidden" name="a10d257fb3ea6cfe04b4cda23eda1b09" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="xenya_2000@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="a10d257fb3ea6cfe04b4cda23eda1b09" value="1" />
            </form>
    </div>
