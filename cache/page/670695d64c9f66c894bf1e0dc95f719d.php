...
<thead>
	...
	<input type="hidden" name="ed68b0e5cf82ebb667b4c0bba1b217f4" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3039&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523c2b00d224d" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="ed68b0e5cf82ebb667b4c0bba1b217f4" value="1" />
            </form>
    </div>
