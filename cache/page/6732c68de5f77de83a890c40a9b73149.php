...
<thead>
	...
	<input type="hidden" name="4ac9a3374c350fb6383abffced43f0ee" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5237b3ec45afd" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="4ac9a3374c350fb6383abffced43f0ee" value="1" />
            </form>
    </div>
