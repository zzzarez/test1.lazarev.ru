...
<thead>
	...
	<input type="hidden" name="a28b05c96000c64fddc0ea7b7e86167e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=7d4066af04ca1ab3a1fb60dd480d75d1">
...
<!--        </div>-->
        ...
        <input type="hidden" name="a28b05c96000c64fddc0ea7b7e86167e" value="1" />
            </form>
    </div>
