...
<thead>
	...
	<input type="hidden" name="1cdfcdc91dd09a4bbea5605ddeaf456b" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_audio.jpg" height="192" width="200" alt="Москва. 19, 20 и 21 апреля 2005 г. (3 дня)" border="0" />    </div>
    <div class="fly_name">
        <b align="left">Москва. 19, 20 и 21 апреля 2005 г. (3 дня)</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3131&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5239befbcfddf" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Москва. 19, 20 и 21 апреля 2005 г. (3 дня)","300");var sm=document.getElementById("sbm_btn3131");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3131" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3131" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3131" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="1cdfcdc91dd09a4bbea5605ddeaf456b" value="1" />
            </form>
    </div>
