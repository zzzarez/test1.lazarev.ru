...
<thead>
	...
	<input type="hidden" name="d234e00a17fd34864cf493953c4096d9" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3755&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=39">Вернуться к товару</a>
	<br /><br />
...
<!--        </div>-->
        ...
        <input type="hidden" name="d234e00a17fd34864cf493953c4096d9" value="1" />
            </form>
    </div>
