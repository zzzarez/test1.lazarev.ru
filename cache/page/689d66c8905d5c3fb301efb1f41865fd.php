...
<thead>
	...
	<input type="hidden" name="c28a08b6cf010cc780b93ca91d4e58cc" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_RUS_DVD_DK_front.jpg" height="292" width="200" alt="4 лекции перед приемом. 1999 г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">4 лекции перед приемом. 1999 г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3325&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5236bc222e854" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "4 лекции перед приемом. 1999 г.","140");var sm=document.getElementById("sbm_btn3325");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3325" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3325" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3325" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<div class="fly_desc_wrp">
    <b> 4 лекции перед приемом 1999 г. </b> <br />Агрессия к любви, к людям, зависимость от духовных и материальных ценностей. Как родить здорового ребенка. Уединение, ревность, желание, воля, жизнь, обиды, осуждение. Сохранение любви при любых потерях. Подготовка к молитве.</div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="c28a08b6cf010cc780b93ca91d4e58cc" value="1" />
            </form>
    </div>
