...
<thead>
	...
	<input type="hidden" name="235bff02d4dd870d8bfc1ec035cf243d" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3667&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="7772005030506moskva_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="235bff02d4dd870d8bfc1ec035cf243d" value="1" />
            </form>
    </div>
