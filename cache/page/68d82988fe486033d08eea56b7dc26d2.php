...
<thead>
	...
	<input type="hidden" name="0c573c99724bafd6a4afc4e09a043bcf" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523928ced822d" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="0c573c99724bafd6a4afc4e09a043bcf" value="1" />
            </form>
    </div>
