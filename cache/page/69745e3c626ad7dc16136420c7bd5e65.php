...
<thead>
	...
	<input type="hidden" name="d687e966c2441c405f04da0984db9290" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=883f62fbf371ceae5da26c5c7a74f0a4">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"Диагностика кармы (вторая серия). Опыт выживания. Часть 5."
    </a>
    <br>
        Имя файла: dkII5.doc        <br>
...
<!--        </div>-->
        ...
        <input type="hidden" name="d687e966c2441c405f04da0984db9290" value="1" />
            </form>
    </div>
