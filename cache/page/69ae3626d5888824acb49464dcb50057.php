...
<thead>
	...
	<input type="hidden" name="dedaf042045a19645c05bb545357736f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3648&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="55519960617yakutsk_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="dedaf042045a19645c05bb545357736f" value="1" />
            </form>
    </div>
