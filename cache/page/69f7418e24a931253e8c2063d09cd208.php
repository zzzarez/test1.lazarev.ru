...
<thead>
	...
	<input type="hidden" name="18c1494165224bc405ae25ef9c521921" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://www.shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> Корзина</span>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
      ...
      <td ><img class='cart_prod_img' src='/components/com_virtuemart/shop_image/product/rus_dk_1_12.jpg'></td>
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3576&amp;category_id=0&amp;option=com_virtuemart&amp;Itemid=1"><strong>Диагностика кармы. Книга двенадцатая. Жизнь, как взмах крыльев бабочки.</strong></a><br />    </td>
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3576" method="post" name="delete" style="display: inline;">
...
<!--        </div>-->
        ...
        <input type="hidden" name="18c1494165224bc405ae25ef9c521921" value="1" />
            </form>
    </div>
