...
<thead>
	...
	<input type="hidden" name="64a8bbda0d3f6a6008a0d3a2a4e33d1e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3378&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2004111213kiev" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="64a8bbda0d3f6a6008a0d3a2a4e33d1e" value="1" />
            </form>
    </div>
