...
<thead>
	...
	<input type="hidden" name="adbd97dd624facd485eb2cd0437b73cd" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=4d9668ddd34b4641ffc77dfcec2abc8a">
...
<!--        </div>-->
        ...
        <input type="hidden" name="adbd97dd624facd485eb2cd0437b73cd" value="1" />
            </form>
    </div>
