...
<thead>
	...
	<input type="hidden" name="cd89cc74095204873b5016328579329f" value="1" /></form>
</div>
    </div>
</div>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
	...
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3587&amp;category_id=0&amp;option=com_virtuemart&amp;Itemid=1"><strong>Диагностика кармы (вторая серия). Опыт выживания. Часть 4.</strong></a><br />    </td>
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3587" method="post" name="delete" style="display: inline;">
...
<!--        </div>-->
        ...
        <input type="hidden" name="cd89cc74095204873b5016328579329f" value="1" />
            </form>
    </div>
