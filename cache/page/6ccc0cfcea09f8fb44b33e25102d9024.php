...
<thead>
	...
	<input type="hidden" name="8990c954d5deaf3d066403f406025d6f" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?page=shop.browse&amp;category_id=8&amp;option=com_virtuemart&amp;Itemid=1" class="pathway">Аудио</a> <img src="/images/M_images/arrow.png" alt=""  /> Германия. Семинар 13 и 14 ноября 2010 г (2 дня)</span>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3252&amp;category_id=8&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523be9cab2cc3" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="8990c954d5deaf3d066403f406025d6f" value="1" />
            </form>
    </div>
