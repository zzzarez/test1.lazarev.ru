...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> Будут ли вам интересны видео лекции в формате Blu-Ray? </span>
...
<thead>
	<tr>
		<th colspan="3" class="sectiontableheader">
			...
			Будут ли вам интересны видео лекции в формате Blu-Ray? 		</th>
	</tr>
</thead>
<tbody>
	<tr class="sectiontableentry0">
		<td width="100%" colspan="3">
			Что такое Blu-Ray?		</td>
	</tr>
	<tr class="sectiontableentry0">
		...
		<td width="300" >
			<div class="polls_color_1" style="height:4px;width:46.4%"></div>
		</td>
	</tr>
	...
	<tr class="sectiontableentry1">
		...
		<td width="300" >
			<div class="polls_color_2" style="height:4px;width:36.7%"></div>
		</td>
	</tr>
	<tr class="sectiontableentry0">
		<td width="100%" colspan="3">
	...
	<tr class="sectiontableentry0">
		...
		<td width="300" >
			<div class="polls_color_3" style="height:4px;width:16.9%"></div>
		</td>
	</tr>
</tbody>
</table>
