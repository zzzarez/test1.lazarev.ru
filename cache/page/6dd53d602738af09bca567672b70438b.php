...
<thead>
	...
	<input type="hidden" name="6c37812131cac3e7feab9edba136ca2f" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5236cc6d6dc3e" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="6c37812131cac3e7feab9edba136ca2f" value="1" />
            </form>
    </div>
