...
<thead>
	...
	<input type="hidden" name="746082c8925a5e8922a996df1621b7b2" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=3e74d283889256547227ccda1d10ea88">
...
<!--        </div>-->
        ...
        <input type="hidden" name="746082c8925a5e8922a996df1621b7b2" value="1" />
            </form>
    </div>
