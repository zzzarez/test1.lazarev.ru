...
<thead>
	...
	<input type="hidden" name="8c147c3ff8e0d8b3447dd7383ea174dc" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=0db8ccfe14d8bea67f80eef165fdc6b9">
...
<!--        </div>-->
        ...
        <input type="hidden" name="8c147c3ff8e0d8b3447dd7383ea174dc" value="1" />
            </form>
    </div>
