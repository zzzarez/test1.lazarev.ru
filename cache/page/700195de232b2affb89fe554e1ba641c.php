...
<thead>
	...
	<input type="hidden" name="1eb81c1cd21a6dcd3c4712e04128dea8" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?option=com_content&amp;view=article&amp;id=17&amp;Itemid=40" class="pathway">Варианты оплаты</a> <img src="/images/M_images/arrow.png" alt=""  /> Регистрация</span>
        ...
        if( !(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,4})+$/.test(form.email.value))) {
           ...
           // $('email_ticker').setHTML("<img src=\"http://shop.lazarev.ru/images/wait.gif\">&nbsp;Checking");
			...
			return isvalid;
	            ...
	            //]]>
	    </script><form action="http://shop.lazarev.ru/index.php?Itemid=40&option=com_virtuemart&page=shop.registration" method="post" name="adminForm">
...
<div align="center"><input type="hidden" name="remember" value="yes" />
	...
	<input type="hidden" name="1eb81c1cd21a6dcd3c4712e04128dea8" value="1" />
