...
<thead>
	...
	<input type="hidden" name="d5fcc69fc2256cac7a8c49e0cb00631f" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5236d1bddfcee" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="d5fcc69fc2256cac7a8c49e0cb00631f" value="1" />
            </form>
    </div>
