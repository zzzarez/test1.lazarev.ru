...
<thead>
	...
	<input type="hidden" name="158c7228e153aae787cbd7abdff918b8" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3581&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2010dk17" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="158c7228e153aae787cbd7abdff918b8" value="1" />
            </form>
    </div>
