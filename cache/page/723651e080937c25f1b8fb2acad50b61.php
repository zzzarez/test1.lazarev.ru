...
<thead>
	...
	<input type="hidden" name="2d743eb2bd3062d780a8dc096dafef4f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3347&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=37">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="20020522almati" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="2d743eb2bd3062d780a8dc096dafef4f" value="1" />
            </form>
    </div>
