...
<thead>
	...
	<input type="hidden" name="d74bcad478576b97331a1d6ff5028bdb" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3122&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="20041015vilnus_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="d74bcad478576b97331a1d6ff5028bdb" value="1" />
            </form>
    </div>
