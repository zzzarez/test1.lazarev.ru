...
<thead>
	...
	<input type="hidden" name="90cf88ede7699a1dd5242b3bbb9655df" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=3d056519cbf574c0dcef0cd9d3982dc7">
...
<!--        </div>-->
        ...
        <input type="hidden" name="90cf88ede7699a1dd5242b3bbb9655df" value="1" />
            </form>
    </div>
