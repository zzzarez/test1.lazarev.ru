...
<thead>
	...
	<input type="hidden" name="23814a2992169e2acf599147fdddc3ee" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=94d407ebb1b7561c7e93588de28f6110">
...
<!--        </div>-->
        ...
        <input type="hidden" name="23814a2992169e2acf599147fdddc3ee" value="1" />
            </form>
    </div>
