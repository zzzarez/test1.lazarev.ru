...
<thead>
	...
	<input type="hidden" name="22464988615cbba3c611f0f5e2daf775" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=4d484af0a4f633b895e2a1f779cbe3af">
...
<!--        </div>-->
        ...
        <input type="hidden" name="22464988615cbba3c611f0f5e2daf775" value="1" />
            </form>
    </div>
