...
<thead>
	...
	<input type="hidden" name="400fcc4ef129b60de7fb850bfc9d5b98" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=42d3459f430a5f6dde893c2e5268de59">
...
<!--        </div>-->
        ...
        <input type="hidden" name="400fcc4ef129b60de7fb850bfc9d5b98" value="1" />
            </form>
    </div>
