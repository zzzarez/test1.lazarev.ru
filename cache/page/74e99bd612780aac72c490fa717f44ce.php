...
<thead>
	...
	<input type="hidden" name="21266af909e0be8e235ce3a8250f0a67" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=88c9856b12443f702543fb0f60f214db">
...
<!--        </div>-->
        ...
        <input type="hidden" name="21266af909e0be8e235ce3a8250f0a67" value="1" />
            </form>
    </div>
