...
<thead>
	...
	<input type="hidden" name="6a408a71ad1af885de9348150d54781a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3065&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=41">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="1997092226moskva_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="6a408a71ad1af885de9348150d54781a" value="1" />
            </form>
    </div>
