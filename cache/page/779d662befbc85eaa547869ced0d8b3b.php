...
<thead>
	...
	<input type="hidden" name="9101a444a9c984c50c97e7d7021f0fe0" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=7e2b4f91d00dca9bd5dc6f1d02d295d4">
...
<!--        </div>-->
        ...
        <input type="hidden" name="9101a444a9c984c50c97e7d7021f0fe0" value="1" />
            </form>
    </div>
