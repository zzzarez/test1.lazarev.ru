...
<thead>
	...
	<input type="hidden" name="a7eaeb4bd6e0a231d120e745c82851ff" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=cbe9360c24af0388eb14f3002273e981">
...
<!--        </div>-->
        ...
        <input type="hidden" name="a7eaeb4bd6e0a231d120e745c82851ff" value="1" />
            </form>
    </div>
