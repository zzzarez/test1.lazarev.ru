...
<thead>
	...
	<input type="hidden" name="0eba04619049a85e68359e4edb204f0e" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> Вход</span>
...
<fieldset class="input">
	<p id="com-form-login-username">
		<label for="username">Введите Ваш Email</label><br />
...
<!--        <a href="--><!--">-->
<!--            --><!--</a>-->
        <a href="/index.php?option=com_virtuemart&amp;page=shop.registration&amp;Itemid=1">
            Зарегистрируйтесь</a>
	</li>
	</ul>
...
<!--        </div>-->
        ...
        <input type="hidden" name="0eba04619049a85e68359e4edb204f0e" value="1" />
            </form>
    </div>
