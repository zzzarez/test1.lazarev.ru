...
<thead>
	...
	<input type="hidden" name="e74d38abfbaaeea0bf3f1efbe5246df1" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=487c837f565d419f7d4c3de8edc4a794">
...
<!--        </div>-->
        ...
        <input type="hidden" name="e74d38abfbaaeea0bf3f1efbe5246df1" value="1" />
            </form>
    </div>
