...
<thead>
	...
	<input type="hidden" name="2d1d20f1b9ce5d0ff103c87eb1b01ce4" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=700c6ec93ff8827307d5a58206e820d9">
...
<!--        </div>-->
        ...
        <input type="hidden" name="2d1d20f1b9ce5d0ff103c87eb1b01ce4" value="1" />
            </form>
    </div>
