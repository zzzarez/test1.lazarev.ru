...
<thead>
	...
	<input type="hidden" name="ccbf2be0a270c5cbba77e31aae29b545" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52395c3aa9caa" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="ccbf2be0a270c5cbba77e31aae29b545" value="1" />
            </form>
    </div>
