...
<thead>
	...
	<input type="hidden" name="37b940b9ca29f36f27eacdd949f3b357" value="1" /></form>
</div>
    </div>
</div>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
      ...
      <td ><img class='cart_prod_img' src='/components/com_virtuemart/shop_image/product/ritm4.png'></td>
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3598&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1"><strong>Ритмы Освобождения Сознания. Часть 4.</strong></a><br />    </td>
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3598" method="post" name="delete" style="display: inline;">
...
<!--  </tr>-->
  ...
  <tr class="sectiontableentry1" style="border-bottom:0px ;border-top: 2px solid rgb(213, 210, 210);">
    ...
    <td  align="right" ><strong>100 р. </strong></td>
      <td></td>
...
<!--        </div>-->
        ...
        <input type="hidden" name="37b940b9ca29f36f27eacdd949f3b357" value="1" />
            </form>
    </div>
<div class="vmCartModule radgrad"><div class='cart_hdr_img'><a style='font-size:14px;color:white;' href='/index.php?page=shop.cart&option=com_virtuemart&Itemid=1'>Корзина</a></div>  <script type="text/javascript">
        document.getElementsById('sbm_btn3598').forEach(function(sm) {
	    sm.value = 'В корзине';
	    sm.disabled = true;
        });
  </script>
            ...
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=1&amp;product_id=3598&amp;option=com_virtuemart&amp;Itemid=1">Ритмы Освобождения Сознания. Часть 4.</a>
            </div>
