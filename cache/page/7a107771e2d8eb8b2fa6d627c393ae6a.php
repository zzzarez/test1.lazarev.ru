...
<thead>
	...
	<input type="hidden" name="34c83d57122b07536bca5a4a4765b936" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3157&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=41">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2006070102odessa_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="34c83d57122b07536bca5a4a4765b936" value="1" />
            </form>
    </div>
