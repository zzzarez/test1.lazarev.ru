...
<thead>
	...
	<input type="hidden" name="d175554668d18264b50c53041280439f" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523baa438f26d" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="d175554668d18264b50c53041280439f" value="1" />
            </form>
    </div>
