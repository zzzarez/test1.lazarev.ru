...
<thead>
	...
	<input type="hidden" name="b2c40407b8d7020eaf0949eca5663a83" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3374&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="20040711otveti" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="b2c40407b8d7020eaf0949eca5663a83" value="1" />
            </form>
    </div>
