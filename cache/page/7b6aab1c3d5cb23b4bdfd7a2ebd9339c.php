...
<thead>
	...
	<input type="hidden" name="b7495fbc1ace869efde7fa0aeb478aa5" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52392353997dc" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="b7495fbc1ace869efde7fa0aeb478aa5" value="1" />
            </form>
    </div>
