...
<thead>
	...
	<input type="hidden" name="16ab067d0ee11bbbfa9e491de67f809f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=1ce6d7c39cdbc7111bb74a503f0ac6a1">
...
<!--        </div>-->
        ...
        <input type="hidden" name="16ab067d0ee11bbbfa9e491de67f809f" value="1" />
            </form>
    </div>
