...
<thead>
	...
	<input type="hidden" name="feb7d0f265b1aa8d60aed2c67003a4ca" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=9d6e4960061ef1003fd77e8f06e772f3">
...
<!--        </div>-->
        ...
        <input type="hidden" name="feb7d0f265b1aa8d60aed2c67003a4ca" value="1" />
            </form>
    </div>
