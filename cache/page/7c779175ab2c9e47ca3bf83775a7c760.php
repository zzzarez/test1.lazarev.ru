...
<thead>
	...
	<input type="hidden" name="ce1006a105accaf727ab7d93eda2afef" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523480459ee8a" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="ce1006a105accaf727ab7d93eda2afef" value="1" />
            </form>
    </div>
