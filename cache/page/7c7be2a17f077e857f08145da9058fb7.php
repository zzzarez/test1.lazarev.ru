...
<thead>
	...
	<input type="hidden" name="be47d6fdf5a8ad902d7dc9c97fabd2e3" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_RUS_DVD_DK_front.jpg" height="292" width="200" alt="Ответы на вопросы. Осень. 13 октября 2003 г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Ответы на вопросы. Осень. 13 октября 2003 г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3359&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5232ae2c669de" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Ответы на вопросы. Осень. 13 октября 2003 г.","140");var sm=document.getElementById("sbm_btn3359");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3359" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3359" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3359" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<div class="fly_desc_wrp">
    <b> Ответы на вопросы. Осень. 13 октября 2003 г.</b> <br /> Очищение детей через себя. Преодоление зависимости от будущего. Суть боевых искусств. Условие положительных изменений. Вранье и неискренность. Молитва за близких. Страдание как необходимый элемент развития. Мировые религии.</div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="be47d6fdf5a8ad902d7dc9c97fabd2e3" value="1" />
            </form>
    </div>
