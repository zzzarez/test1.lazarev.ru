...
<thead>
	...
	<input type="hidden" name="ae1b0e24d87032b1a71d8f1d4d0988c0" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3618&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="77719990511lekciipriem" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="ae1b0e24d87032b1a71d8f1d4d0988c0" value="1" />
            </form>
    </div>
