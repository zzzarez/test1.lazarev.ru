...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3642&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523811bf93b96" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "С-Петербург. Ноябрь 1993 г.","100");var sm=document.getElementById("sbm_btn3642");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3642" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3642" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3642" class="addtocart_button" value="Купить" title="Купить" />
            </div>
