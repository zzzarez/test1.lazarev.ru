...
<thead>
	...
	<input type="hidden" name="620d5c4c860d9ae1eaa28b166752cf35" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523898a255a1b" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="620d5c4c860d9ae1eaa28b166752cf35" value="1" />
            </form>
    </div>
