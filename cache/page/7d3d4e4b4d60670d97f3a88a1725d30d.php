...
<thead>
	...
	<input type="hidden" name="7303ef23a2e56e2e6cede41cbfde6265" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3487&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=40">Вернуться к товару</a>
	<br /><br />
...
<!--        </div>-->
        ...
        <input type="hidden" name="7303ef23a2e56e2e6cede41cbfde6265" value="1" />
            </form>
    </div>
