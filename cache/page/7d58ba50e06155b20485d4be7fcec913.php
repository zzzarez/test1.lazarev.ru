...
<thead>
	...
	<input type="hidden" name="096b1d64905cab00819f43c5ef20fce5" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3122&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=41">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52344abba835a" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="096b1d64905cab00819f43c5ef20fce5" value="1" />
            </form>
    </div>
