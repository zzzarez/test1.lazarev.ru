...
<thead>
	...
	<input type="hidden" name="a67828b48e09be36f71d8041573ccc90" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=44d198b95be1c2bd92a177c821cc8ac4">
...
<!--        </div>-->
        ...
        <input type="hidden" name="a67828b48e09be36f71d8041573ccc90" value="1" />
            </form>
    </div>
