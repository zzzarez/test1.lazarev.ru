...
<thead>
	...
	<input type="hidden" name="32e24a9e1518c243767ee71146976658" value="1" /></form>
</div>
    </div>
</div>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
	...
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3595&amp;category_id=0&amp;option=com_virtuemart&amp;Itemid=1"><strong>Ритмы Освобождения Сознания. Часть 1.</strong></a><br />    </td>
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3596" method="post" name="delete" style="display: inline;">
  ...
  <tr valign="top" class="sectiontableentry2">
      ...
      <td ><img class='cart_prod_img' src='/components/com_virtuemart/shop_image/product/ritm2.png'></td>
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3596&amp;category_id=0&amp;option=com_virtuemart&amp;Itemid=1"><strong>Ритмы Освобождения Сознания. Часть 2.</strong></a><br />    </td>
      <td style="vertical-align: middle;width: 70px;" align='center'>
          <b style='font-size:11px;'>электронная версия<br>(mp3)</b>      </td>
...
<!--  </tr>-->
  ...
  <tr class="sectiontableentry1" style="border-bottom:0px ;border-top: 2px solid rgb(213, 210, 210);">
    ...
    <td  align="right" ><strong>200 р. </strong></td>
      <td></td>
...
<!--        </div>-->
        ...
        <input type="hidden" name="32e24a9e1518c243767ee71146976658" value="1" />
            </form>
    </div>
<div class="vmCartModule radgrad"><div class='cart_hdr_img'><a style='font-size:14px;color:white;' href='/index.php?page=shop.cart&option=com_virtuemart&Itemid=1'>Корзина</a></div>  <script type="text/javascript">
        document.getElementsById('sbm_btn3596').forEach(function(sm) {
	    sm.value = 'В корзине';
	    sm.disabled = true;
        });
	    ...
	    sm.disabled = true;
            ...
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=0&amp;product_id=3596&amp;option=com_virtuemart&amp;Itemid=1">Ритмы Освобождения Сознания. Часть 2.</a>
            </div>
            ...
            <br style="clear: both;" />
                         ...
                         <div style="border-bottom: 1px dotted #949292;">
                <div class="vmCartPrice" style="float: left;font-size: 11px;width:137px; text-align: left;padding-left: 7px;padding-bottom: 10px; padding-top: 10px;">
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=0&amp;product_id=3595&amp;option=com_virtuemart&amp;Itemid=1">Ритмы Освобождения Сознания. Часть 1.</a>
            </div>
                <div class="vmCartPrice" style="float: right;font-size: 9px;padding-right: 5px;padding-bottom: 10px; padding-top: 10px;">
            100 р.             </div>
            <br style="clear: both;" />
