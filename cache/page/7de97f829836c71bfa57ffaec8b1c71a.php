...
<thead>
	...
	<input type="hidden" name="8ff414fe465592ac509a971a8e7b86f4" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3409&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2006092223harkov" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="8ff414fe465592ac509a971a8e7b86f4" value="1" />
            </form>
    </div>
