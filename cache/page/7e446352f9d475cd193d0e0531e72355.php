...
<thead>
	...
	<input type="hidden" name="615436d01e24913081637b68ae27c69c" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="alex.khatsanovsky@gmail.com" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="615436d01e24913081637b68ae27c69c" value="1" />
            </form>
    </div>
