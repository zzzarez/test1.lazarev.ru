...
<thead>
	...
	<input type="hidden" name="746c4957f39f4e82350732e11164f04f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=4852fb2ca6708fbdbef11107f64fc884">
...
<!--        </div>-->
        ...
        <input type="hidden" name="746c4957f39f4e82350732e11164f04f" value="1" />
            </form>
    </div>
