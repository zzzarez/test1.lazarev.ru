...
<thead>
	...
	<input type="hidden" name="1f8b40e0a3a2d0cc1baa1ee68647b8a7" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=fdca2ffea3478f897374552ffe09dba0">
...
<!--        </div>-->
        ...
        <input type="hidden" name="1f8b40e0a3a2d0cc1baa1ee68647b8a7" value="1" />
            </form>
    </div>
