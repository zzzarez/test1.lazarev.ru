...
<thead>
	...
	<input type="hidden" name="b8ce8974f95f635be54c75eae7ed3b66" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3417&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=39">Вернуться к товару</a>
	<br /><br />
...
<!--        </div>-->
        ...
        <input type="hidden" name="b8ce8974f95f635be54c75eae7ed3b66" value="1" />
            </form>
    </div>
