...
<thead>
	...
	<input type="hidden" name="2e0a07af72abacee8fbc4a7f971bfb05" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52355f4e561ed" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="2e0a07af72abacee8fbc4a7f971bfb05" value="1" />
            </form>
    </div>
