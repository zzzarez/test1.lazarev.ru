...
<thead>
	...
	<input type="hidden" name="9f4f2b4f1a93715c06f8fd293eb58925" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?page=shop.browse&amp;category_id=8&amp;option=com_virtuemart&amp;Itemid=1" class="pathway">Аудио</a> <img src="/images/M_images/arrow.png" alt=""  /> Прага. 17 и 18 августа 2013г.</span>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_audio.jpg" height="192" width="200" alt="Прага. 17 и 18 августа 2013г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Прага. 17 и 18 августа 2013г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3753&amp;category_id=8&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523ab10164935" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Прага. 17 и 18 августа 2013г.","200");var sm=document.getElementById("sbm_btn3753");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3753" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3753" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3753" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<div class="fly_desc_wrp">
    <b>Прага. 17 и 18 августа 2013г.</b></div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="9f4f2b4f1a93715c06f8fd293eb58925" value="1" />
            </form>
    </div>
