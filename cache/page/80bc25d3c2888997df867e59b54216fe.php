...
<thead>
	...
	<input type="hidden" name="58e34a3122f83cf34f72fb5c2bfe6a0f" value="1" /></form>
</div>
    </div>
</div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="58e34a3122f83cf34f72fb5c2bfe6a0f" value="1" />
            </form>
    </div>
<div class="vmCartModule radgrad"><div class='cart_hdr_img'><a style='font-size:14px;color:white;' href='/index.php?page=shop.cart&option=com_virtuemart&Itemid=1'>Корзина</a></div>  <script type="text/javascript">
        document.getElementsById('sbm_btn3501').forEach(function(sm) {
	    sm.value = 'В корзине';
	    sm.disabled = true;
        });
  </script>
            ...
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=1&amp;product_id=3501&amp;option=com_virtuemart&amp;Itemid=1">Москва. Семинар 4 и 5 ноября 2010 г. (2 дня)</a>
            </div>
