...
<thead>
	...
	<input type="hidden" name="f966c0cb78e2893e7b8f64c0ec2f7fb5" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=a980074f5e778840955911306d0a750f">
...
<!--        </div>-->
        ...
        <input type="hidden" name="f966c0cb78e2893e7b8f64c0ec2f7fb5" value="1" />
            </form>
    </div>
