...
<thead>
	...
	<input type="hidden" name="dfe41e000dba8e4998fd524c3da7220e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=b2bf36d55170aa79fb6e2fea37f654bc">
...
<!--        </div>-->
        ...
        <input type="hidden" name="dfe41e000dba8e4998fd524c3da7220e" value="1" />
            </form>
    </div>
