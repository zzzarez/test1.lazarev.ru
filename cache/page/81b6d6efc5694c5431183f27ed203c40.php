...
<thead>
	...
	<input type="hidden" name="b8cf1fd9feaa3c39fe22dea50a904a79" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=e86ee6f8f2c9957260afae90f8f27f74">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"Диагностика кармы (вторая серия). Опыт выживания. Часть 3."
    </a>
    <br>
        Имя файла: dkII3.pdf        <br>
...
<!--        </div>-->
        ...
        <input type="hidden" name="b8cf1fd9feaa3c39fe22dea50a904a79" value="1" />
            </form>
    </div>
