...
<thead>
	...
	<input type="hidden" name="36e41b4a4401f1c18b1f9f2e4bddd425" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3732&amp;category_id=16&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="20132vizdorovlenie_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="36e41b4a4401f1c18b1f9f2e4bddd425" value="1" />
            </form>
    </div>
