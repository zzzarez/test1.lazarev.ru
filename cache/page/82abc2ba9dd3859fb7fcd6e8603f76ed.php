...
<thead>
	...
	<input type="hidden" name="09f6557792780a3d35f6b3ebfa22eac7" value="1" /></form>
</div>
    </div>
</div>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3752" method="post" name="delete" style="display: inline;">
...
<!--  </tr>-->
  ...
  <tr class="sectiontableentry1" style="border-bottom:0px ;border-top: 2px solid rgb(213, 210, 210);">
    ...
    <td  align="right" ><strong>480 р. </strong></td>
      <td></td>
...
<!--        </div>-->
        ...
        <input type="hidden" name="09f6557792780a3d35f6b3ebfa22eac7" value="1" />
            </form>
    </div>
...
<div style="float: left;font-size: 11px;padding: 10px;font-weight: bold;color: red;" >
    ...
    <input type="hidden" id="totalprice_hlp" value="480"/>
...
всего: <font style='font-size:14px;margin-left:7px;line-height:0px;'>480 р. </font></div>
