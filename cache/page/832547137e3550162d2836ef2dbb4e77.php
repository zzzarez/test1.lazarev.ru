...
<thead>
	...
	<input type="hidden" name="d31fb6997f8745dcf87490ce55de1619" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=a5c997aad572c3f511ac9db269c5461d">
...
<!--        </div>-->
        ...
        <input type="hidden" name="d31fb6997f8745dcf87490ce55de1619" value="1" />
            </form>
    </div>
