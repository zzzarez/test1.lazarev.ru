...
<thead>
	...
	<input type="hidden" name="85d385174075cdcaadf2681ea4d78db1" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=f66375efb55d0f8e1216fbc7a6905c58">
...
<!--        </div>-->
        ...
        <input type="hidden" name="85d385174075cdcaadf2681ea4d78db1" value="1" />
            </form>
    </div>
