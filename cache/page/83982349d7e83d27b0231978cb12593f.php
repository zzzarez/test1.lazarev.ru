...
<thead>
	...
	<input type="hidden" name="de2ca419755654346151cfbd715ba0fd" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=fa2ce263afacb867060615281993c55f">
...
<!--        </div>-->
        ...
        <input type="hidden" name="de2ca419755654346151cfbd715ba0fd" value="1" />
            </form>
    </div>
