...
<thead>
	...
	<input type="hidden" name="6f1fb02e7b46a8c1dc0d98c7404de76f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3366&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="20040316piter" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="6f1fb02e7b46a8c1dc0d98c7404de76f" value="1" />
            </form>
    </div>
