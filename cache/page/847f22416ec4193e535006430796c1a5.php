...
<thead>
	...
	<input type="hidden" name="103c9dcde210b3335935461a077af71a" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523a73826e4e6" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="103c9dcde210b3335935461a077af71a" value="1" />
            </form>
    </div>
