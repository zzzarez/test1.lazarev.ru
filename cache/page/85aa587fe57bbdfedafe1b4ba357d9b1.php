...
<thead>
	...
	<input type="hidden" name="1a4b684c1551fdf0fe99d8b09151627e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=930a1c40404d0383928dc2fc68b28210">
...
<!--        </div>-->
        ...
        <input type="hidden" name="1a4b684c1551fdf0fe99d8b09151627e" value="1" />
            </form>
    </div>
