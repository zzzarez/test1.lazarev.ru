...
<thead>
	...
	<input type="hidden" name="2a658d309cdc3e7b886b4528c606a147" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523ba9d1f1b39" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="2a658d309cdc3e7b886b4528c606a147" value="1" />
            </form>
    </div>
