...
<thead>
	...
	<input type="hidden" name="7d98899893074184c4cffc4c9ea1b201" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
	...
	<ul id="cpanel">
					<li class="cpanel-icon tooltip" title="Editor Global Configuration::Edit the JCE Editor Global Configuration"><a href="index.php?option=com_jce&amp;view=config"><span class="config"></span>Editor Global Configuration</a></li>
							...
							<li class="cpanel-icon tooltip" title="File Browser::File Browser::Manage files and folders"><a href="index.php?option=com_jce&view=editor&layout=plugin&plugin=browser&standalone=1&wf9e3d9e920839e76f58757aacd9e9b55e=1" class="dialog browser" target="_blank" data-options="{'width':765,'height':480, 'modal':true}" title="File Browser"><span class="browser"></span>File Browser</a></li>
...
<!--        </div>-->
        ...
        <input type="hidden" name="7d98899893074184c4cffc4c9ea1b201" value="1" />
            </form>
    </div>
