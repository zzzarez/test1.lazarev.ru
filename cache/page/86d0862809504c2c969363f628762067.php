...
<thead>
	...
	<input type="hidden" name="989f04b254cba79d52cb2574af6fc223" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_RUS_DVD_CB_front.jpg" height="292" width="200" alt="Москва. 13 марта 2010 г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Москва. 13 марта 2010 г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3486&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523ad0c9e6c3b" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Москва. 13 марта 2010 г.","140");var sm=document.getElementById("sbm_btn3486");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3486" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3486" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3486" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<div class="fly_desc_wrp">
    Прием. Москва. 13 марта 2010 г.</div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="989f04b254cba79d52cb2574af6fc223" value="1" />
            </form>
    </div>
