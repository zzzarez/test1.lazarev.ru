...
<thead>
	...
	<input type="hidden" name="b77c07f3942eef2b5dab2f6cfcade96c" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523ad157bc1c1" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="b77c07f3942eef2b5dab2f6cfcade96c" value="1" />
            </form>
    </div>
