...
<thead>
	...
	<input type="hidden" name="afa1164cf44fb1a4a8b0667c91a6bcb2" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523b56a6d5fcc" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="afa1164cf44fb1a4a8b0667c91a6bcb2" value="1" />
            </form>
    </div>
