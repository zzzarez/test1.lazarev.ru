...
<thead>
	...
	<input type="hidden" name="ef3e6fbebc74c7657a381ef06f87c1f3" value="1" /></form>
</div>
    </div>
</div>
...
<tr>
	<td valign="top">
		195112, Россия, г. С-Петербург, а/я 69. Лазареву С.Н.	</td>
</tr>
</table>
<br />
<table width="100%" cellpadding="0" cellspacing="0" border="0">
<tr>
 ...
 var path = 'hr' + 'ef' + '=';
 var addy53971 = 'sh&#111;p' + '&#64;';
 addy53971 = addy53971 + 'l&#97;z&#97;r&#101;v' + '&#46;' + 'r&#117;';
 document.write( '<a ' + path + '\'' + prefix + addy53971 + suffix + '\'' + attribs + '>' );
 document.write( addy53971 );
 document.write( '<\/a>' );
 //-->
...
<tr>
	...
	<td>
		 Тех поддержка: support@lazarev.ru 	</td>
</tr>
<tr>
	<td width="40" >
	</td>
	<td>
		<a href="http://shop.lazarev.ru" target="_blank">
			http://shop.lazarev.ru</a>
	</td>
</tr>
</table>
<br />
...
<tr>
	...
	<td>
		Ваши мнения и предложения можно отправить в этой форме:	</td>
</tr>
</table>
<br />
			</td>
...
<tr>
	<td colspan="2">
	<br /><br />
	<form action="/index.php?option=com_contact&amp;view=contact&amp;id=1&amp;Itemid=6" method="post" name="emailForm" id="emailForm" class="form-validate">
...
<!--        </div>-->
        ...
        <input type="hidden" name="ef3e6fbebc74c7657a381ef06f87c1f3" value="1" />
            </form>
    </div>
