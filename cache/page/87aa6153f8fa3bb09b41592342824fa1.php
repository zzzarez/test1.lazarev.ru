...
<thead>
	...
	<input type="hidden" name="b4fa6c760b745b935c6988a27883c4d6" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523898d92b8a2" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="b4fa6c760b745b935c6988a27883c4d6" value="1" />
            </form>
    </div>
