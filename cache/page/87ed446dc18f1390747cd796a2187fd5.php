...
<thead>
	...
	<input type="hidden" name="9915ecd7de0f23dedf90c0a9b2e2a194" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=32987a5634614720133527f7013d17c2">
...
<!--        </div>-->
        ...
        <input type="hidden" name="9915ecd7de0f23dedf90c0a9b2e2a194" value="1" />
            </form>
    </div>
