...
<thead>
	...
	<input type="hidden" name="875f5ac35dfe784b9ec61a1fceede473" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523ade47a850d" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="875f5ac35dfe784b9ec61a1fceede473" value="1" />
            </form>
    </div>
