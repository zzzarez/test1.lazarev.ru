...
<thead>
	...
	<input type="hidden" name="8d4718b0ccff0e5a238c5396a4da4aeb" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=1a8b022d67be0a53288979aa62390a48">
...
<!--        </div>-->
        ...
        <input type="hidden" name="8d4718b0ccff0e5a238c5396a4da4aeb" value="1" />
            </form>
    </div>
