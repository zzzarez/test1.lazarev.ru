...
<thead>
	...
	<input type="hidden" name="47c1f212ee5237a0694bd7be367f0b01" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="bibins@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="47c1f212ee5237a0694bd7be367f0b01" value="1" />
            </form>
    </div>
