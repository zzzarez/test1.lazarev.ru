...
<thead>
	...
	<input type="hidden" name="eb987f2a665d8d083012d8fbac53661a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=0ed3bf5df8d7d04a8a706a3d79940324">
...
<!--        </div>-->
        ...
        <input type="hidden" name="eb987f2a665d8d083012d8fbac53661a" value="1" />
            </form>
    </div>
