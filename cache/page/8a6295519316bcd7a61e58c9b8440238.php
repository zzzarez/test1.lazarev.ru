...
<thead>
	...
	<input type="hidden" name="6c342f0d157de69dce4eabe9617ea10e" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_audio.jpg" height="192" width="200" alt="Харьков. 26 января 2006 г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Харьков. 26 января 2006 г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3144&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523680bf08c32" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Харьков. 26 января 2006 г.","100");var sm=document.getElementById("sbm_btn3144");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3144" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3144" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3144" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="6c342f0d157de69dce4eabe9617ea10e" value="1" />
            </form>
    </div>
