...
<thead>
	...
	<input type="hidden" name="2b1a8b22cfb65089223a00bfa1e8058a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3703&amp;category_id=12&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2013rithm6_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="2b1a8b22cfb65089223a00bfa1e8058a" value="1" />
            </form>
    </div>
