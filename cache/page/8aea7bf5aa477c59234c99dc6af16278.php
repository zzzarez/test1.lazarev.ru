...
<thead>
	...
	<input type="hidden" name="7cb5e7a62a840d16b4b45be4ef8b4e3a" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://shoplazarev.com/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?page=shop.browse&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1" class="pathway">Видео</a> <img src="/images/M_images/arrow.png" alt=""  /> Харьков. 22 и 23 сентября 2006 г. (2 дня)</span>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52390f32188de" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="7cb5e7a62a840d16b4b45be4ef8b4e3a" value="1" />
            </form>
    </div>
