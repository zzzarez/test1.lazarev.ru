...
<thead>
	...
	<input type="hidden" name="86cbb8842df2ac94083cae0794da7dee" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5234d5cfcf722" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="86cbb8842df2ac94083cae0794da7dee" value="1" />
            </form>
    </div>
