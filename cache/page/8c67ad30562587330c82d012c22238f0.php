...
<thead>
	...
	<input type="hidden" name="b8ee5f70a27ca10cd9093806ae2328df" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3300&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="19960311piter" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="b8ee5f70a27ca10cd9093806ae2328df" value="1" />
            </form>
    </div>
