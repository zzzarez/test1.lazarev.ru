...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=b3f21fc405409c910de0e493b78a8140">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"Москва. 7 и 8 сентября 2013г."
    </a>
    <br>
        Имя файла: 20130907moskva.avi        <br>
        Оставшееся количество скачиваний: 1        <br> <br><br><br>
    <script>
...
<!---->
<!--    <h3>--><!--</h3>-->
<!--    <img src="--><!--images/downloads.gif" alt="downloads" border="0" align="middle"/>-->
<!--    <br/>-->
<!--    <br/>-->
<!--    --><!--        <form method="get" action="--><!--index.php" name="downloadForm">-->
...
<!--                <br/><br/>-->
<!--                <input type="submit"-->
<!--                       onclick="if( document.downloadForm.download_id.value &lt; 12) { alert('--><!--');return false;} else return true;"-->
<!--                       class="button" value="--><!--"/>-->
<!--            </div>-->
