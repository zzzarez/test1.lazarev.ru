...
<thead>
	...
	<input type="hidden" name="a8204475461ebeb072622653616623b3" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5235561ba782f" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="a8204475461ebeb072622653616623b3" value="1" />
            </form>
    </div>
