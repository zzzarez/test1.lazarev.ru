...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
	...
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3566&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1"><strong>Диагностика кармы. Книга вторая. Чистая карма.(часть 2)</strong></a><br />    </td>
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3566" method="post" name="delete" style="display: inline;">
