...
<thead>
	...
	<input type="hidden" name="399bed7882bbaf57c715dead7a9fdef5" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5238f1d55773a" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="399bed7882bbaf57c715dead7a9fdef5" value="1" />
            </form>
    </div>
