...
<thead>
	...
	<input type="hidden" name="ad7a44ea3e9cc8e5c24942186343aabc" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=15297345a36cbc1096dc0ead0edbf899">
...
<!--        </div>-->
        ...
        <input type="hidden" name="ad7a44ea3e9cc8e5c24942186343aabc" value="1" />
            </form>
    </div>
