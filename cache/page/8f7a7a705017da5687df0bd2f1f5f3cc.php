...
<thead>
	...
	<input type="hidden" name="13d49f20ca914e70bfc9451852a1705a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=1c0484f912d527dee02a1ec8a6aedd13">
...
<!--        </div>-->
        ...
        <input type="hidden" name="13d49f20ca914e70bfc9451852a1705a" value="1" />
            </form>
    </div>
