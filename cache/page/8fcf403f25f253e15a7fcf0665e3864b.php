...
<thead>
	...
	<input type="hidden" name="7eed3138dd417fe3ef9195cdefd25798" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3054&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=41">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="19960617yakutsk_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="7eed3138dd417fe3ef9195cdefd25798" value="1" />
            </form>
    </div>
