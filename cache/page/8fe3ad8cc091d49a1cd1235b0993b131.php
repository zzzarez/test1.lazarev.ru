...
<thead>
	...
	<input type="hidden" name="f378baed16068772f6b50187b891a7d1" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=22a9645a6678024903c1214ab8d1c878">
...
<!--        </div>-->
        ...
        <input type="hidden" name="f378baed16068772f6b50187b891a7d1" value="1" />
            </form>
    </div>
