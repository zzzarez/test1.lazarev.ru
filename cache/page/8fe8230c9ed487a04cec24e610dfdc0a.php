...
<thead>
	...
	<input type="hidden" name="f70d910fa633db1e9090a6541052f531" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523b37a606dab" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="f70d910fa633db1e9090a6541052f531" value="1" />
            </form>
    </div>
