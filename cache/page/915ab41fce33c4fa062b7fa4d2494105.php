...
<thead>
	...
	<input type="hidden" name="d74eb5e1c3600c5da12c4ada2d0d0e24" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=1c33faf41329472ba51e78a14794170d">
...
<!--        </div>-->
        ...
        <input type="hidden" name="d74eb5e1c3600c5da12c4ada2d0d0e24" value="1" />
            </form>
    </div>
