...
<thead>
	...
	<input type="hidden" name="6cd45325eebf6d57eecf7aef505bdba6" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=2b2c567f6381ac1274ea541ade098407">
...
<!--        </div>-->
        ...
        <input type="hidden" name="6cd45325eebf6d57eecf7aef505bdba6" value="1" />
            </form>
    </div>
