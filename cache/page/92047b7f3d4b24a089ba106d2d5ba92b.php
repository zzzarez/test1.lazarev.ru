...
<thead>
	...
	<input type="hidden" name="bb8e5607447a4d4bca6d355656fcd821" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?page=shop.browse&amp;category_id=6&amp;option=com_virtuemart&amp;Itemid=1" class="pathway">Книги</a> <img src="/images/M_images/arrow.png" alt=""  /> Восточный путь к здоровью</span>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3589&amp;category_id=6&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52372fc75c82f" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="bb8e5607447a4d4bca6d355656fcd821" value="1" />
            </form>
    </div>
