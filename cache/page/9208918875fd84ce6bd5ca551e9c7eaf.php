...
<thead>
	...
	<input type="hidden" name="c18f7df4dbdd6caef45c1f69a9af4cce" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523898156a767" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="c18f7df4dbdd6caef45c1f69a9af4cce" value="1" />
            </form>
    </div>
