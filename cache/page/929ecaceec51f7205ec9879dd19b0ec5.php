...
<thead>
	...
	<input type="hidden" name="068491e65f3f63ed9d12514b96d6ccab" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=825f52ddd38c33966b7b8e1292703b54">
...
<!--        </div>-->
        ...
        <input type="hidden" name="068491e65f3f63ed9d12514b96d6ccab" value="1" />
            </form>
    </div>
