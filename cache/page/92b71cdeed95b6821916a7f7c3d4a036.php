...
<thead>
	...
	<input type="hidden" name="dd71b8b1e25b0e2ad4c05537bea916ea" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=e16c7b486a3e241ca2a678e5bf24790f">
...
<!--        </div>-->
        ...
        <input type="hidden" name="dd71b8b1e25b0e2ad4c05537bea916ea" value="1" />
            </form>
    </div>
