...
<thead>
	...
	<input type="hidden" name="a2e9cd3b463fd19f1d3e593b636304dd" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3444&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2008041213moskva" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="a2e9cd3b463fd19f1d3e593b636304dd" value="1" />
            </form>
    </div>
