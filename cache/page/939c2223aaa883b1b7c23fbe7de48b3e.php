...
<thead>
	...
	<input type="hidden" name="d6acf50ca513c9720e7dfa925b59df30" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://shoplazarev.com/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?page=shop.browse&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1" class="pathway">Видео</a> <img src="/images/M_images/arrow.png" alt=""  /> С-Петербург. Семинар 15 и 16 марта 2008г.(2 дня)</span>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3193&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52386a2ceda88" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="d6acf50ca513c9720e7dfa925b59df30" value="1" />
            </form>
    </div>
