...
<thead>
	...
	<input type="hidden" name="1f0becee7df06ae084b75bfef5dfceb0" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52389695112a1" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="1f0becee7df06ae084b75bfef5dfceb0" value="1" />
            </form>
    </div>
