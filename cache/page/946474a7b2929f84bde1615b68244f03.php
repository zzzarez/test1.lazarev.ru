...
<thead>
	...
	<input type="hidden" name="78724157573f0beabb3a0af720f9c4e9" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3091&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="20020120otveti_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="78724157573f0beabb3a0af720f9c4e9" value="1" />
            </form>
    </div>
