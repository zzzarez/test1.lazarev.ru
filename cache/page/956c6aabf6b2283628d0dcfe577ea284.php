...
<thead>
	...
	<input type="hidden" name="33ca2c6fb9707e43a77af13471a5284c" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=38d9a6a1b4f0d187025988ec816e8a30">
...
<!--        </div>-->
        ...
        <input type="hidden" name="33ca2c6fb9707e43a77af13471a5284c" value="1" />
            </form>
    </div>
