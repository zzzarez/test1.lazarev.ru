...
<thead>
	...
	<input type="hidden" name="bfc4d0bcd331eeb80a222eeb18394fe4" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=a1d459f982fb2b7b67febac66bd3a4db">
...
<!--        </div>-->
        ...
        <input type="hidden" name="bfc4d0bcd331eeb80a222eeb18394fe4" value="1" />
            </form>
    </div>
