...
<thead>
	...
	<input type="hidden" name="4aa54fa1b756001a867c506af150c6ce" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=ce1adee2b3e18e3eedd28a78a61bf955">
...
<!--        </div>-->
        ...
        <input type="hidden" name="4aa54fa1b756001a867c506af150c6ce" value="1" />
            </form>
    </div>
