...
<thead>
	...
	<input type="hidden" name="5e18d4969f96de847e1a468abb3bf9c3" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3501&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=43">Вернуться к товару</a>
	<br /><br />
...
<!--        </div>-->
        ...
        <input type="hidden" name="5e18d4969f96de847e1a468abb3bf9c3" value="1" />
            </form>
    </div>
