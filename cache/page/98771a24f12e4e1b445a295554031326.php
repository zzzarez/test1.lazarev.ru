...
<thead>
	...
	<input type="hidden" name="dcee5bc9a2c6558a634035931435949b" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=4626eae2897e4ea189b4dc4e8badb294">
...
<!--        </div>-->
        ...
        <input type="hidden" name="dcee5bc9a2c6558a634035931435949b" value="1" />
            </form>
    </div>
