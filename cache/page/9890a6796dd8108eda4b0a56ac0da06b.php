...
<thead>
	...
	<input type="hidden" name="4d468c6aaa7f2ab85789b2474c93dd9e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=cdfa3f97ca3905fe7db8865a11da1d24">
...
<!--        </div>-->
        ...
        <input type="hidden" name="4d468c6aaa7f2ab85789b2474c93dd9e" value="1" />
            </form>
    </div>
