...
<thead>
	...
	<input type="hidden" name="499ff78c409a7c56aea62552a75839b9" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=8e60e01e1e0372b2b12ef5a5a52cf805">
...
<!--        </div>-->
        ...
        <input type="hidden" name="499ff78c409a7c56aea62552a75839b9" value="1" />
            </form>
    </div>
