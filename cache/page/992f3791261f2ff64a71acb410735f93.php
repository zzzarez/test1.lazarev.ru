...
<thead>
	...
	<input type="hidden" name="4a124f9d0857e46d2d7cb05386aa5612" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3636&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5239c1a47494a" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Москва. Семинар 17 и 18 марта 2007 г (2 дня)","280");var sm=document.getElementById("sbm_btn3636");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3636" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3636" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3636" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="4a124f9d0857e46d2d7cb05386aa5612" value="1" />
            </form>
    </div>
