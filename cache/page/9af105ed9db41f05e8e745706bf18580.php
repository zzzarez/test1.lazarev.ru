...
<thead>
	...
	<input type="hidden" name="de4a23bf55b317d7574aee3c06679892" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=e6b7b4abbde65256446583f029c0a40c">
...
<!--        </div>-->
        ...
        <input type="hidden" name="de4a23bf55b317d7574aee3c06679892" value="1" />
            </form>
    </div>
