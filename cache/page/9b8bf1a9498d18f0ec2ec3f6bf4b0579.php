...
<thead>
	...
	<input type="hidden" name="60884518cc14144f874376758b69cd75" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=3825cf959704f7fe9af358f9d7de9a30">
...
<!--        </div>-->
        ...
        <input type="hidden" name="60884518cc14144f874376758b69cd75" value="1" />
            </form>
    </div>
