...
<thead>
	...
	<input type="hidden" name="63299c508a249e4818432c35af790d2f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=4bbff8606cbb502e4e180859578f77a9">
...
<!--        </div>-->
        ...
        <input type="hidden" name="63299c508a249e4818432c35af790d2f" value="1" />
            </form>
    </div>
