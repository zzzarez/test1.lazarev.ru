...
<thead>
	...
	<input type="hidden" name="31bb4f6bd016490615190fbfb6f7e461" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=5b8e26819c294e941402867bb0a43a61">
...
<!--        </div>-->
        ...
        <input type="hidden" name="31bb4f6bd016490615190fbfb6f7e461" value="1" />
            </form>
    </div>
