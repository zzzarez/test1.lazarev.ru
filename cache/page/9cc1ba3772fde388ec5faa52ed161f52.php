...
<thead>
	...
	<input type="hidden" name="342d3b6da7a62660a0d6caad85ad43ce" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523627318f259" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="342d3b6da7a62660a0d6caad85ad43ce" value="1" />
            </form>
    </div>
