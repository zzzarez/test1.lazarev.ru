...
<thead>
	...
	<input type="hidden" name="4a4560fcada3d741827c098778a454b0" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=4750b99cfda56015fd6eab969536ee30">
...
<!--        </div>-->
        ...
        <input type="hidden" name="4a4560fcada3d741827c098778a454b0" value="1" />
            </form>
    </div>
