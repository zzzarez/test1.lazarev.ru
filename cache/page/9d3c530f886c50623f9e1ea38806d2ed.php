...
<thead>
	...
	<input type="hidden" name="199f39a973f3f57d420c9f02a0073e8e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=eb2726a2ac1d514d5e3d91c8a232fe6a">
...
<!--        </div>-->
        ...
        <input type="hidden" name="199f39a973f3f57d420c9f02a0073e8e" value="1" />
            </form>
    </div>
