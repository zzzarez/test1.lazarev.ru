...
<thead>
	...
	<input type="hidden" name="5529bed417c3aebdba18f4df9c7d72a2" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=eeabd82794e6a43673195990907d1daf">
...
<!--        </div>-->
        ...
        <input type="hidden" name="5529bed417c3aebdba18f4df9c7d72a2" value="1" />
            </form>
    </div>
