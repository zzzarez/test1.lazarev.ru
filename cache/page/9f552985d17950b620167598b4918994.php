...
<thead>
	...
	<input type="hidden" name="cb98021efe9ce5c4eed8ae03fe4df0ba" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3675&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="77720071101moskva_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="cb98021efe9ce5c4eed8ae03fe4df0ba" value="1" />
            </form>
    </div>
