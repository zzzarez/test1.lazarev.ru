...
<thead>
	...
	<input type="hidden" name="9db5aaaff94820d380fdac79f0a2d0cd" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_RUS_DVD_DK_front.jpg" height="292" width="200" alt="Москва. 10 января 1996 г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Москва. 10 января 1996 г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3299&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5232c31394223" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Москва. 10 января 1996 г.","140");var sm=document.getElementById("sbm_btn3299");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3299" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3299" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3299" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<div class="fly_desc_wrp">
    <b> 10 января 1996 г. Москва. </b> <br />Полевые структуры определяют характер и судьбу человека. Полевая наследственность. Агрессивные эмоции. Подсознательная агрессия приводит к болезням. Две системы ценностей: земные и Божественные.</div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="9db5aaaff94820d380fdac79f0a2d0cd" value="1" />
            </form>
    </div>
