...
<thead>
	...
	<input type="hidden" name="a696e9f9722fbbffe15797e4e00fd3c6" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3660&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="7772002071112belgorod_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="a696e9f9722fbbffe15797e4e00fd3c6" value="1" />
            </form>
    </div>
