...
<thead>
	...
	<input type="hidden" name="50ded1bfc545776789caf10f342b186e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=13408820001aceaa3236aaf3bed48d28">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"Человек будущего. Воспитание родителей. Часть 2."
    </a>
    <br>
        Имя файла: vsprdt2.fb2        <br>
...
<!--        </div>-->
        ...
        <input type="hidden" name="50ded1bfc545776789caf10f342b186e" value="1" />
            </form>
    </div>
