...
<thead>
	...
	<input type="hidden" name="682575a65ceacd4f0eaf52b25e865c1e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=ac5ede9d989f546213f6727d0681bc89">
...
<!--        </div>-->
        ...
        <input type="hidden" name="682575a65ceacd4f0eaf52b25e865c1e" value="1" />
            </form>
    </div>
