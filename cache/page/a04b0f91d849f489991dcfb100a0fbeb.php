...
<thead>
	...
	<input type="hidden" name="b07a77a40e99b152b44f0cecbe2727f1" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=212383351c1691eadd29d2df7b70d832">
...
<!--        </div>-->
        ...
        <input type="hidden" name="b07a77a40e99b152b44f0cecbe2727f1" value="1" />
            </form>
    </div>
