...
<thead>
	...
	<input type="hidden" name="dec577aeebfb8a064770d22153be70ba" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523b5792cfabb" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="dec577aeebfb8a064770d22153be70ba" value="1" />
            </form>
    </div>
