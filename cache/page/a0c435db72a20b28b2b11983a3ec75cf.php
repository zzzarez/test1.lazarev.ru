...
<thead>
	...
	<input type="hidden" name="6f7a3370cf237d2aa397992cfb865c63" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=49f760c3b4df14dc6b98b11ecb2ba244">
...
<!--        </div>-->
        ...
        <input type="hidden" name="6f7a3370cf237d2aa397992cfb865c63" value="1" />
            </form>
    </div>
