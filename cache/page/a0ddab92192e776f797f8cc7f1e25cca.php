...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
	...
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3415&amp;category_id=0&amp;option=com_virtuemart&amp;Itemid=1"><strong>2 лекции перед приемом. Осень 2006 г.</strong></a><br />    </td>
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3415" method="post" name="delete" style="display: inline;">
...
<!--  </tr>-->
  ...
  <tr class="sectiontableentry1" style="border-bottom:0px ;border-top: 2px solid rgb(213, 210, 210);">
    ...
    <td  align="right" ><strong>140 р. </strong></td>
      <td></td>
...
<div class="vmCartModule radgrad"><div class='cart_hdr_img'><a style='font-size:14px;color:white;' href='/index.php?page=shop.cart&option=com_virtuemart&Itemid=1'>Корзина</a></div>  <script type="text/javascript">
        document.getElementsById('sbm_btn3415').forEach(function(sm) {
	    sm.value = 'В корзине';
	    sm.disabled = true;
        });
  </script>
            ...
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=0&amp;product_id=3415&amp;option=com_virtuemart&amp;Itemid=1">2 лекции перед приемом. Осень 2006 г.</a>
            </div>
