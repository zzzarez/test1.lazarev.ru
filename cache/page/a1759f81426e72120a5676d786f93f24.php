...
<thead>
	...
	<input type="hidden" name="46234a803b261fa4c9af9e68b358f1c9" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=302f4126b1b9ef3a569852bcd481bccf">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"Билет на онлайн-трансляцию 4 января (второй день семинара)"
    </a>
    <br>
        Имя файла: aga_view2.htm        <br>
...
<!--        </div>-->
        ...
        <input type="hidden" name="46234a803b261fa4c9af9e68b358f1c9" value="1" />
            </form>
    </div>
