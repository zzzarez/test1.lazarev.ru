...
<thead>
	...
	<input type="hidden" name="c577dabfc1fd30046b039625c8d3017a" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523602640c5bd" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="c577dabfc1fd30046b039625c8d3017a" value="1" />
            </form>
    </div>
