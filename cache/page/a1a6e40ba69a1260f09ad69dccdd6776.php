...
<thead>
	...
	<input type="hidden" name="8a2e0dc221aaa0b7dd08a592ce37c634" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=49d9f3851e6f7d773a173538af423c2a">
...
<!--        </div>-->
        ...
        <input type="hidden" name="8a2e0dc221aaa0b7dd08a592ce37c634" value="1" />
            </form>
    </div>
