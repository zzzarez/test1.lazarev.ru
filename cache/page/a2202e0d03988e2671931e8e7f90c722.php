...
<thead>
	...
	<input type="hidden" name="0d9de73d77e957b68e2de7a9c68ab36d" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="kin-glin@ya.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="0d9de73d77e957b68e2de7a9c68ab36d" value="1" />
            </form>
    </div>
