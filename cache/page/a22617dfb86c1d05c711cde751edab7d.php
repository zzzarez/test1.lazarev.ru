...
<thead>
	...
	<input type="hidden" name="d2abd67beb8a090ca0fecb0774b12626" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=9a002f368d9f2eeae6a9fa20c6ab9641">
...
<!--        </div>-->
        ...
        <input type="hidden" name="d2abd67beb8a090ca0fecb0774b12626" value="1" />
            </form>
    </div>
