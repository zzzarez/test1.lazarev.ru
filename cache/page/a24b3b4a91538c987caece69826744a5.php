...
<thead>
	...
	<input type="hidden" name="44888face7ec92d89778a03f106339fc" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="slavik.kl@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="44888face7ec92d89778a03f106339fc" value="1" />
            </form>
    </div>
