...
<thead>
	...
	<input type="hidden" name="634e65040c9177f617242e9c3f368aba" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3379&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="20041204tolyati" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="634e65040c9177f617242e9c3f368aba" value="1" />
            </form>
    </div>
