...
<thead>
	...
	<input type="hidden" name="73f0e3531c7f3f46627ea877b05df6e1" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3126&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=41">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52344ac1ed1fa" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="73f0e3531c7f3f46627ea877b05df6e1" value="1" />
            </form>
    </div>
