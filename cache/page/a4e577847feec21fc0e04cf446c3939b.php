...
<thead>
	...
	<input type="hidden" name="378cd00b9f28564985182f3d0ca363b2" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3600&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2012060203moskva" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="378cd00b9f28564985182f3d0ca363b2" value="1" />
            </form>
    </div>
