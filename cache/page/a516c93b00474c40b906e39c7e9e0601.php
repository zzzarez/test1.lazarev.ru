...
<thead>
	...
	<input type="hidden" name="00938784f753a57354e04a9a2a7f1a73" value="1" /></form>
</div>
    </div>
</div>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3742" method="post" name="delete" style="display: inline;">
  ...
  <tr valign="top" class="sectiontableentry2">
      ...
      <td ><img class='cart_prod_img' src='/components/com_virtuemart/shop_image/product/audio.jpg'></td>
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3742&amp;category_id=0&amp;option=com_virtuemart&amp;Itemid=1"><strong>Семинар 8 и 9 июня 2013г г.Омск</strong></a><br />    </td>
      <td style="vertical-align: middle;width: 70px;" align='center'>
          <b style='font-size:11px;'>электронная версия<br>(mp3)</b>      </td>
...
<!--        </div>-->
        ...
        <input type="hidden" name="00938784f753a57354e04a9a2a7f1a73" value="1" />
            </form>
    </div>
<div class="vmCartModule radgrad"><div class='cart_hdr_img'><a style='font-size:14px;color:white;' href='/index.php?page=shop.cart&option=com_virtuemart&Itemid=1'>Корзина</a></div>  <script type="text/javascript">
        document.getElementsById('sbm_btn3742').forEach(function(sm) {
	    sm.value = 'В корзине';
	    sm.disabled = true;
        });
	    ...
	    sm.disabled = true;
            ...
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=0&amp;product_id=3742&amp;option=com_virtuemart&amp;Itemid=1">Семинар 8 и 9 июня 2013г г.Омск</a>
            </div>
