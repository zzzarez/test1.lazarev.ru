...
<thead>
	...
	<input type="hidden" name="f9bdde434a53224c8d6310e11cee4a96" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523505ecdd200" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="f9bdde434a53224c8d6310e11cee4a96" value="1" />
            </form>
    </div>
