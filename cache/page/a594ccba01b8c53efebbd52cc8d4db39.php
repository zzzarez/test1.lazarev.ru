...
<thead>
	...
	<input type="hidden" name="cb9159b33df24a48214d4d111bd1ccf6" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=d5233048a525398b81a28bdda1ff6e81">
...
<!--        </div>-->
        ...
        <input type="hidden" name="cb9159b33df24a48214d4d111bd1ccf6" value="1" />
            </form>
    </div>
