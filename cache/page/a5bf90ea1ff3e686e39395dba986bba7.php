...
<thead>
	...
	<input type="hidden" name="dcd69163d8fee68942b36236aea4f7b5" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=13db6cd4220ea98d3a6c7db3f0a26573">
...
<!--        </div>-->
        ...
        <input type="hidden" name="dcd69163d8fee68942b36236aea4f7b5" value="1" />
            </form>
    </div>
