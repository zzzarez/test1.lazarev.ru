...
<thead>
	...
	<input type="hidden" name="6d8b1310ca3a8c943c6f23229f99f88d" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="Apost@inbox.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="6d8b1310ca3a8c943c6f23229f99f88d" value="1" />
            </form>
    </div>
...
<div style="float: left;font-size: 11px;padding: 10px;font-weight: bold;color: red;" >
    ...
    <input type="hidden" id="totalprice_hlp" value="600"/>
...
всего: <font style='font-size:14px;margin-left:7px;line-height:0px;'>600 р. </font></div>
