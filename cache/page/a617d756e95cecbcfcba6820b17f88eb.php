...
<thead>
	...
	<input type="hidden" name="e6d3f8aa5c0815c497899534317947ea" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52346bfdadbd0" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="e6d3f8aa5c0815c497899534317947ea" value="1" />
            </form>
    </div>
