...
<thead>
	...
	<input type="hidden" name="b2c3f5d49deb373f5deebbcbccc24bef" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5238fa1b8e144" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="b2c3f5d49deb373f5deebbcbccc24bef" value="1" />
            </form>
    </div>
