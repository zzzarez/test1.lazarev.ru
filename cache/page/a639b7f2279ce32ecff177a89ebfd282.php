...
<thead>
	...
	<input type="hidden" name="c2ab615425b97b571831befbdddaa420" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3177&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=41">Вернуться к товару</a>
	<br /><br />
...
<!--        </div>-->
        ...
        <input type="hidden" name="c2ab615425b97b571831befbdddaa420" value="1" />
            </form>
    </div>
