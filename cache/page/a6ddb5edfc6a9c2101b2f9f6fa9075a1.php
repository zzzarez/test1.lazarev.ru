...
<thead>
	...
	<input type="hidden" name="47a4e22f12a2d4884eb215f548567399" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=49a73ebeffc1cd83fd3c6a881288b861">
...
<!--        </div>-->
        ...
        <input type="hidden" name="47a4e22f12a2d4884eb215f548567399" value="1" />
            </form>
    </div>
