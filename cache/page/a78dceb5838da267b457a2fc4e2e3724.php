...
<thead>
	...
	<input type="hidden" name="c64c2576dd44f54e4500d6753ed03d1f" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="archiman@inbox.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="c64c2576dd44f54e4500d6753ed03d1f" value="1" />
            </form>
    </div>
