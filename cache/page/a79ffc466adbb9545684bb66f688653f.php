...
<thead>
	...
	<input type="hidden" name="474ee7a85d5f44732febcce74dfeb427" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523a981adf703" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="474ee7a85d5f44732febcce74dfeb427" value="1" />
            </form>
    </div>
