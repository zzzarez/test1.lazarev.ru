...
<thead>
	...
	<input type="hidden" name="886db06f3d500cc10301cbcab7551495" value="1" /></form>
</div>
    </div>
</div>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
	...
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3753&amp;category_id=0&amp;option=com_virtuemart&amp;Itemid=1"><strong>Прага. 17 и 18 августа 2013г.</strong></a><br />    </td>
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3589" method="post" name="delete" style="display: inline;">
  ...
  <tr valign="top" class="sectiontableentry2">
      ...
      <td ><img class='cart_prod_img' src='/components/com_virtuemart/shop_image/product/vost_put.jpg'></td>
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3589&amp;category_id=0&amp;option=com_virtuemart&amp;Itemid=1"><strong>Восточный путь к здоровью</strong></a><br />    </td>
      <td style="vertical-align: middle;width: 70px;" align='center'>
...
<!--  </tr>-->
  ...
  <tr class="sectiontableentry1" style="border-bottom:0px ;border-top: 2px solid rgb(213, 210, 210);">
    ...
    <td  align="right" ><strong>270 р. </strong></td>
      <td></td>
...
<!--        </div>-->
        ...
        <input type="hidden" name="886db06f3d500cc10301cbcab7551495" value="1" />
            </form>
    </div>
<div class="vmCartModule radgrad"><div class='cart_hdr_img'><a style='font-size:14px;color:white;' href='/index.php?page=shop.cart&option=com_virtuemart&Itemid=1'>Корзина</a></div>  <script type="text/javascript">
        document.getElementsById('sbm_btn3589').forEach(function(sm) {
	    sm.value = 'В корзине';
	    sm.disabled = true;
        });
        document.getElementsById('sbm_btn3753').forEach(function(sm) {
	    sm.value = 'В корзине';
	    sm.disabled = true;
        });
  </script>
            ...
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=0&amp;product_id=3589&amp;option=com_virtuemart&amp;Itemid=1">Восточный путь к здоровью</a>
            </div>
            ...
            <br style="clear: both;" />
                         ...
                         <div style="border-bottom: 1px dotted #949292;">
                <div class="vmCartPrice" style="float: left;font-size: 11px;width:137px; text-align: left;padding-left: 7px;padding-bottom: 10px; padding-top: 10px;">
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=0&amp;product_id=3753&amp;option=com_virtuemart&amp;Itemid=1">Прага. 17 и 18 августа 2013г.</a>
            </div>
                <div class="vmCartPrice" style="float: right;font-size: 9px;padding-right: 5px;padding-bottom: 10px; padding-top: 10px;">
            200 р.             </div>
            <br style="clear: both;" />
...
<div style="float: left;font-size: 11px;padding: 10px;font-weight: bold;color: red;" >
    ...
    <input type="hidden" id="totalprice_hlp" value="270"/>
...
всего: <font style='font-size:14px;margin-left:7px;line-height:0px;'>270 р. </font></div>
