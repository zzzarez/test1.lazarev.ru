...
<thead>
	...
	<input type="hidden" name="828414fb825ac48afca871b029b330c6" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=249f4dfaab3529bba060f7c960a7d520">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"Восточный путь к здоровью"
    </a>
    <br>
        Имя файла: putkzdorovu.pdf        <br>
...
<!--        </div>-->
        ...
        <input type="hidden" name="828414fb825ac48afca871b029b330c6" value="1" />
            </form>
    </div>
