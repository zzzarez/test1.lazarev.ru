...
<thead>
	...
	<input type="hidden" name="21ca699a8dfded65b06b533a0581324c" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3394&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2005112627moskva" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="21ca699a8dfded65b06b533a0581324c" value="1" />
            </form>
    </div>
