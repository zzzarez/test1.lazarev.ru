...
<thead>
	...
	<input type="hidden" name="7f2972037acec738deeda2eb8884160a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=3710e4e7b3cc89bb71299520746a346d">
...
<!--        </div>-->
        ...
        <input type="hidden" name="7f2972037acec738deeda2eb8884160a" value="1" />
            </form>
    </div>
