...
<thead>
	...
	<input type="hidden" name="45ab487bf79852bbec37722687569a20" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=3220f27ca3802dba6961fdad5e8376ec">
...
<!--        </div>-->
        ...
        <input type="hidden" name="45ab487bf79852bbec37722687569a20" value="1" />
            </form>
    </div>
