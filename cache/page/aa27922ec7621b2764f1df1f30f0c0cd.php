...
<thead>
	...
	<input type="hidden" name="6a70600217a58b68df12a5ed421e53d0" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_audio.jpg" height="192" width="200" alt="Петропавловск-Камчатский. 26 августа 2007 г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Петропавловск-Камчатский. 26 августа 2007 г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3182&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5233558588d7d" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Петропавловск-Камчатский. 26 августа 2007 г.","100");var sm=document.getElementById("sbm_btn3182");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3182" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3182" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3182" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<div class="fly_desc_wrp">
    Петропавловск-Камчатский. 26 августа 2007 г.</div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="6a70600217a58b68df12a5ed421e53d0" value="1" />
            </form>
    </div>
