...
<thead>
	...
	<input type="hidden" name="68b9b5f1441a9a81317cb3a39c9edc6d" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=afd248ffa0984eaf9c0de2e394887044">
...
<!--        </div>-->
        ...
        <input type="hidden" name="68b9b5f1441a9a81317cb3a39c9edc6d" value="1" />
            </form>
    </div>
