...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?option=com_content&amp;view=article&amp;id=59&amp;Itemid=43" class="pathway">Частые вопросы</a> <img src="/images/M_images/arrow.png" alt=""  /> Регистрация</span>
        ...
        if( !(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,4})+$/.test(form.email.value))) {
           ...
           // $('email_ticker').setHTML("<img src=\"http://shop.lazarev.ru/images/wait.gif\">&nbsp;Checking");
			...
			return isvalid;
	            ...
	            //]]>
	    </script><form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.registration&Itemid=43" method="post" name="adminForm">
