...
<thead>
	...
	<input type="hidden" name="d75cbcda8152e80dfe2df7da080f2fbf" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3630&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="7772005030506moskva" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="d75cbcda8152e80dfe2df7da080f2fbf" value="1" />
            </form>
    </div>
