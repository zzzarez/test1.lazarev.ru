...
<thead>
	...
	<input type="hidden" name="f82dcae7234f5aaa0274df09e392938c" value="1" /></form>
</div>
    </div>
</div>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
	...
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3614&amp;category_id=0&amp;option=com_virtuemart&amp;Itemid=1"><strong>Саратов. 10 декабря 1997 г.</strong></a><br />    </td>
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3614" method="post" name="delete" style="display: inline;">
...
<!--        </div>-->
        ...
        <input type="hidden" name="f82dcae7234f5aaa0274df09e392938c" value="1" />
            </form>
    </div>
