...
<thead>
	...
	<input type="hidden" name="48722a4d04acbc7daf9f99dc62442cd6" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3656&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523a85ef18b7f" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Алматы. 30 мая 2000 г. (весна)","100");var sm=document.getElementById("sbm_btn3656");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3656" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3656" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3656" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="48722a4d04acbc7daf9f99dc62442cd6" value="1" />
            </form>
    </div>
