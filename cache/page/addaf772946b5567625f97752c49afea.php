...
<thead>
	...
	<input type="hidden" name="5986abdc96c916c7163015bfb231f3b5" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_audio.jpg" height="192" width="200" alt="Рига. 21 и 22 августа 2000 г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Рига. 21 и 22 августа 2000 г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3080&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523ae7bd5fb4b" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Рига. 21 и 22 августа 2000 г.","100");var sm=document.getElementById("sbm_btn3080");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3080" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3080" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3080" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="5986abdc96c916c7163015bfb231f3b5" value="1" />
            </form>
    </div>
