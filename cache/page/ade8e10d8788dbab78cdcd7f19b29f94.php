...
<thead>
	...
	<input type="hidden" name="6c1d1bda26634adea3e718eefe8b92f1" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=6ae851bbee22d8838d4f6977fccb15fb">
...
<!--        </div>-->
        ...
        <input type="hidden" name="6c1d1bda26634adea3e718eefe8b92f1" value="1" />
            </form>
    </div>
