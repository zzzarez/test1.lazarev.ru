...
<thead>
	...
	<input type="hidden" name="b3bbdc3e26546a9ca4bf7bea9287cbf3" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523ae8158cf5f" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="b3bbdc3e26546a9ca4bf7bea9287cbf3" value="1" />
            </form>
    </div>
