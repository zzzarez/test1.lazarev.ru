...
<thead>
	...
	<input type="hidden" name="aa97da6395922e7eb4eb75d6206e4b94" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=23d8b00ac88efe114327d9cc9c486e61">
...
<!--        </div>-->
        ...
        <input type="hidden" name="aa97da6395922e7eb4eb75d6206e4b94" value="1" />
            </form>
    </div>
