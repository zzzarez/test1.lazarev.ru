...
<thead>
	...
	<input type="hidden" name="4ba4ae5f07ceb663f786790dfdef7a0b" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> Регистрация</span>
        ...
        if( !(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,4})+$/.test(form.email.value))) {
           ...
           // $('email_ticker').setHTML("<img src=\"http://shop.lazarev.ru/images/wait.gif\">&nbsp;Checking");
			...
			return isvalid;
	            ...
	            //]]>
	    </script><form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.registration&Itemid=27" method="post" name="adminForm">
...
<div align="center"><input type="hidden" name="remember" value="yes" />
	...
	<input type="hidden" name="4ba4ae5f07ceb663f786790dfdef7a0b" value="1" />
...
<!--        </div>-->
        ...
        <div class="form-login-links">
            <a href="index.php?option=com_virtuemart&amp;page=shop.registration&amp;Itemid=27">Регистрация</a>
