...
<thead>
	...
	<input type="hidden" name="57bd8a683cdb883351dbd6824735a744" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3493&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=40">Вернуться к товару</a>
	<br /><br />
...
<!--        </div>-->
        ...
        <input type="hidden" name="57bd8a683cdb883351dbd6824735a744" value="1" />
            </form>
    </div>
