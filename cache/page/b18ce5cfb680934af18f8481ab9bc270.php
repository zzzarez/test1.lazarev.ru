...
<thead>
	...
	<input type="hidden" name="143a9627c3c50d666ef6a1bf6b375733" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="valger@yandex.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="143a9627c3c50d666ef6a1bf6b375733" value="1" />
            </form>
    </div>
