...
<thead>
	...
	<input type="hidden" name="e2d59ca52e5da9942a4caf5da5a464d5" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=d86fd31b4cd6a4665b65b48fafe650d2">
...
<!--        </div>-->
        ...
        <input type="hidden" name="e2d59ca52e5da9942a4caf5da5a464d5" value="1" />
            </form>
    </div>
