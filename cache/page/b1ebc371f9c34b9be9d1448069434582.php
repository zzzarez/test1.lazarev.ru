...
<thead>
	...
	<input type="hidden" name="8dead30052e1a041c0f209624013112f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=5ec737eaa3a194f051bf661a2fd0ac36">
...
<!--        </div>-->
        ...
        <input type="hidden" name="8dead30052e1a041c0f209624013112f" value="1" />
            </form>
    </div>
