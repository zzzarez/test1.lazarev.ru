...
<thead>
	...
	<input type="hidden" name="f6db64cb6bee74a3304e070f07434ce6" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=1ad71938109d4defbf02c0373df78e55">
...
<!--        </div>-->
        ...
        <input type="hidden" name="f6db64cb6bee74a3304e070f07434ce6" value="1" />
            </form>
    </div>
