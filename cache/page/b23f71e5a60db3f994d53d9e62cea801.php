...
<thead>
	...
	<input type="hidden" name="c2fc2d2fcb5e602dc588cd39f12908ba" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523998fd17c1d" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="c2fc2d2fcb5e602dc588cd39f12908ba" value="1" />
            </form>
    </div>
