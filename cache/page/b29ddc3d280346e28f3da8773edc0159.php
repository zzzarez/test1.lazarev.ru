...
<thead>
	...
	<input type="hidden" name="1a40ebbb2a770f9a6ceacb39e9ed689b" value="1" /></form>
</div>
    </div>
</div>
...
<h2 align="center">
    <b>
        7 сентября (первый день)<br> </b>

</h2>

 <b>Семинар Лазарева С.Н.<br>
     г. Москва, 7 сентября  2013 года (первый день)<br>      11.00 – 15.00 по московскому времени<br>
 </b><br>
<br><br>
...
<!--    <img src="/images/zag.jpg" alt="">-->
                <br><br><br><br>
                <iframe name="prolivestream" src="http://facecast.net/player/?stream=live90&stream_lines=720&def_q=4&autoPlay=false&title=pro-stream.ru&poster=https://dl.dropboxusercontent.com/s/8dugixs8e7gm8hu/plyaerbackground.jpg&width=550&height=309" scrolling="no" frameborder="no" height="339" width="549"></iframe>
<!--           <iframe name="prolivestream" src="http://facecast.net/player/?stream=live90&stream_lines=720&def_q=4&autoPlay=false&title=pro-stream.ru&poster=https://dl.dropboxusercontent.com/s/8dugixs8e7gm8hu/plyaerbackground.jpg&width=565&height=318" scrolling="no" frameborder="no" height="318" width="565"></iframe>-->

<!--                <iframe name="prolivestream" src="http://facecast.net/player/?stream=live4&stream_lines=720&def_q=4&autoPlay=false&title=pro-stream.ru&poster=https://dl.dropboxusercontent.com/s/8dugixs8e7gm8hu/plyaerbackground.jpg&width=565&height=318" scrolling="no" frameborder="no" height="340" width="565"></iframe>-->
<!--                <iframe src="http://broadcast.comdi.com/broadcast/player/stream/?eventKey=4oi338yuknd3tgham410" width="565" height="350" frameborder="0" scrolling="no"></iframe>-->
                <!--                <iframe src="http://broadcast.comdi.com/broadcast/player/stream/?eventKey=aazesum1o7n46crqwiro" width="565" height="350" frameborder="0" scrolling="no"></iframe>-->
...
<!--        </div>-->
        ...
        <input type="hidden" name="1a40ebbb2a770f9a6ceacb39e9ed689b" value="1" />
            </form>
    </div>
