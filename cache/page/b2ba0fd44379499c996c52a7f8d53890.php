...
<thead>
	...
	<input type="hidden" name="bf4bc91e833e75644af290aa49f17dc7" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="Iuynina@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="bf4bc91e833e75644af290aa49f17dc7" value="1" />
            </form>
    </div>
