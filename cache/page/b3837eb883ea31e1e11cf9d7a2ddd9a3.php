...
<thead>
	...
	<input type="hidden" name="9d3e19f4525ee893be971fc20dc6f1d0" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="dashka7@land.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="9d3e19f4525ee893be971fc20dc6f1d0" value="1" />
            </form>
    </div>
