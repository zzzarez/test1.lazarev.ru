...
<thead>
	...
	<input type="hidden" name="907861eb835e3cb5aea36973f690cb37" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="nata77277@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="907861eb835e3cb5aea36973f690cb37" value="1" />
            </form>
    </div>
