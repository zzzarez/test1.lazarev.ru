...
<thead>
	...
	<input type="hidden" name="e0c89613204ddf19466c698836f66929" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_audio.jpg" height="192" width="200" alt="Ялта. Семинар 19 и 20 ноября 2011 г (2 дня)" border="0" />    </div>
    <div class="fly_name">
        <b align="left">Ялта. Семинар 19 и 20 ноября 2011 г (2 дня)</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3275&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52390f257c3a3" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Ялта. Семинар 19 и 20 ноября 2011 г (2 дня)","200");var sm=document.getElementById("sbm_btn3275");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3275" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3275" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3275" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="e0c89613204ddf19466c698836f66929" value="1" />
            </form>
    </div>
