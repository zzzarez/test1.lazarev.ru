...
<thead>
	...
	<input type="hidden" name="d1e7912bec23c12264dc416da014c3f0" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3311&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="19970610zhukovskiy" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="d1e7912bec23c12264dc416da014c3f0" value="1" />
            </form>
    </div>
