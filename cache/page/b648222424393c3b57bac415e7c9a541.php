...
<thead>
	...
	<input type="hidden" name="b5617260b29c0d5ed0dd062c852fb77d" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3037&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="19940507kaunas_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="b5617260b29c0d5ed0dd062c852fb77d" value="1" />
            </form>
    </div>
