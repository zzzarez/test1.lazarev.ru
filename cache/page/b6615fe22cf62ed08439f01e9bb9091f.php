...
<thead>
	...
	<input type="hidden" name="ae52226b2626bacd6ff05739b31b063e" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="tradu77@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="ae52226b2626bacd6ff05739b31b063e" value="1" />
            </form>
    </div>
