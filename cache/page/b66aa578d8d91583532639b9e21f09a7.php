...
<thead>
	...
	<input type="hidden" name="db2d60042508b05cb62aceea3b582ea4" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?page=shop.browse&amp;category_id=8&amp;option=com_virtuemart&amp;Itemid=1" class="pathway">Аудио</a> <img src="/images/M_images/arrow.png" alt=""  /> Москва. 14 и 15 апреля 2004 г. (2 дня)</span>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3114&amp;category_id=8&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52363623445a8" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="db2d60042508b05cb62aceea3b582ea4" value="1" />
            </form>
    </div>
