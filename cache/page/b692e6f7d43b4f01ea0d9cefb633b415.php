...
<thead>
	...
	<input type="hidden" name="344e7d3b0ab35d99cf7de650c8e681ba" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=9d4d2c0f90d74385b3199d6fe436b152">
...
<!--        </div>-->
        ...
        <input type="hidden" name="344e7d3b0ab35d99cf7de650c8e681ba" value="1" />
            </form>
    </div>
