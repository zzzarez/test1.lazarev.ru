...
<thead>
	...
	<input type="hidden" name="bfd31b4f80129174a9e4d8113425ff35" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3690&amp;category_id=6&amp;option=com_virtuemart&amp;Itemid=6">Вернуться к товару</a>
	<br /><br />
...
<!--        </div>-->
        ...
        <input type="hidden" name="bfd31b4f80129174a9e4d8113425ff35" value="1" />
            </form>
    </div>
