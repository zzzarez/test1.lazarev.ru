...
<thead>
	...
	<input type="hidden" name="140565f53d00c58d42d78fdf344836b3" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3690&amp;category_id=6&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
...
<!--        </div>-->
        ...
        <input type="hidden" name="140565f53d00c58d42d78fdf344836b3" value="1" />
            </form>
    </div>
