...
<thead>
	...
	<input type="hidden" name="9f2161fe603196c7d5b8b321a5baec1c" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3515&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2011043001almaati" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="9f2161fe603196c7d5b8b321a5baec1c" value="1" />
            </form>
    </div>
