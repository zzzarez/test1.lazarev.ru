...
<thead>
	...
	<input type="hidden" name="c27ed159eddfaecfc2f1662803660fd4" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52389743c26d3" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="c27ed159eddfaecfc2f1662803660fd4" value="1" />
            </form>
    </div>
