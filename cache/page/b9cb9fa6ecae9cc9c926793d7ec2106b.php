...
<thead>
	...
	<input type="hidden" name="2fcb98862d712625815dfb0c2abf0e4c" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=170750f6d9228c769894b2636590473c">
...
<!--        </div>-->
        ...
        <input type="hidden" name="2fcb98862d712625815dfb0c2abf0e4c" value="1" />
            </form>
    </div>
