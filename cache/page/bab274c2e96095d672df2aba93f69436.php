...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?option=com_content&amp;view=article&amp;id=59&amp;Itemid=43" class="pathway">Частые вопросы</a> <img src="/images/M_images/arrow.png" alt=""  /> Корзина</span>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
	...
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3755&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=43"><strong>Москва. 7 и 8 сентября 2013г.</strong></a><br />    </td>
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart&Itemid=43" method="post" name="delete" style="display: inline;">
  ...
  <tr valign="top" class="sectiontableentry2">
      ...
      <td ><img class='cart_prod_img' src='/components/com_virtuemart/shop_image/product/RUS_DVD_DK2_front.jpg'></td>
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3526&amp;category_id=0&amp;option=com_virtuemart&amp;Itemid=43"><strong>С-Петербург. Семинар 10 и 11 декабря 2011г (2 дня.)</strong></a><br />    </td>
      <td style="vertical-align: middle;width: 70px;" align='center'>
          <b style='font-size:11px;'>электронная версия<br>(avi)</b>      </td>
...
<!--  </tr>-->
  ...
  <tr class="sectiontableentry1" style="border-bottom:0px ;border-top: 2px solid rgb(213, 210, 210);">
    ...
    <td  align="right" ><strong>560 р. </strong></td>
      <td></td>
...
<!--  </tr>-->
    ...
    <a href="http://shop.lazarev.ru/index.php?page=checkout.index&amp;ssl_redirect=1&amp;option=com_virtuemart&amp;Itemid=43" title="Оформить заказ" class="checkout_link" onclick="try{ if( !parent.GB ) return GB_showCenter('Оформить заказ', 'http://shop.lazarev.ru/index2.php?page=checkout.index&amp;ssl_redirect=1&amp;option=com_virtuemart&amp;Itemid=43', 500, 600);} catch(e) { }">Оформить заказ</a>	</div>
