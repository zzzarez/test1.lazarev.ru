...
<thead>
	...
	<input type="hidden" name="abb44d371286010a410992b3ec405a2d" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5239fea739c9c" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="abb44d371286010a410992b3ec405a2d" value="1" />
            </form>
    </div>
