...
<thead>
	...
	<input type="hidden" name="f61376181d4ee01e412313113ec22b01" value="1" /></form>
</div>
    </div>
</div>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
	...
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3346&amp;category_id=0&amp;option=com_virtuemart&amp;Itemid=1"><strong>Волгоград. Семинар 1 и 2 мая 2002 г. (2 дня)</strong></a><br />    </td>
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3510" method="post" name="delete" style="display: inline;">
  ...
  <tr valign="top" class="sectiontableentry2">
	...
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3510&amp;category_id=0&amp;option=com_virtuemart&amp;Itemid=1"><strong>Москва. Семинар 6 и 7 марта 2011 г. (2 дня)</strong></a><br />    </td>
      <td style="vertical-align: middle;width: 70px;" align='center'>
          <b style='font-size:11px;'>электронная версия<br>(avi)</b>      </td>
...
<!--        </div>-->
        ...
        <input type="hidden" name="f61376181d4ee01e412313113ec22b01" value="1" />
            </form>
    </div>
<div class="vmCartModule radgrad"><div class='cart_hdr_img'><a style='font-size:14px;color:white;' href='/index.php?page=shop.cart&option=com_virtuemart&Itemid=1'>Корзина</a></div>  <script type="text/javascript">
        document.getElementsById('sbm_btn3510').forEach(function(sm) {
	    sm.value = 'В корзине';
	    sm.disabled = true;
        });
        document.getElementsById('sbm_btn3346').forEach(function(sm) {
	    sm.value = 'В корзине';
	    sm.disabled = true;
        });
  </script>
            ...
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=0&amp;product_id=3510&amp;option=com_virtuemart&amp;Itemid=1">Москва. Семинар 6 и 7 марта 2011 г. (2 дня)</a>
            </div>
            ...
            <br style="clear: both;" />
                         ...
                         <div style="border-bottom: 1px dotted #949292;">
                <div class="vmCartPrice" style="float: left;font-size: 11px;width:137px; text-align: left;padding-left: 7px;padding-bottom: 10px; padding-top: 10px;">
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=0&amp;product_id=3346&amp;option=com_virtuemart&amp;Itemid=1">Волгоград. Семинар 1 и 2 мая 2002 г. (2 дня)</a>
            </div>
                <div class="vmCartPrice" style="float: right;font-size: 9px;padding-right: 5px;padding-bottom: 10px; padding-top: 10px;">
            280 р.             </div>
            <br style="clear: both;" />
