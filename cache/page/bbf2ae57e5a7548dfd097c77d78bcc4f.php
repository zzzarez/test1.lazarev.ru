...
<thead>
	...
	<input type="hidden" name="69c3153733cdbc5a6cf90b84bd946982" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=4dbb044f9648b6e457ac9fa9551bc70b">
...
<!--        </div>-->
        ...
        <input type="hidden" name="69c3153733cdbc5a6cf90b84bd946982" value="1" />
            </form>
    </div>
