...
<thead>
	...
	<input type="hidden" name="faac120d1dd9d463a4dc3a976732350a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=8e0489e6408868feebca3be017cfbe2b">
...
<!--        </div>-->
        ...
        <input type="hidden" name="faac120d1dd9d463a4dc3a976732350a" value="1" />
            </form>
    </div>
