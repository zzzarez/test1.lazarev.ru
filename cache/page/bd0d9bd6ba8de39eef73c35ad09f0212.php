...
<thead>
	...
	<input type="hidden" name="0156f5c3464308dbda8eefb5e4f4a379" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3529&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=43">Вернуться к товару</a>
	<br /><br />
...
<!--        </div>-->
        ...
        <input type="hidden" name="0156f5c3464308dbda8eefb5e4f4a379" value="1" />
            </form>
    </div>
