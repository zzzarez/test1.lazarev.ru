...
<thead>
	...
	<input type="hidden" name="abf5491a5586a4aab91bbe41bbec5a1f" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5239a0c36ffea" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="abf5491a5586a4aab91bbe41bbec5a1f" value="1" />
            </form>
    </div>
