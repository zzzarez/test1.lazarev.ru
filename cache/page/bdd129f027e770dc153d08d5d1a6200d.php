...
<thead>
	...
	<input type="hidden" name="46f6c5730211558d575ae8ecfe59fa8f" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5233c4b984a04" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="46f6c5730211558d575ae8ecfe59fa8f" value="1" />
            </form>
    </div>
