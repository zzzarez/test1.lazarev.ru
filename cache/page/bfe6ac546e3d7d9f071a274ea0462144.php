...
<thead>
	...
	<input type="hidden" name="422344e280b1b991121928afdbf9d60a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3533&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2012040708piter" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="422344e280b1b991121928afdbf9d60a" value="1" />
            </form>
    </div>
