...
<thead>
	...
	<input type="hidden" name="09982c0b45ca48e4e543c838f051fa5d" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3361&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2003102223piter" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="09982c0b45ca48e4e543c838f051fa5d" value="1" />
            </form>
    </div>
