...
<thead>
	...
	<input type="hidden" name="bf6450c00367edf7d589b2efd7fd1cb8" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3276&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=41">Вернуться к товару</a>
	<br /><br />
...
<!--        </div>-->
        ...
        <input type="hidden" name="bf6450c00367edf7d589b2efd7fd1cb8" value="1" />
            </form>
    </div>
