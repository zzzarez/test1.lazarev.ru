...
<thead>
	...
	<input type="hidden" name="7c4ca8e4589fce80ca6f98cd09933229" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="pozindmitry@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="7c4ca8e4589fce80ca6f98cd09933229" value="1" />
            </form>
    </div>
