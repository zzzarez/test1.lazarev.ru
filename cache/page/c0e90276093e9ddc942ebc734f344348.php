...
<thead>
	...
	<input type="hidden" name="f32baede5ec1d2e5b83b3e94b0c82dad" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=76e8d4dc7446f556e2972b55f57368f4">
...
<!--        </div>-->
        ...
        <input type="hidden" name="f32baede5ec1d2e5b83b3e94b0c82dad" value="1" />
            </form>
    </div>
