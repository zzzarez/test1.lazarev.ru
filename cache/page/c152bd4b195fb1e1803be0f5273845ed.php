...
<thead>
	...
	<input type="hidden" name="ba221e8f17c281d5fbf46b3fb6711b26" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523baa06c251e" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="ba221e8f17c281d5fbf46b3fb6711b26" value="1" />
            </form>
    </div>
