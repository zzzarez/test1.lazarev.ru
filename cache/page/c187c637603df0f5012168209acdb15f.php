...
<thead>
	...
	<input type="hidden" name="dae41b3d25b6af7e2f23cce3efddc2bf" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=95891046d527c54c178c6e4e0768ef06">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"Билет на онлайн-трансляцию 21 октября"
    </a>
    <br>
        Имя файла: aga_view.htm        <br>
...
<!--        </div>-->
        ...
        <input type="hidden" name="dae41b3d25b6af7e2f23cce3efddc2bf" value="1" />
            </form>
    </div>
