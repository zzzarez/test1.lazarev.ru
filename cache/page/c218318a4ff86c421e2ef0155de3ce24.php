...
<thead>
	...
	<input type="hidden" name="5f69cae0b8eb276ce128c6f6b2d74e4d" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
	...
	<ul id="cpanel">
					<li class="cpanel-icon tooltip" title="Editor Global Configuration::Edit the JCE Editor Global Configuration"><a href="index.php?option=com_jce&amp;view=config"><span class="config"></span>Editor Global Configuration</a></li>
							<li class="cpanel-icon tooltip" title="Editor Profiles::Create / Edit profiles for the editor"><a href="index.php?option=com_jce&amp;view=profiles"><span class="profiles"></span>Editor Profiles</a></li>
							<li class="cpanel-icon tooltip" title="Install Add-ons::Install and Manage JCE Add-ons <br />(plugins and languages)"><a href="index.php?option=com_jce&amp;view=installer"><span class="install"></span>Install Add-ons</a></li>
							<li class="cpanel-icon tooltip" title="File Browser::File Browser::Manage files and folders"><a href="index.php?option=com_jce&view=editor&layout=plugin&plugin=browser&standalone=1&wf8ae361eda80f670a92c18558825c9e60=1" class="dialog browser" target="_blank" data-options="{'width':765,'height':480, 'modal':true}" title="File Browser"><span class="browser"></span>File Browser</a></li>
					
	</ul>
	<br style="clear:both;" />
	<ul class="adminformlist">
                <li>
                    <span class="tooltip" title="Support::Documentation, FAQ, Tutorials and Forum">
                        Support                    </span>
                    <a href="http://www.joomlacontenteditor.net/support" target="_new">www.joomlacontenteditor.com/support</a>
                </li>
              
                <li>
                    <span class="tooltip" title="Licence::The Licence JCE is released under">
                        Licence                    </span>
                    <a href="http://www.gnu.org/licenses/old-licenses/gpl-2.0.html" title="GNU General Public License, version 2" target="_blank">GNU General Public License, version 2</a>                </li>
                 <li>
                    <span class="tooltip" title="Version::The Editor version currently installed">
                        Version                    </span>
                    2.1.3                </li>
                	                 <li>
		                <span class="tooltip" title="News Feed::Show JCE Latest News Feed">
		                    News Feed		                </span>
		                <span style="display:inline-block;">
	                	                		News Feed Disabled :: <a title="Options" class="dialog preferences" data-options="{'width':760,'height':540,'modal':true}" href="index.php?option=com_jce&amp;view=preferences&amp;tmpl=component">[Enable News Feed]</a>
	                	                	</span>
	                </li>
                	</ul>
</div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="5f69cae0b8eb276ce128c6f6b2d74e4d" value="1" />
            </form>
    </div>
