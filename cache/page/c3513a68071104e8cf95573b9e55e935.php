...
<thead>
	...
	<input type="hidden" name="31684d5b6e38ccdaaa9cec10f6b4ca19" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=5ebb7f8ce839909c219d22885a8733b5">
...
<!--        </div>-->
        ...
        <input type="hidden" name="31684d5b6e38ccdaaa9cec10f6b4ca19" value="1" />
            </form>
    </div>
