...
<thead>
	...
	<input type="hidden" name="baedb43c2d9b0a1e5527a91743a52849" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=1525363bc194cd6bc1933a30db64578a">
...
<!--        </div>-->
        ...
        <input type="hidden" name="baedb43c2d9b0a1e5527a91743a52849" value="1" />
            </form>
    </div>
