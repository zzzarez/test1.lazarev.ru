...
<thead>
	...
	<input type="hidden" name="c65811ac0f8a72ce22bf36b3c74dd0a0" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3227&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=41">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2009101011germaniya_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="c65811ac0f8a72ce22bf36b3c74dd0a0" value="1" />
            </form>
    </div>
