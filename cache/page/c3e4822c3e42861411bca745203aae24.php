...
<thead>
	...
	<input type="hidden" name="d78610662b4325fc729f9319d27d3a2e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=f0b2ef0aba665ee2085a1f09552a0be9">
...
<!--        </div>-->
        ...
        <input type="hidden" name="d78610662b4325fc729f9319d27d3a2e" value="1" />
            </form>
    </div>
