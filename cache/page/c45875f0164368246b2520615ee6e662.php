...
<thead>
	...
	<input type="hidden" name="630c4bd7985d8b12a8fcbef67d1bd06a" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523abe4d0cc2a" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="630c4bd7985d8b12a8fcbef67d1bd06a" value="1" />
            </form>
    </div>
