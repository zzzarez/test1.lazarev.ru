...
<thead>
	...
	<input type="hidden" name="3c54bdf054a0ab9def1dab12418e672a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3522&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2011100102volgograd" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="3c54bdf054a0ab9def1dab12418e672a" value="1" />
            </form>
    </div>
