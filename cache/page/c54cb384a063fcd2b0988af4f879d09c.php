...
<thead>
	...
	<input type="hidden" name="efbba23da3426f5775509ae96d0987ba" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=aeb4cb3ca3fa55162aca222507fa6ad0">
...
<!--        </div>-->
        ...
        <input type="hidden" name="efbba23da3426f5775509ae96d0987ba" value="1" />
            </form>
    </div>
