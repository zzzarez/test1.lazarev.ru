...
<thead>
	...
	<input type="hidden" name="f54a9a282c7fe8a19311536887545fe7" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=ea420688a363f40937edb3f8dce44367">
...
<!--        </div>-->
        ...
        <input type="hidden" name="f54a9a282c7fe8a19311536887545fe7" value="1" />
            </form>
    </div>
