...
<thead>
	...
	<input type="hidden" name="c0d69f6f2762247b64511f617143dc3b" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=5e21ca4e89636f26db47b6389ee33f8d">
...
<!--        </div>-->
        ...
        <input type="hidden" name="c0d69f6f2762247b64511f617143dc3b" value="1" />
            </form>
    </div>
