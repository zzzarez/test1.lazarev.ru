...
<thead>
	...
	<input type="hidden" name="822a6f94d2f986e36249a6834052e2ad" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="klv5980@yandex.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="822a6f94d2f986e36249a6834052e2ad" value="1" />
            </form>
    </div>
