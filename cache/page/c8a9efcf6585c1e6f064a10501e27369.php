...
<thead>
	...
	<input type="hidden" name="378ea034599d79d76608358f2f1ca426" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=1ac36eedced089d6afeae2277844f452">
...
<!--        </div>-->
        ...
        <input type="hidden" name="378ea034599d79d76608358f2f1ca426" value="1" />
            </form>
    </div>
