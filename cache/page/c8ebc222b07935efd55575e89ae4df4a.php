...
<thead>
	...
	<input type="hidden" name="7849631e486aac1fbecebc1996bfc217" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3369&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=35">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="20040411otveti" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="7849631e486aac1fbecebc1996bfc217" value="1" />
            </form>
    </div>
