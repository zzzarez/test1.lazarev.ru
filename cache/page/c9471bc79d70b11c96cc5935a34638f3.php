...
<thead>
	...
	<input type="hidden" name="41c2a96df29acc5af5d7467542ae1af7" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5234cc2dc1f2e" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="41c2a96df29acc5af5d7467542ae1af7" value="1" />
            </form>
    </div>
