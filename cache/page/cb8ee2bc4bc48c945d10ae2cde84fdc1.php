...
<thead>
	...
	<input type="hidden" name="1e34772034ad56dc7802820ae6cdcc3a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3517&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=6">Вернуться к товару</a>
	<br /><br />
...
<!--        </div>-->
        ...
        <input type="hidden" name="1e34772034ad56dc7802820ae6cdcc3a" value="1" />
            </form>
    </div>
