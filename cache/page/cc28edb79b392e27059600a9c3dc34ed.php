...
<thead>
	...
	<input type="hidden" name="675443c2f7eb2c0102cf274db6a51ea7" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=c3626cc19af3c073c3a2bf0e07e905f1">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"ТВ передача «Бумеранг», июль 1994 г."
    </a>
    <br>
        Имя файла: 19940711bumerang.avi        <br>
...
<!--        </div>-->
        ...
        <input type="hidden" name="675443c2f7eb2c0102cf274db6a51ea7" value="1" />
            </form>
    </div>
