...
<thead>
	...
	<input type="hidden" name="27814b32dc724bb5fb51da014288b80b" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=84262a9f72dfe0d0b0cf2a6d5405435f">
...
<!--        </div>-->
        ...
        <input type="hidden" name="27814b32dc724bb5fb51da014288b80b" value="1" />
            </form>
    </div>
