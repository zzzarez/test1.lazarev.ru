...
<thead>
	...
	<input type="hidden" name="aa04732e572568400a63f5d568bb15ca" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=0f51ddb61bdd3e2ef68e20f71ca037d6">
...
<!--        </div>-->
        ...
        <input type="hidden" name="aa04732e572568400a63f5d568bb15ca" value="1" />
            </form>
    </div>
