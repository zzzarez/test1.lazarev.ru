...
<thead>
	...
	<input type="hidden" name="f7b289a1ab0d87bf7c3805e33715d224" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3148&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2006031112germaniya_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="f7b289a1ab0d87bf7c3805e33715d224" value="1" />
            </form>
    </div>
