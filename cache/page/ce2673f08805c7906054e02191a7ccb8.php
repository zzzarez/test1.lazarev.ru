...
<thead>
	...
	<input type="hidden" name="cf6993c781101c66d406f4d26541ef8b" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3322&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="1998112122piter" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="cf6993c781101c66d406f4d26541ef8b" value="1" />
            </form>
    </div>
