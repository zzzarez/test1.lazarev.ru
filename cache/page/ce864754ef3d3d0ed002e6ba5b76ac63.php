...
<thead>
	...
	<input type="hidden" name="b2489d1e4998fcf6d385f100ba5d53ca" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=afcfa26cae00316f5b92676b07fc9cd1">
...
<!--        </div>-->
        ...
        <input type="hidden" name="b2489d1e4998fcf6d385f100ba5d53ca" value="1" />
            </form>
    </div>
