...
<thead>
	...
	<input type="hidden" name="20317395df051e79e385be2304fbcdc8" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=a81a807d31310ca1a750cb291931cf61">
...
<!--        </div>-->
        ...
        <input type="hidden" name="20317395df051e79e385be2304fbcdc8" value="1" />
            </form>
    </div>
