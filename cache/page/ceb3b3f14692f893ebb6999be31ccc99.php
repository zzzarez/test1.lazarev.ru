...
<thead>
	...
	<input type="hidden" name="6729d18a60b8127853c798e199ba87b4" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://www.shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?option=com_content&amp;view=section&amp;layout=blog&amp;id=5&amp;Itemid=35" class="pathway">Новости</a> <img src="/images/M_images/arrow.png" alt=""  /> Внимание! Изменилась процедура входа в магазин</span>
...
<tr>
<td valign="top">
<p><span style="font-size: 12pt;"><span style="color: #ff0000;">Внимание</span>! Изменилась процедура входа в магазин.</span></p>
<p>За время работы интернет-магазина мы не раз получали письма, в которых вы указываете на различные трудности, связанные с процессом регистрации на сайте. Мы учли ваши замечания, и теперь система регистрации и входа в магазин стали более удобными, функциональными и понятными!</p>
<p><b>Важно</b>: С целью упрощения процедуры регистрации на сайте shop.lazarev.ru произошли изменения относительно входа на сайт (в вашу учетную запись). &nbsp;</p>
<p>Теперь, <b>чтобы авторизоваться на сайте и совершать покупки, необходимо вводить</b> не логин, который вы указывали при регистрации, а <b>ваш E-mail</b>, указанный при регистрации.</p>
<p><b>Пароль</b> остается прежним.</p>
<p>Пользователям, которые регистрировались раньше, тоже нужно входить с использованием email, указанного при регистрации.</p>
<p>Если Вам необходима помощь для входа в магазин или регистрации, то пишите нам в службу поддержки.</p>
<p><img src="images/stories/Снимок_экрана_2013-02-10_в_18.59.37.png" width="258" height="196" alt="Снимок экрана 2013-02-10 в 18.59.37" /></p>
<p align="right">С уважением, команда shop.lazarev.ru</p></td>
</tr>
...
<!--        </div>-->
        ...
        <input type="hidden" name="6729d18a60b8127853c798e199ba87b4" value="1" />
            </form>
    </div>
