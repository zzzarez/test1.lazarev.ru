...
<thead>
	...
	<input type="hidden" name="f55cfcd3cf8b5f70c50b932c4aebff09" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_RUS_DVD_DK_front.jpg" height="292" width="200" alt="Одесса. 25 мая 2005 г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Одесса. 25 мая 2005 г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3385&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523a93d668b5c" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Одесса. 25 мая 2005 г.","140");var sm=document.getElementById("sbm_btn3385");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3385" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3385" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3385" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="f55cfcd3cf8b5f70c50b932c4aebff09" value="1" />
            </form>
    </div>
