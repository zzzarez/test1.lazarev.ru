...
<thead>
	...
	<input type="hidden" name="1dc1e0df5c5983cdb1114b90ca026cff" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=ae98152210bcfddf22dc1b01352709ab">
...
<!--        </div>-->
        ...
        <input type="hidden" name="1dc1e0df5c5983cdb1114b90ca026cff" value="1" />
            </form>
    </div>
