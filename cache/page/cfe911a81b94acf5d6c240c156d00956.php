...
<thead>
	...
	<input type="hidden" name="34c5c2d0079f7072dcac143e30a9b8c7" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3096&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="20020811yalta_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="34c5c2d0079f7072dcac143e30a9b8c7" value="1" />
            </form>
    </div>
