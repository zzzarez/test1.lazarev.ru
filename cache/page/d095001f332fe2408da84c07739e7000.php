...
<thead>
	...
	<input type="hidden" name="32df05bd208b03a29d397c07a53687c9" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3297&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="1995080401piter" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="32df05bd208b03a29d397c07a53687c9" value="1" />
            </form>
    </div>
