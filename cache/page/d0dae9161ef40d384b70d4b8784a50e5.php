...
<thead>
	...
	<input type="hidden" name="c4e1ca0fd8680fd65cdef7912dc1322e" value="1" /></form>
</div>
    </div>
</div>
...
<table class="cart_tbl2">
  ...
  <tr valign="top" class="sectiontableentry1">
	...
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3620&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1"><strong>Ответы на вопросы. Весна 2000 г.</strong></a><br />    </td>
    ...
    <td style="vertical-align: middle;">
        <form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.cart&product_id=3079" method="post" name="delete" style="display: inline;">
  ...
  <tr valign="top" class="sectiontableentry2">
	...
	<td style="vertical-align: middle;width: 499px;" align='left'>
        <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3079&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1"><strong>Ответы на вопросы. Весна 2000 г.</strong></a><br />    </td>
      <td style="vertical-align: middle;width: 70px;" align='center'>
...
<!--  </tr>-->
  ...
  <tr class="sectiontableentry1" style="border-bottom:0px ;border-top: 2px solid rgb(213, 210, 210);">
    ...
    <td  align="right" ><strong>240 р. </strong></td>
      <td></td>
...
<!--        </div>-->
        ...
        <input type="hidden" name="c4e1ca0fd8680fd65cdef7912dc1322e" value="1" />
            </form>
    </div>
<div class="vmCartModule radgrad"><div class='cart_hdr_img'><a style='font-size:14px;color:white;' href='/index.php?page=shop.cart&option=com_virtuemart&Itemid=1'>Корзина</a></div>  <script type="text/javascript">
        document.getElementsById('sbm_btn3079').forEach(function(sm) {
	    sm.value = 'В корзине';
	    sm.disabled = true;
        });
        document.getElementsById('sbm_btn3620').forEach(function(sm) {
	    sm.value = 'В корзине';
	    sm.disabled = true;
        });
  </script>
            ...
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=1&amp;product_id=3079&amp;option=com_virtuemart&amp;Itemid=1">Ответы на вопросы. Весна 2000 г.</a>
            </div>
            ...
            <br style="clear: both;" />
                         ...
                         <div style="border-bottom: 1px dotted #949292;">
                <div class="vmCartPrice" style="float: left;font-size: 11px;width:137px; text-align: left;padding-left: 7px;padding-bottom: 10px; padding-top: 10px;">
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=1&amp;product_id=3620&amp;option=com_virtuemart&amp;Itemid=1">Ответы на вопросы. Весна 2000 г.</a>
            </div>
                <div class="vmCartPrice" style="float: right;font-size: 9px;padding-right: 5px;padding-bottom: 10px; padding-top: 10px;">
            140 р.             </div>
            <br style="clear: both;" />
...
<div style="float: left;font-size: 11px;padding: 10px;font-weight: bold;color: red;" >
    ...
    <input type="hidden" id="totalprice_hlp" value="240"/>
...
всего: <font style='font-size:14px;margin-left:7px;line-height:0px;'>240 р. </font></div>
