...
<thead>
	...
	<input type="hidden" name="a023003bdbfd0283a2dad0bbf836eeac" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523b93cc8babf" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="a023003bdbfd0283a2dad0bbf836eeac" value="1" />
            </form>
    </div>
