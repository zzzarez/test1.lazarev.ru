...
<thead>
	...
	<input type="hidden" name="b65db136e96accb9ff0de5faf0c073e6" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523aea08cf5fc" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="b65db136e96accb9ff0de5faf0c073e6" value="1" />
            </form>
    </div>
