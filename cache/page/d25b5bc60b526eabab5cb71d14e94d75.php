...
<thead>
	...
	<input type="hidden" name="945341ac61cf4e4b9bc3aa623f84f801" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="geriman@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="945341ac61cf4e4b9bc3aa623f84f801" value="1" />
            </form>
    </div>
