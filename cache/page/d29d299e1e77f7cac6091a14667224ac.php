...
<thead>
	...
	<input type="hidden" name="6edffdbc768480c6da4362d77e4c2fb3" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="vis_a_vis_gs@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="6edffdbc768480c6da4362d77e4c2fb3" value="1" />
            </form>
    </div>
<div class="vmCartModule radgrad"><div class='cart_hdr_img'><a style='font-size:14px;color:white;' href='/index.php?page=shop.cart&option=com_virtuemart&Itemid=1'>Корзина</a></div>  <script type="text/javascript">
	    ...
	    sm.disabled = true;
            ...
            <br style="clear: both;" />
                         ...
                         <div style="border-bottom: 1px dotted #949292;">
                <div class="vmCartPrice" style="float: left;font-size: 11px;width:137px; text-align: left;padding-left: 7px;padding-bottom: 10px; padding-top: 10px;">
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=1&amp;product_id=3740&amp;option=com_virtuemart&amp;Itemid=1">Семинар 25 и 26 мая 2013г г.Алматы</a>
            </div>
                <div class="vmCartPrice" style="float: right;font-size: 9px;padding-right: 5px;padding-bottom: 10px; padding-top: 10px;">
            280 р.             </div>
            <br style="clear: both;" />
            ...
            <br style="clear: both;" />
                         ...
                         <div style="border-bottom: 1px dotted #949292;">
                <div class="vmCartPrice" style="float: left;font-size: 11px;width:137px; text-align: left;padding-left: 7px;padding-bottom: 10px; padding-top: 10px;">
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=1&amp;product_id=3725&amp;option=com_virtuemart&amp;Itemid=1">Семинар 13 и 14 апреля 2013г Санкт-Петербург</a>
            </div>
                <div class="vmCartPrice" style="float: right;font-size: 9px;padding-right: 5px;padding-bottom: 10px; padding-top: 10px;">
            280 р.             </div>
            <br style="clear: both;" />
...
<div style="float: left;font-size: 11px;padding: 10px;font-weight: bold;color: red;" >
    ...
    <input type="hidden" id="totalprice_hlp" value="1140"/>
...
всего: <font style='font-size:14px;margin-left:7px;line-height:0px;'>1 140 р. </font></div>
