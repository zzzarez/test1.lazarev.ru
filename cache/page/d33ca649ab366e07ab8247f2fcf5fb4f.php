...
<thead>
	...
	<input type="hidden" name="38260a68b7f5358fbf1fa6de0df69e6d" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="jizn-igra@bk.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="38260a68b7f5358fbf1fa6de0df69e6d" value="1" />
            </form>
    </div>
