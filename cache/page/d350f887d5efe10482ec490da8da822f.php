...
<thead>
	...
	<input type="hidden" name="5abc2592e16dfa7325f06c03671914ba" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=fb1f6423834886fe0a2493ea67015041">
...
<!--        </div>-->
        ...
        <input type="hidden" name="5abc2592e16dfa7325f06c03671914ba" value="1" />
            </form>
    </div>
