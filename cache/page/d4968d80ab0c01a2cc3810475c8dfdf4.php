...
<thead>
	...
	<input type="hidden" name="19cafd66cc6224d811564d781fee9ded" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3633&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=41">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="77720060228samara" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="19cafd66cc6224d811564d781fee9ded" value="1" />
            </form>
    </div>
