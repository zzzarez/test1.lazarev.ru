...
<thead>
	...
	<input type="hidden" name="b3a4729e1d2ff8b92b10b4a541a8a8c0" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="tchema@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="b3a4729e1d2ff8b92b10b4a541a8a8c0" value="1" />
            </form>
    </div>
