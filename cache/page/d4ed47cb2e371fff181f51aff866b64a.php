...
<thead>
	...
	<input type="hidden" name="72dfdf9865affec768607feb3c9ac57c" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=7d07a2107403cd56f5101cdfbf60a796">
...
<!--        </div>-->
        ...
        <input type="hidden" name="72dfdf9865affec768607feb3c9ac57c" value="1" />
            </form>
    </div>
