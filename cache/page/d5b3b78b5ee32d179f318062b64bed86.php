...
<thead>
	...
	<input type="hidden" name="88fbaba6b4eb9232ed55c1da77682bc8" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="haskul.o@list.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="88fbaba6b4eb9232ed55c1da77682bc8" value="1" />
            </form>
    </div>
