...
<thead>
	...
	<input type="hidden" name="7901f4e1289528d1c25ca033ec475e61" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3233&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=41">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2010010405moskva_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="7901f4e1289528d1c25ca033ec475e61" value="1" />
            </form>
    </div>
