...
<thead>
	...
	<input type="hidden" name="2ac4e24d7750b3a32633ac5ec0a7daac" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=315deab71cad256364bc9bd47182292a">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"Человек будущего. Воспитание родителей. Ответы на вопросы."
    </a>
    <br>
        Имя файла: vsprdtotveti.fb2        <br>
...
<!--        </div>-->
        ...
        <input type="hidden" name="2ac4e24d7750b3a32633ac5ec0a7daac" value="1" />
            </form>
    </div>
