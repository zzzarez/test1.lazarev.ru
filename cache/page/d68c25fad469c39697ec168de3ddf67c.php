...
<thead>
	...
	<input type="hidden" name="c81bae1ff896ee0f709cbb02db2ebb29" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3306&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="19961011habarovsk" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="c81bae1ff896ee0f709cbb02db2ebb29" value="1" />
            </form>
    </div>
