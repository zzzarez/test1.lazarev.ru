...
<thead>
	...
	<input type="hidden" name="67a3c1e48494a5371b93161bbc2af8a8" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=6a5bcb660b9ecff9943b1e8b00ef3a0a">
...
<!--        </div>-->
        ...
        <input type="hidden" name="67a3c1e48494a5371b93161bbc2af8a8" value="1" />
            </form>
    </div>
