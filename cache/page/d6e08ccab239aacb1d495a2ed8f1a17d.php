...
<thead>
	...
	<input type="hidden" name="fea5bd9e625090aac72cbc721b89d1de" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=5691ca4858cabda3b9c108f6a34600e4">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"Диагностика кармы (вторая серия). Опыт выживания. Часть 2."
    </a>
    <br>
        Имя файла: dkII2.doc        <br>
...
<!--        </div>-->
        ...
        <input type="hidden" name="fea5bd9e625090aac72cbc721b89d1de" value="1" />
            </form>
    </div>
