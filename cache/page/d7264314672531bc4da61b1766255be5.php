...
<thead>
	...
	<input type="hidden" name="66cacf187f60687152b53ce9a52b9adc" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=b830c970ebde449037d2d37ef2f0a8a6">
...
<!--        </div>-->
        ...
        <input type="hidden" name="66cacf187f60687152b53ce9a52b9adc" value="1" />
            </form>
    </div>
