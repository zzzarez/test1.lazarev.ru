...
<thead>
	...
	<input type="hidden" name="d9a83cf5b4a22fc25ce39b3e642677f7" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=22ade902b5cff757456204900ee432b2">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"Человек будущего. Воспитание родителей. Ответы на вопросы."
    </a>
    <br>
        Имя файла: vsprdtotveti.pdf        <br>
...
<!--        </div>-->
        ...
        <input type="hidden" name="d9a83cf5b4a22fc25ce39b3e642677f7" value="1" />
            </form>
    </div>
