...
<thead>
	...
	<input type="hidden" name="092f0bf712b0f9b173bdb59ab118f13f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=8368921882e0b700554142f495ec7835">
...
<!--        </div>-->
        ...
        <input type="hidden" name="092f0bf712b0f9b173bdb59ab118f13f" value="1" />
            </form>
    </div>
