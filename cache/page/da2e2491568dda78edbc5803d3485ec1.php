...
<thead>
	...
	<input type="hidden" name="941422d06d0e529cfd3761027b4e23d3" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=5b2abec97093739a8a14c721564fbfcc">
...
<!--        </div>-->
        ...
        <input type="hidden" name="941422d06d0e529cfd3761027b4e23d3" value="1" />
            </form>
    </div>
