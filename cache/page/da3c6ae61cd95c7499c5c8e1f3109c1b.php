...
<thead>
	...
	<input type="hidden" name="b6362d59db4f9f8a6db6e6c47ea380bb" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3740&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2013052526almaata" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="b6362d59db4f9f8a6db6e6c47ea380bb" value="1" />
            </form>
    </div>
