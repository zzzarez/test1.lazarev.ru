...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> Будет ли Вам интересно покупать электронные книги в Apple App Store?</span>
...
<thead>
	<tr>
		<th colspan="3" class="sectiontableheader">
			...
			Будет ли Вам интересно покупать электронные книги в Apple App Store?		</th>
	</tr>
</thead>
<tbody>
	<tr class="sectiontableentry0">
		<td width="100%" colspan="3">
			Что такое App Store?		</td>
	</tr>
	<tr class="sectiontableentry0">
		...
		<td width="300" >
			<div class="polls_color_1" style="height:4px;width:44.2%"></div>
		</td>
	</tr>
	...
	<tr class="sectiontableentry1">
		...
		<td width="300" >
			<div class="polls_color_2" style="height:4px;width:34.1%"></div>
		</td>
	</tr>
	<tr class="sectiontableentry0">
		<td width="100%" colspan="3">
	...
	<tr class="sectiontableentry0">
		...
		<td width="300" >
			<div class="polls_color_3" style="height:4px;width:21.7%"></div>
		</td>
	</tr>
</tbody>
</table>
