...
<thead>
	...
	<input type="hidden" name="46cacbcc70ed4b08eb8a5d531a2171dc" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=f7df51825378400d310f15971982dced">
...
<!--        </div>-->
        ...
        <input type="hidden" name="46cacbcc70ed4b08eb8a5d531a2171dc" value="1" />
            </form>
    </div>
