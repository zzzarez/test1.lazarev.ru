...
<thead>
	...
	<input type="hidden" name="4b333027128a7b136228538f95b3d9f8" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523adf0e22c3f" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="4b333027128a7b136228538f95b3d9f8" value="1" />
            </form>
    </div>
