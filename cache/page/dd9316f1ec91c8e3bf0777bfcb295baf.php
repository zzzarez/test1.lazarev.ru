...
<thead>
	...
	<input type="hidden" name="992234204da1e266ba1cd3cb4dbc43b7" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3641&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="7772008051314moskva" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="992234204da1e266ba1cd3cb4dbc43b7" value="1" />
            </form>
    </div>
