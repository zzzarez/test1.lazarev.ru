...
<thead>
	...
	<input type="hidden" name="55d14f3fe0802258eda8b6ba479c5589" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=409cee03327c4c51fc2cdde2009fa08a">
...
<!--        </div>-->
        ...
        <input type="hidden" name="55d14f3fe0802258eda8b6ba479c5589" value="1" />
            </form>
    </div>
