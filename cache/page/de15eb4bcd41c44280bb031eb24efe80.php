...
<thead>
	...
	<input type="hidden" name="d1da71eba529d3d57780b61cdfc33ca2" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3602&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2012063001yalta" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="d1da71eba529d3d57780b61cdfc33ca2" value="1" />
            </form>
    </div>
