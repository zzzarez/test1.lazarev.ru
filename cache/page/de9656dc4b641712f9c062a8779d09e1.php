...
<thead>
	...
	<input type="hidden" name="6a52ee4a80ec4a2ef5c36fdf3701ce44" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52331029c5e35" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="6a52ee4a80ec4a2ef5c36fdf3701ce44" value="1" />
            </form>
    </div>
