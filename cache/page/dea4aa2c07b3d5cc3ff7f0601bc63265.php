...
<thead>
	...
	<input type="hidden" name="ba408a77a47f376462a7ca7e1e5dbf3d" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=5b1a0971e6ddfb99febac70f81606863">
...
<!--        </div>-->
        ...
        <input type="hidden" name="ba408a77a47f376462a7ca7e1e5dbf3d" value="1" />
            </form>
    </div>
