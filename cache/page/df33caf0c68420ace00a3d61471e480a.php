...
<thead>
	...
	<input type="hidden" name="f0ef409efa3363f41a4b789a4fd1194f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3647&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="5551996051112piter_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="f0ef409efa3363f41a4b789a4fd1194f" value="1" />
            </form>
    </div>
