...
<thead>
	...
	<input type="hidden" name="875d64111dc210117603860fb04ab1d7" value="1" /></form>
</div>
    </div>
</div>
        ...
        if( !(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,4})+$/.test(form.email.value))) {
           ...
           // $('email_ticker').setHTML("<img src=\"http://shop.lazarev.ru/images/wait.gif\">&nbsp;Checking");
			...
			return isvalid;
	            ...
	            //]]>
	    </script><form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.registration&Itemid=40" method="post" name="adminForm">
...
<div align="center"><input type="hidden" name="remember" value="yes" />
	...
	<input type="hidden" name="875d64111dc210117603860fb04ab1d7" value="1" />
