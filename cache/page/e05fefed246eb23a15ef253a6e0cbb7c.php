...
<thead>
	...
	<input type="hidden" name="d438d02364d54072979012775734340c" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523283ba8fe34" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="d438d02364d54072979012775734340c" value="1" />
            </form>
    </div>
