...
<thead>
	...
	<input type="hidden" name="9193ba3b69700fb1ab5df296cfed42dd" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=2cc8eb84edae6d890e0bd73f0a8af1cf">
...
<!--        </div>-->
        ...
        <input type="hidden" name="9193ba3b69700fb1ab5df296cfed42dd" value="1" />
            </form>
    </div>
