...
<thead>
	...
	<input type="hidden" name="b44f79fbbdd1392fa0005194d90f8d6a" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3437&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=35">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2007111718moskva" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="b44f79fbbdd1392fa0005194d90f8d6a" value="1" />
            </form>
    </div>
