...
<thead>
	...
	<input type="hidden" name="7fddbdb0faf0552336561a90432e6dd5" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=0e5dc85c4f7e2c8f68e22de3e2b9e681">
...
<!--        </div>-->
        ...
        <input type="hidden" name="7fddbdb0faf0552336561a90432e6dd5" value="1" />
            </form>
    </div>
