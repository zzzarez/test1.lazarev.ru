...
<thead>
	...
	<input type="hidden" name="aa3bcdb7fdb45550268095f5d591bac1" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=04fd73bbeb0fb722e95a7ae6e75d6efb">
...
<!--        </div>-->
        ...
        <input type="hidden" name="aa3bcdb7fdb45550268095f5d591bac1" value="1" />
            </form>
    </div>
