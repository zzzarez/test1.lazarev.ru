...
<thead>
	...
	<input type="hidden" name="528263ba855f80c93c0f9dce1d4a1bde" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="smalz@ukr.net" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="528263ba855f80c93c0f9dce1d4a1bde" value="1" />
            </form>
    </div>
