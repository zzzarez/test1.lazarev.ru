...
<thead>
	...
	<input type="hidden" name="904ea7028795436b42175ebf2977c7e8" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=819080820105ba7dfe23b3eb094a03c0">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"Ответы на вопросы. Весна 1994 г."
    </a>
    <br>
        Имя файла: 19940311otveti.avi        <br>
...
<!--        </div>-->
        ...
        <input type="hidden" name="904ea7028795436b42175ebf2977c7e8" value="1" />
            </form>
    </div>
