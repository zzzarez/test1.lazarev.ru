...
<thead>
	...
	<input type="hidden" name="abed3bfefcde7e1a99138829a2e932f3" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=2cbbde6b09bdb2cdbf2da705d012189e">
...
<!--        </div>-->
        ...
        <input type="hidden" name="abed3bfefcde7e1a99138829a2e932f3" value="1" />
            </form>
    </div>
