...
<thead>
	...
	<input type="hidden" name="a1da2042ddab0708768716d5a2761a0d" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=61d95931b3cd66a87bb8f42f3980dbfe">
...
<!--        </div>-->
        ...
        <input type="hidden" name="a1da2042ddab0708768716d5a2761a0d" value="1" />
            </form>
    </div>
