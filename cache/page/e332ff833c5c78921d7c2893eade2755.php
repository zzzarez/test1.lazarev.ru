...
<thead>
	...
	<input type="hidden" name="25bfaea5b47e3082e1123d5e1cd5ebf5" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=0489b3a1a42a3541586f29b31e3c8ba0">
...
<!--        </div>-->
        ...
        <input type="hidden" name="25bfaea5b47e3082e1123d5e1cd5ebf5" value="1" />
            </form>
    </div>
