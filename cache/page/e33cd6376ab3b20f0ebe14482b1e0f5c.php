...
<thead>
	...
	<input type="hidden" name="188075afa897ec1b5e861828b3934d1a" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="vladafenix76@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="188075afa897ec1b5e861828b3934d1a" value="1" />
            </form>
    </div>
