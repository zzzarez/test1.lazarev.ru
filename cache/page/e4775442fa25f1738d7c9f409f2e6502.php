...
<thead>
	...
	<input type="hidden" name="dce82a6fbe50590556d159fded67a716" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=a9166ca1dbc53afba78a25b0a136fae3">
...
<!--        </div>-->
        ...
        <input type="hidden" name="dce82a6fbe50590556d159fded67a716" value="1" />
            </form>
    </div>
