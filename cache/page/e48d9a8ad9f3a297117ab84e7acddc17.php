...
<thead>
	...
	<input type="hidden" name="3a9b722b44c2a5ceefe763f8db013fad" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523baa9100c2c" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="3a9b722b44c2a5ceefe763f8db013fad" value="1" />
            </form>
    </div>
