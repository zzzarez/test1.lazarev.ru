...
<thead>
	...
	<input type="hidden" name="42eb27007853bed7e4ff689e1dc507d5" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?option=com_content&amp;view=article&amp;id=10&amp;Itemid=41" class="pathway">Помощь</a> <img src="/images/M_images/arrow.png" alt=""  /> Регистрация</span>
        ...
        if( !(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,4})+$/.test(form.email.value))) {
           ...
           // $('email_ticker').setHTML("<img src=\"http://shop.lazarev.ru/images/wait.gif\">&nbsp;Checking");
			...
			return isvalid;
	            ...
	            //]]>
	    </script><form action="http://shop.lazarev.ru/index.php?option=com_virtuemart&page=shop.registration&Itemid=41" method="post" name="adminForm">
...
<div align="center"><input type="hidden" name="remember" value="yes" />
	...
	<input type="hidden" name="42eb27007853bed7e4ff689e1dc507d5" value="1" />
...
<div class="vmCartModule radgrad"><div class='cart_hdr_img'><a style='font-size:14px;color:white;' href='/index.php?page=shop.cart&option=com_virtuemart&Itemid=1'>Корзина</a></div>  <script type="text/javascript">
        document.getElementsById('sbm_btn3708').forEach(function(sm) {
	    sm.value = 'В корзине';
	    sm.disabled = true;
        });
  </script>
            ...
            <!--&nbsp;x&nbsp;--> <a href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=0&amp;product_id=3708&amp;option=com_virtuemart&amp;Itemid=41">Ответы на вопросы    21 января 2013г</a>
            </div>
...
<div style="float: left;font-size: 11px;padding: 10px;font-weight: bold;color: red;" >
    ...
    <input type="hidden" id="totalprice_hlp" value="140"/>
...
всего: <font style='font-size:14px;margin-left:7px;line-height:0px;'>140 р. </font></div>
    <br/><br style="clear:both;" /><div align="center" class="show_cart_text">
    <a href="index.php?page=shop.cart&amp;option=com_virtuemart&amp;Itemid=41" title="Показать корзину">Показать корзину</a>    </div><br/>
