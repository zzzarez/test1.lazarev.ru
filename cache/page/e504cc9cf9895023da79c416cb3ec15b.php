...
<thead>
	...
	<input type="hidden" name="70ef6e817e4bbc87b8bdb7798fd69f61" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=b159ad978904e8774743eb52fadeb228">
...
<!--        </div>-->
        ...
        <input type="hidden" name="70ef6e817e4bbc87b8bdb7798fd69f61" value="1" />
            </form>
    </div>
