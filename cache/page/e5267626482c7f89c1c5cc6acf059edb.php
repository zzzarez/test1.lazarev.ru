...
<thead>
	...
	<input type="hidden" name="251abc245145905240d6a7ee0b07d265" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5239d9b310e72" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="251abc245145905240d6a7ee0b07d265" value="1" />
            </form>
    </div>
