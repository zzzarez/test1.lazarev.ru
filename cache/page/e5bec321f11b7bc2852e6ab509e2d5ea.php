...
<thead>
	...
	<input type="hidden" name="e7166953bd0cdba2b96636583d9c9a93" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
	...
	<ul id="cpanel">
					<li class="cpanel-icon tooltip" title="Editor Global Configuration::Edit the JCE Editor Global Configuration"><a href="index.php?option=com_jce&amp;view=config"><span class="config"></span>Editor Global Configuration</a></li>
							...
							<li class="cpanel-icon tooltip" title="File Browser::File Browser::Manage files and folders"><a href="index.php?option=com_jce&view=editor&layout=plugin&plugin=browser&standalone=1&wff719f06b56d554efa98a5a2a6abdcf86=1" class="dialog browser" target="_blank" data-options="{'width':765,'height':480, 'modal':true}" title="File Browser"><span class="browser"></span>File Browser</a></li>
...
<!--        </div>-->
        ...
        <input type="hidden" name="e7166953bd0cdba2b96636583d9c9a93" value="1" />
            </form>
    </div>
