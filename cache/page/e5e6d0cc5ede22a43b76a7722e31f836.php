...
<thead>
	...
	<input type="hidden" name="c80ca5ea22c50a1308c05fc7ab7dee5d" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
	...
	<ul id="cpanel">
					<li class="cpanel-icon tooltip" title="Editor Global Configuration::Edit the JCE Editor Global Configuration"><a href="index.php?option=com_jce&amp;view=config"><span class="config"></span>Editor Global Configuration</a></li>
							...
							<li class="cpanel-icon tooltip" title="File Browser::File Browser::Manage files and folders"><a href="index.php?option=com_jce&view=editor&layout=plugin&plugin=browser&standalone=1&wfa1ec459cccbe8717092ad95212ede290=1" class="dialog browser" target="_blank" data-options="{'width':765,'height':480, 'modal':true}" title="File Browser"><span class="browser"></span>File Browser</a></li>
...
<!--        </div>-->
        ...
        <input type="hidden" name="c80ca5ea22c50a1308c05fc7ab7dee5d" value="1" />
            </form>
    </div>
