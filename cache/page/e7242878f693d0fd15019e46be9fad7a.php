...
<thead>
	...
	<input type="hidden" name="8467837cf8cd1c12355b5659575107a3" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=5d53cb8e72797de8080bbbd08e749c50">
...
<!--        </div>-->
        ...
        <input type="hidden" name="8467837cf8cd1c12355b5659575107a3" value="1" />
            </form>
    </div>
