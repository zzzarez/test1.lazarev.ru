...
<thead>
	...
	<input type="hidden" name="4c3a21dfa572ae2f0745810a6cebf008" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523898d200b39" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="4c3a21dfa572ae2f0745810a6cebf008" value="1" />
            </form>
    </div>
