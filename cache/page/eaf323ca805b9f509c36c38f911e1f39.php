...
<thead>
	...
	<input type="hidden" name="2d4eeb09f20fbff131b8a4a8a34f2799" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3354&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="20030607zaporozhe" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="2d4eeb09f20fbff131b8a4a8a34f2799" value="1" />
            </form>
    </div>
