...
<thead>
	...
	<input type="hidden" name="b968a8283a2965316aefb117ae6e0d8f" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523b6c8fd77c2" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="b968a8283a2965316aefb117ae6e0d8f" value="1" />
            </form>
    </div>
