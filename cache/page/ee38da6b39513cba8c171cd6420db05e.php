...
<thead>
	...
	<input type="hidden" name="2245da5ec1bd9338c05fd9703a4feede" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3579&amp;category_id=6&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
...
<!--        </div>-->
        ...
        <input type="hidden" name="2245da5ec1bd9338c05fd9703a4feede" value="1" />
            </form>
    </div>
