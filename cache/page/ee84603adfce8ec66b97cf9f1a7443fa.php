...
<thead>
	...
	<input type="hidden" name="dad4346de4d1eb2e6b74211b3794611b" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3495&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2010062627yalta" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="dad4346de4d1eb2e6b74211b3794611b" value="1" />
            </form>
    </div>
