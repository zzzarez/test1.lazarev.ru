...
<thead>
	...
	<input type="hidden" name="6a5997ee63c268aaad65ecdaea5db81f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=94e3015563ec13a625775c86ccb0f5d9">
...
<!--        </div>-->
        ...
        <input type="hidden" name="6a5997ee63c268aaad65ecdaea5db81f" value="1" />
            </form>
    </div>
