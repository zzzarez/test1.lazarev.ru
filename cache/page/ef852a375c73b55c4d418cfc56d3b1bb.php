...
<thead>
	...
	<input type="hidden" name="3b39163bf7655ecc70d2353564e4d115" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=b456af3f8364003e800985fa5caffab8">
...
<!--        </div>-->
        ...
        <input type="hidden" name="3b39163bf7655ecc70d2353564e4d115" value="1" />
            </form>
    </div>
