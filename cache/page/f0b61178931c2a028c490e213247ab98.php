...
<thead>
	...
	<input type="hidden" name="9e895ffaa96edc0c6cdbfaaccaae67ef" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523a9cf54e36b" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="9e895ffaa96edc0c6cdbfaaccaae67ef" value="1" />
            </form>
    </div>
