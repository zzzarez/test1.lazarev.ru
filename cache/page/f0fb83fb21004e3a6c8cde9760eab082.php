...
<thead>
	...
	<input type="hidden" name="db72c25028d6b7024f7ead38a85103a3" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3524&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2011110506moskva" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="db72c25028d6b7024f7ead38a85103a3" value="1" />
            </form>
    </div>
