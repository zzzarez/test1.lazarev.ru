...
<thead>
	...
	<input type="hidden" name="1a5fec1755dcd5668b93d207e464a8cd" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3606&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5239d9d6a25da" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "ТВ передача «Бумеранг», июль 1994 г.","5");var sm=document.getElementById("sbm_btn3606");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3606" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3606" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3606" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="1a5fec1755dcd5668b93d207e464a8cd" value="1" />
            </form>
    </div>
