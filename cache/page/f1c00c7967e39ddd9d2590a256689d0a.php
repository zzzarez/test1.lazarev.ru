...
<thead>
	...
	<input type="hidden" name="e2a12933ea82f621fd238a97962d1df5" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=340fe340ce691e91807ed4c93573b2a4">
...
<!--        </div>-->
        ...
        <input type="hidden" name="e2a12933ea82f621fd238a97962d1df5" value="1" />
            </form>
    </div>
