...
<thead>
	...
	<input type="hidden" name="42c0048268f0e8bacca7a3ac214f5e7c" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5239c7a63c745" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="42c0048268f0e8bacca7a3ac214f5e7c" value="1" />
            </form>
    </div>
