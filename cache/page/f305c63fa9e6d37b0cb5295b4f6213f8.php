...
<thead>
	...
	<input type="hidden" name="9fbbb2529f283660f9c01281496ed5ed" value="1" /></form>
</div>
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
                				...
                				<input style="visibility: hidden;" id="username" name="username" value="M.Verevochkina@mail.ru" type="text" class="required" size="36" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="9fbbb2529f283660f9c01281496ed5ed" value="1" />
            </form>
    </div>
