...
<thead>
	...
	<input type="hidden" name="51aed6acd10816c90340cb39d89d5f43" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_RUS_DVD_DK_front.jpg" height="292" width="200" alt="Волгоград. 19 марта 2005 г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Волгоград. 19 марта 2005 г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3382&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52356c9711625" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Волгоград. 19 марта 2005 г.","140");var sm=document.getElementById("sbm_btn3382");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3382" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3382" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3382" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="51aed6acd10816c90340cb39d89d5f43" value="1" />
            </form>
    </div>
