...
<thead>
	...
	<input type="hidden" name="5193e182261789aaa936f3dfddd4db2d" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=f4f17cdc2e9cde2d6697f0c5477242ca">
...
<!--        </div>-->
        ...
        <input type="hidden" name="5193e182261789aaa936f3dfddd4db2d" value="1" />
            </form>
    </div>
