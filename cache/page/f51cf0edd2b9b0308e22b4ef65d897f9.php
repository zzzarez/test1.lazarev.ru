...
<thead>
	...
	<input type="hidden" name="b4898a04f7eb3ba83bb7d43f559e0865" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> Какой раздел нужно доработать?</span>
...
<thead>
	<tr>
		<th colspan="3" class="sectiontableheader">
			...
			Какой раздел нужно доработать?		</th>
	</tr>
</thead>
<tbody>
	...
	<tr class="sectiontableentry0">
		...
		<td width="300" >
			<div class="polls_color_1" style="height:4px;width:49.3%"></div>
		</td>
	</tr>
	...
	<tr class="sectiontableentry1">
		...
		<td width="300" >
			<div class="polls_color_2" style="height:4px;width:16.8%"></div>
		</td>
	</tr>
	<tr class="sectiontableentry0">
		<td width="100%" colspan="3">
	...
	<tr class="sectiontableentry1">
		...
		<td width="300" >
			<div class="polls_color_4" style="height:4px;width:8.4%"></div>
		</td>
	</tr>
	<tr class="sectiontableentry0">
		<td width="100%" colspan="3">
	...
	<tr class="sectiontableentry0">
		...
		<td width="300" >
			<div class="polls_color_5" style="height:4px;width:6.8%"></div>
		</td>
	</tr>
	<tr class="sectiontableentry1">
		<td width="100%" colspan="3">
	...
	<tr class="sectiontableentry1">
		...
		<td width="300" >
			<div class="polls_color_1" style="height:4px;width:4.1%"></div>
		</td>
	</tr>
	<tr class="sectiontableentry0">
		<td width="100%" colspan="3">
	...
	<tr class="sectiontableentry0">
		...
		<td width="300" >
			<div class="polls_color_2" style="height:4px;width:3.2%"></div>
		</td>
	</tr>
	<tr class="sectiontableentry1">
		<td width="100%" colspan="3">
	...
	<tr class="sectiontableentry1">
		...
		<td width="300" >
			<div class="polls_color_3" style="height:4px;width:1.6%"></div>
		</td>
	</tr>
</tbody>
</table>
...
<!--        </div>-->
        ...
        <input type="hidden" name="b4898a04f7eb3ba83bb7d43f559e0865" value="1" />
            </form>
    </div>
