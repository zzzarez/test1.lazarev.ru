...
<thead>
	...
	<input type="hidden" name="da0c23b36c548a48d4a5f16010df70c5" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3621&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="7772000111011piter" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="da0c23b36c548a48d4a5f16010df70c5" value="1" />
            </form>
    </div>
