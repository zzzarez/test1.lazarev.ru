...
<thead>
	...
	<input type="hidden" name="797a93319cd3ba1ec88184571bfe3d37" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=95303d56a972fb8ffddccb8d36742630">
...
<!--        </div>-->
        ...
        <input type="hidden" name="797a93319cd3ba1ec88184571bfe3d37" value="1" />
            </form>
    </div>
