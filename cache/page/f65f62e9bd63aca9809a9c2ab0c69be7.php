...
<thead>
	...
	<input type="hidden" name="ffc8ba7c32c6aeee40b16f36d83d8e1d" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://www.shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?page=shop.browse&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1" class="pathway">Видео</a> <img src="/images/M_images/arrow.png" alt=""  /> Харьков. 26 января 2007 г.</span>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_RUS_DVD_DK_front.jpg" height="292" width="200" alt="Харьков. 26 января 2007 г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Харьков. 26 января 2007 г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3421&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523bc5619c14c" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Харьков. 26 января 2007 г.","140");var sm=document.getElementById("sbm_btn3421");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3421" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3421" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3421" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="ffc8ba7c32c6aeee40b16f36d83d8e1d" value="1" />
            </form>
    </div>
