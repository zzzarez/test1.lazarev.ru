...
<thead>
	...
	<input type="hidden" name="cd1f0cd7e64088158172a2436f00e28e" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=763a11c6f6e35c8f6b510b6242454a0c">
...
<!--        </div>-->
        ...
        <input type="hidden" name="cd1f0cd7e64088158172a2436f00e28e" value="1" />
            </form>
    </div>
