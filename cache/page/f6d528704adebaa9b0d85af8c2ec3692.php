...
<thead>
	...
	<input type="hidden" name="bd39cae0a9cc9664423f0c646a8c7619" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=9976d0101baba8fe37f8623d14d3ceda">
...
<!--        </div>-->
        ...
        <input type="hidden" name="bd39cae0a9cc9664423f0c646a8c7619" value="1" />
            </form>
    </div>
