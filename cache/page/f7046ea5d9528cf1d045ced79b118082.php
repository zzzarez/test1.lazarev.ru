...
<thead>
	...
	<input type="hidden" name="2dee50086d855b7d04dedbcb4d0e69d5" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=69b140b6e22040f2c66db8fbf1534f62">
...
<!--        </div>-->
        ...
        <input type="hidden" name="2dee50086d855b7d04dedbcb4d0e69d5" value="1" />
            </form>
    </div>
