...
<thead>
	...
	<input type="hidden" name="adfc8f6c9e3a806a855f8d18282fa5da" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3102&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="20030607zaporozhe_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="adfc8f6c9e3a806a855f8d18282fa5da" value="1" />
            </form>
    </div>
