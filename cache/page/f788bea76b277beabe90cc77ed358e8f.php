...
<thead>
	...
	<input type="hidden" name="2f6a1d819228432c9db0e6eb6e23528b" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=26df4a3052c3ea834958ad09d5157c65">
...
<!--        </div>-->
        ...
        <input type="hidden" name="2f6a1d819228432c9db0e6eb6e23528b" value="1" />
            </form>
    </div>
