...
<thead>
	...
	<input type="hidden" name="339d3ca1b6f1c68094214b5911066f0f" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523a94536970f" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="339d3ca1b6f1c68094214b5911066f0f" value="1" />
            </form>
    </div>
