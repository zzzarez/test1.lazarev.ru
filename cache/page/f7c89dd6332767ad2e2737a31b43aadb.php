...
<thead>
	...
	<input type="hidden" name="6ee6c72ad3e8d9a93c523795ba3b0bff" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3082&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2000111011piter_aud" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="6ee6c72ad3e8d9a93c523795ba3b0bff" value="1" />
            </form>
    </div>
