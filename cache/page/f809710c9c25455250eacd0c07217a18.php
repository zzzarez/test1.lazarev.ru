...
<thead>
	...
	<input type="hidden" name="7158ab5b5dd23a75d51685189216fe74" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=f2ae2db8c68a19d992e5fb874ce231ec">
...
<!--        </div>-->
        ...
        <input type="hidden" name="7158ab5b5dd23a75d51685189216fe74" value="1" />
            </form>
    </div>
