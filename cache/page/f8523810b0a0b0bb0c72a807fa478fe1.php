...
<thead>
	...
	<input type="hidden" name="f88c433bc1e9fc26c0e36b050bde3b97" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=b121072a539ff8f8192791e21fcc2a68">
...
<!--        </div>-->
        ...
        <input type="hidden" name="f88c433bc1e9fc26c0e36b050bde3b97" value="1" />
            </form>
    </div>
