...
<thead>
	...
	<input type="hidden" name="a3aabfd199c87e890bf9252c2b6396b5" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    ...
    <div class="fly_name">
        ...
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3124&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_52363f13bd47f" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Киев. 12 и 13 ноября 2004 г. (2 дня)","200");var sm=document.getElementById("sbm_btn3124");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3124" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3124" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3124" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="a3aabfd199c87e890bf9252c2b6396b5" value="1" />
            </form>
    </div>
