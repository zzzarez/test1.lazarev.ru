...
<thead>
	...
	<input type="hidden" name="abecb94c6e21a48736989556b7a3bccd" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=419ca9b6f03be26f697dba33bcf8e0f9">
...
<!--        </div>-->
        ...
        <input type="hidden" name="abecb94c6e21a48736989556b7a3bccd" value="1" />
            </form>
    </div>
