...
<thead>
	...
	<input type="hidden" name="faf52d608b105d15c1988adc4ca55bdc" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=9037b3171d22546aebfa20ac96cf3eb3">
...
<!--        </div>-->
        ...
        <input type="hidden" name="faf52d608b105d15c1988adc4ca55bdc" value="1" />
            </form>
    </div>
