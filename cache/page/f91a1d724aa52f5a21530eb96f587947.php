...
<thead>
	...
	<input type="hidden" name="08fa2dbd57e42451abff7b86aff730b7" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523896419146a" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="08fa2dbd57e42451abff7b86aff730b7" value="1" />
            </form>
    </div>
