...
<thead>
	...
	<input type="hidden" name="3b7dd55501153f6cc679c4edabffaa11" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523b57304620c" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="3b7dd55501153f6cc679c4edabffaa11" value="1" />
            </form>
    </div>
