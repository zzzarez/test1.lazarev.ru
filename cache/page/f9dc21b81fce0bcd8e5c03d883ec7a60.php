...
<thead>
	...
	<input type="hidden" name="9e5cbedf2912aefa76cd5b88c53284a8" value="1" /></form>
</div>
    </div>
</div>
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523a02da49dd7" class="addtocart_form"
...
<!--        </div>-->
        ...
        <input type="hidden" name="9e5cbedf2912aefa76cd5b88c53284a8" value="1" />
            </form>
    </div>
