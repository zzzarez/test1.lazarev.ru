...
<thead>
	...
	<input type="hidden" name="f4d3fc963e23a146aed6151893ecb981" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=223b6b858873b5b5cf0f864fa6020094">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"Семинар 8 и 9 декабря Санкт-Петербург 2012г (2 дня)"
    </a>
    <br>
        Имя файла: 20121208piter.avi        <br>
...
<!--        </div>-->
        ...
        <input type="hidden" name="f4d3fc963e23a146aed6151893ecb981" value="1" />
            </form>
    </div>
