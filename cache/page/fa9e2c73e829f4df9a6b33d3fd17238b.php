...
<thead>
	...
	<input type="hidden" name="bf4406a88469a46219ea6c151a00cda0" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=8f8a0b392e4596881a84013ce8cd9a7c">
...
<!--        </div>-->
        ...
        <input type="hidden" name="bf4406a88469a46219ea6c151a00cda0" value="1" />
            </form>
    </div>
