...
<thead>
	...
	<input type="hidden" name="de5f74a51340f1d2834092f8c8ca2041" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=7ebaa3288128db6b6037f2183bbdeffd">
...
<!--        </div>-->
        ...
        <input type="hidden" name="de5f74a51340f1d2834092f8c8ca2041" value="1" />
            </form>
    </div>
