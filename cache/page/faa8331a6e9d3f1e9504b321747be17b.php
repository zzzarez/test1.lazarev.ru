...
<thead>
	...
	<input type="hidden" name="b197de7f83b01689431c78be25315503" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=469ee2e1d08f31352248ba4351609c18">
        Скачать&nbsp;&nbsp;&nbsp;&nbsp;"Семинар 22 и 23 июня 2013г Санкт-Петербург"
    </a>
    <br>
        Имя файла: 20130623piter.mp3        <br>
...
<!--        </div>-->
        ...
        <input type="hidden" name="b197de7f83b01689431c78be25315503" value="1" />
            </form>
    </div>
