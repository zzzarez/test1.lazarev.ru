...
<thead>
	...
	<input type="hidden" name="71d8a47d7253bdf19e2b15a795dd22c4" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=0f041b25a28889cb0dc024e3bfaafd84">
...
<!--        </div>-->
        ...
        <input type="hidden" name="71d8a47d7253bdf19e2b15a795dd22c4" value="1" />
            </form>
    </div>
