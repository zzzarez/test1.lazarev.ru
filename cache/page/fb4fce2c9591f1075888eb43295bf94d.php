...
<thead>
	...
	<input type="hidden" name="074fe1f44ab84825a0cbee5a0a81a0a7" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3426&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2007033101germaniya" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="074fe1f44ab84825a0cbee5a0a81a0a7" value="1" />
            </form>
    </div>
