...
<thead>
	...
	<input type="hidden" name="a646d63b09d8107ecdc392c90299586c" value="1" /></form>
</div>
    </div>
</div>
        ...
        if( !(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,4})+$/.test(form.email.value))) {
           ...
           // $('email_ticker').setHTML("<img src=\"http://shop.lazarev.ru/images/wait.gif\">&nbsp;Checking");
			...
			return isvalid;
	            ...
	            //]]>
	    </script><form action="http://shop.lazarev.ru/index.php?Itemid=1&option=com_virtuemart&page=shop.registration" method="post" name="adminForm">
...
<div align="center"><input type="hidden" name="remember" value="yes" />
	...
	<input type="hidden" name="a646d63b09d8107ecdc392c90299586c" value="1" />
