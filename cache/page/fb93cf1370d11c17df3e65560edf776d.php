...
<thead>
	...
	<input type="hidden" name="8299a3f425f4ac49b5ae051647e23a06" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=80265aba25d2ab7b52ea5808d0a246fb">
...
<!--        </div>-->
        ...
        <input type="hidden" name="8299a3f425f4ac49b5ae051647e23a06" value="1" />
            </form>
    </div>
