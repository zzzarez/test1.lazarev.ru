...
<thead>
	...
	<input type="hidden" name="b3d4b9577a21ed8582848047d05d7fbf" value="1" /></form>
</div>
    </div>
</div>
...
<a href="http://shop.lazarev.ru/" class="pathway">Главная</a> <img src="/images/M_images/arrow.png" alt=""  /> <a href="/index.php?option=com_content&amp;view=section&amp;layout=blog&amp;id=5&amp;Itemid=35" class="pathway">Новости</a> <img src="/images/M_images/arrow.png" alt=""  /> Корзина</span>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
Ваша корзина пуста.<!-- End Cart --><br />
...
<!--        </div>-->
        ...
        <input type="hidden" name="b3d4b9577a21ed8582848047d05d7fbf" value="1" />
            </form>
    </div>
