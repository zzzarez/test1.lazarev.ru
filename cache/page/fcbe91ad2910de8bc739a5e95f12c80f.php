...
<thead>
	...
	<input type="hidden" name="daa7a12e4f20c20f2b9560e1e9e6ba4f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3380&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=1">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2004120809moskva" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="daa7a12e4f20c20f2b9560e1e9e6ba4f" value="1" />
            </form>
    </div>
