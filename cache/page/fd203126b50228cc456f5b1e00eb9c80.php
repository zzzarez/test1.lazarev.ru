...
<thead>
	...
	<input type="hidden" name="b53c1f8f073c7852cd27452bdc59b9f5" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=d6cada0fd52680d2452ae5874c69e911">
...
<!--        </div>-->
        ...
        <input type="hidden" name="b53c1f8f073c7852cd27452bdc59b9f5" value="1" />
            </form>
    </div>
