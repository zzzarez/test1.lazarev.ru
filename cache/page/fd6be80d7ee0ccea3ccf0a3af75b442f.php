...
<thead>
	...
	<input type="hidden" name="47cae4566026cf20bb30eca267c5977f" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=532cd8d92cfea41a7b93b27b165696e2">
...
<!--        </div>-->
        ...
        <input type="hidden" name="47cae4566026cf20bb30eca267c5977f" value="1" />
            </form>
    </div>
