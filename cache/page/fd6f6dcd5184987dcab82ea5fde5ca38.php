...
<thead>
	...
	<input type="hidden" name="0356edf25cc47cec301b9c304b3b0a0c" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_RUS_DVD_CB_front.jpg" height="292" width="200" alt="Германия. Семинар 10 и 11 октября 2009 г. (2 дня)" border="0" />    </div>
    <div class="fly_name">
        <b align="left">Германия. Семинар 10 и 11 октября 2009 г. (2 дня)</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3477&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_5236687998505" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Германия. Семинар 10 и 11 октября 2009 г. (2 дня)","280");var sm=document.getElementById("sbm_btn3477");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3477" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3477" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3477" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="0356edf25cc47cec301b9c304b3b0a0c" value="1" />
            </form>
    </div>
