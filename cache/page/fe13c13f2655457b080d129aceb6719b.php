...
<thead>
	...
	<input type="hidden" name="e51d8b3c5eeb32f024b1fac1114e605f" value="1" /></form>
</div>
    </div>
</div>
...
<div class="fly_hdr_wrp">
    <div class="fly_img">
        <img src="http://shop.lazarev.ru/components/com_virtuemart/shop_image/product/s_RUS_DVD_DK_front.jpg" height="292" width="200" alt="Встреча с психологами. 18 мая 1997 г." border="0" />    </div>
    <div class="fly_name">
        <b align="left">Встреча с психологами. 18 мая 1997 г.</b>
        <br><br><br>
        <a class="button" href="index.php?page=shop.ask&amp;flypage=flypage.tpl&amp;product_id=3308&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Задайте вопрос по этому товару</a>    </div>
    <div class="fly_price">
...
<div class="vmCartContainer">
        ...
        <form action="http://shop.lazarev.ru/index.php?page=shop.cart&option=com_virtuemart" method="post" name="addtocart" id="addtocart_523649be1e989" class="addtocart_form"
                onsubmit='handleAddToCart( this.id , "Встреча с психологами. 18 мая 1997 г.","140");var sm=document.getElementById("sbm_btn3308");sm.value="В корзине";sm.disabled=true; return false;'>
...
<input type="hidden" name="prod_id[]" value="3308" />
                    ...
                    <div style="float: right;vertical-align: middle;"> <input type="hidden" id="quantity3308" name="quantity[]" value="1" />                <input type="submit" id="sbm_btn3308" class="addtocart_button" value="Купить" title="Купить" />
            </div>
...
<div class="fly_desc_wrp">
    Встреча с психологами. 18 мая 1997 г.</div>
...
<!--        </div>-->
        ...
        <input type="hidden" name="e51d8b3c5eeb32f024b1fac1114e605f" value="1" />
            </form>
    </div>
