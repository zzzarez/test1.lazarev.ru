...
<thead>
	...
	<input type="hidden" name="4479c82bc930d4f7939a81b38feb3dd9" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=abe7e6c49a7757307e6961a6d189aba8">
...
<!--        </div>-->
        ...
        <input type="hidden" name="4479c82bc930d4f7939a81b38feb3dd9" value="1" />
            </form>
    </div>
