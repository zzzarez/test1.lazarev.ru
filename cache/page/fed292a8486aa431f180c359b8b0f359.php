...
<thead>
	...
	<input type="hidden" name="fa5f5d5e049b16b2b6dc370ff3d4a55d" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=1ce83dd81466d4466e63943b1fa4a045">
...
<!--        </div>-->
        ...
        <input type="hidden" name="fa5f5d5e049b16b2b6dc370ff3d4a55d" value="1" />
            </form>
    </div>
