...
<thead>
	...
	<input type="hidden" name="9450d8dbc9eb843e08c0b8205fec4041" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3411&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=40">Вернуться к товару</a>
	<br /><br />
...
<!--        </div>-->
        ...
        <input type="hidden" name="9450d8dbc9eb843e08c0b8205fec4041" value="1" />
            </form>
    </div>
