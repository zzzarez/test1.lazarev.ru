...
<thead>
	...
	<input type="hidden" name="99ddd4aa7f8df18c507466e2db44dc89" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
            <div class="content radgrad">
                <div class="content_move">
                    ﻿﻿<div id="vmMainPage">
	<br />
	<a class="button" href="index.php?page=shop.product_details&amp;flypage=flypage.tpl&amp;product_id=3402&amp;category_id=1&amp;option=com_virtuemart&amp;Itemid=44">Вернуться к товару</a>
	<br /><br />
	...
	<input type="hidden" name="product_sku" value="2006042223volgograd" />
...
<!--        </div>-->
        ...
        <input type="hidden" name="99ddd4aa7f8df18c507466e2db44dc89" value="1" />
            </form>
    </div>
