...
<thead>
	...
	<input type="hidden" name="3e1b0f95f24532156ec5f4681410ba49" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=754a6eb14ba6b6551d8df00393ff6874">
...
<!--        </div>-->
        ...
        <input type="hidden" name="3e1b0f95f24532156ec5f4681410ba49" value="1" />
            </form>
    </div>
