...
<thead>
	...
	<input type="hidden" name="763ef521fe0d05f801818f443e75a821" value="1" /></form>
</div>
    </div>
</div>
...
<!--            </div>-->
    ...
    <br><br>
    <a id="dlink" style="font-size: 18px;color: #006400;" href="http://shop.lazarev.ru/index.php?func=downloadRequest&option=com_virtuemart&page=shop.downloads&download_id=f88fe86f1b1d4a2f2aebd1b8930843ab">
...
<!--        </div>-->
        ...
        <input type="hidden" name="763ef521fe0d05f801818f443e75a821" value="1" />
            </form>
    </div>
