...
class UserController extends JController
{
	...
	function login()
	{
		...
		else
		{
			...
			$mainframe->redirect( $return."&fail3=true" );
		}
	}
	...
	function activate()
	{
		...
		{
            //fix!!!
//            $fix_txt="<h1 class='activation_comp_title'>".JText::_( 'REG_ACTIVATE_COMPLETE_TITLE' )."</h1>";
//			// Page Title
//            $document->setTitle( $fix_txt);
//            $pathway->addItem( $fix_txt);
//            $message->title = $fix_txt;
//
//            $message->text = "<span class='activation_comp'>".JText::_( 'REG_ACTIVATE_COMPLETE' )."</span>";
		...
		{
            //fix!!!
//            $fix_text="<h1 class='activation_comp_title'>".JText::_( 'REG_ACTIVATE_NOT_FOUND_TITLE' )."<h1>";
//
//            $document->setTitle( $fix_text );
//            $pathway->addItem( $fix_text);
//            $message->title = $fix_text;
//            $message->text = "<span class='activation_comp'>".JText::_( 'REG_ACTIVATE_NOT_FOUND' )."</span>";
	...
	function requestreset()
	{
		...
		if ($model->requestReset($email) === false)
		{
			...
			$this->setRedirect('index.php?option=com_user&failed=true&view=reset', $message);
			return false;
		}

		$this->setRedirect('index.php?option=com_user&view=reset&layout=confirm&email='.$email);
	}
