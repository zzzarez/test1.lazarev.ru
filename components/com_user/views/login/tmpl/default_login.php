...
<fieldset class="input">
	<p id="com-form-login-username">
		<label for="username"><?php echo JText::_('Введите Ваш Email') ?></label><br />
...
<!--            --><?php //echo JText::_('REGISTER'); ?><!--</a>-->
        <a href="<?php echo JRoute::_( 'index.php?option=com_virtuemart&page=shop.registration&Itemid=1' ); ?>">
            <?php echo JText::_('REGISTER'); ?></a>
	</li>
	<?php endif; ?>
</ul>
