...
if (!$alreadycommented) {
    ...
    <table cellpadding="5" summary="<?php echo $VM_LANG->_('PHPSHOP_REVIEW_RATE') ?>">
      <tr>
        <th id="five_stars">
        	<label for="user_rating5"><img alt="5 stars" src="<?php echo VM_THEMEURL ?>images/stars/5.png" border="0" /></label>
        </th>
        <th id="four_stars">
        	<label for="user_rating4"><img alt="4 stars" src="<?php echo VM_THEMEURL ?>images/stars/4.png" border="0" /></label>
        </th>
        <th id="three_stars">
        	<label for="user_rating3"><img alt="3 stars" src="<?php echo VM_THEMEURL ?>images/stars/3.png" border="0" /></label>
        </th>
        <th id="two_stars">
        	<label for="user_rating2"><img alt="2 stars" src="<?php echo VM_THEMEURL ?>images/stars/2.png" border="0" /></label>
        </th>
        <th id="one_star">
        	<label for="user_rating1"><img alt="1 star" src="<?php echo VM_THEMEURL ?>images/stars/1.png" border="0" /></label>
        </th>
        <th id="null_stars">
        	<label for="user_rating0"><img alt="0 stars" src="<?php echo VM_THEMEURL ?>images/stars/0.png" border="0" /></label>
        </th>
      </tr>
      <tr>
